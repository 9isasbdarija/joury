(function(m,t,w){function F(a,b,c){return function(){try{return a.apply(this,arguments)}catch(d){c||sa(d,b)}}}function sa(a,b){var c;if(.01>Math.random())try{var d=a&&a.message||"";(c=-1<d.indexOf("network error occurred")||-1<d.indexOf("send beacon")&&-1<d.indexOf("Content Security Policy"))||(new Ra).log("jserrs",va,a.message,b,L.href,"","string"===typeof a.stack&&a.stack.replace(/\n/g,"\\n"))}catch(f){}}function H(a,b,c,d){return m.setTimeout(F(a,c||"setTimeout",d),b)}function Pb(a,b,c,d,f){function l(a,
e){e=Math.max(0,Math.min(e,65535));k.mergeArrays(a,[e>>8,e&255])}function g(a,e){k.mergeArrays(a,[e&255])}function n(a,e){if(-1==fa.indexOf(e))return!0;g(a,e)}function r(a,e){for(e=Math.max(0,e|0);127<e;)k.mergeArrays(a,[e&127|128]),e>>=7;k.mergeArrays(a,[e])}function u(a,e){255<e.length&&(e=e.substr(0,255));k.mergeArrays(a,[e.length]);for(var b=0;b<e.length;b++)l(a,e.charCodeAt(b))}function p(a,e){r(a,e.length);for(var b=0;b<e.length;b++)r(a,e.charCodeAt(b))}function C(a){if(!a.nodeName)return a[Y]=
-1,null;var e=+a[Y];if(!isFinite(e)||0>=e)return null;if(a.attributes)for(var b=a;b;){if(b.attributes.__ym_wv_ign)return null;b=b.parentElement}b=64;var c=0,h=v.getElementParent(a),d=h&&h[Y]?h[Y]:0;0>d&&(d=0);var f=a.nodeName.toUpperCase(),q=Ma[f];q||(b|=2);var p=v.getElementNeighborPosition(a);p||(b|=4);var B=v.getElementRegion(a);(h=h?v.getElementRegion(h):null)&&B[0]==h[0]&&B[1]==h[1]&&B[2]==h[2]&&B[3]==h[3]&&(b|=8);Fa[e].pos=B[0]+"x"+B[1];Fa[e].size=B[2]+"x"+B[3];a.id&&"string"==typeof a.id&&
(b|=32);(h=v.calcTextChecksum(a))&&(b|=16);var C=v.calcAttribChecksum(a);C&&(c|=2);a:{var A=v.getElementChildren(v.getElementParent(a),a.tagName);for(var I=0;I<A.length;I++)if((!A[I].id||"string"!=typeof A[I].id)&&v.calcAttribChecksum(A[I])==C&&v.calcTextChecksum(A[I])==h){A=!0;break a}A=!1}if(A){b|=1;var k=v.calcChildrenChecksum(a)}A=[];if(n(A,1))return null;r(A,e);g(A,b);r(A,d);q?g(A,q):u(A,f);p&&r(A,p);b&8||(r(A,B[0]),r(A,B[1]),r(A,B[2]),r(A,B[3]));b&32&&u(A,a.id);h&&l(A,h);b&1&&l(A,k);g(A,c);
C&&l(A,C);return A}function q(a,e,b,c,h,d){for(var f;b&&(f=v.getElementSize(b))&&(!f[0]||!f[1]);)b=v.getElementParent(b);if(!b)return null;f=b[Y];if(!f||0>f)return null;var q={mousemove:2,click:32,dblclick:33,mousedown:4,mouseup:30,touch:12}[e];if(!q)return null;var p=v.getElementXY(b);b=[];if(n(b,q))return null;r(b,a);r(b,f);r(b,Math.max(0,c[0]-p[0]));r(b,Math.max(0,c[1]-p[1]));/^mouse(up|down)|click$/.test(e)&&(a=h||d,g(b,2>a?1:a==(h?2:4)?4:2));return b}function h(a,e,b,c,h){var d=[];if(n(d,38))return null;
r(d,a);l(d,e);g(d,b);a=c[Y];if(!a||0>a)a=0;r(d,a);g(d,h?1:0);return d}function e(a,e){var b;if(0==e.length)var c=b="";else 100>=e.length?(b=e,c=""):200>=e.length?(b=e.substr(0,100),c=e.substr(100)):(b=e.substr(0,97),c=e.substr(e.length-97));var h=[];if(n(h,29))return null;r(h,a);p(h,b);p(h,c);return h}function B(a){var e=[];if(n(e,27))return null;r(e,a);return e}function I(a){var e=[];g(e,14);r(e,a);return e}function A(a){var e=[];if(n(e,15))return null;r(e,a);return e}function ca(a,e){var b=[];if(n(b,
17))return null;r(b,a);r(b,e[Y]);return b}function Sa(a,e){var b=[];if(n(b,18))return null;r(b,a);r(b,e[Y]);return b}function Na(a,e,b,c){var h=[];if(n(h,39))return null;r(h,a);r(h,e[Y]);u(h,String(b));g(h,c?1:0);return h}function Ta(a,e){var b=e[Y];if(0<b){var c=[],h=v.getElementRegion(e),g=Fa[b],d=h[0]+"x"+h[1],f=h[2]+"x"+h[3];if(d!=g.pos){g.pos=d;if(n(c,9))return null;r(c,a);r(c,b);r(c,h[0]);r(c,h[1])}if(f!=g.size){g.size=f;if(n(c,10))return null;r(c,a);r(c,b);r(c,h[2]);r(c,h[3])}if(c.length)return c}return null}
function Ua(a){var e=a[Y];if(!e||0>e||!/^INPUT|SELECT|TEXTAREA$/.test(a.nodeName)||!a.form||ta(a.form))return null;var b=v.getFormNumber(a.form);if(0>b)return null;var c="INPUT"==a.nodeName?{text:0,color:0,date:0,datetime:0,"datetime-local":0,email:0,number:0,range:0,search:0,tel:0,time:0,url:0,month:0,week:0,password:2,radio:3,checkbox:4,file:6,image:7}[a.type]:{SELECT:1,TEXTAREA:5}[a.nodeName];if("number"!=typeof c)return null;for(var h=-1,g=a.form.elements,d=g.length,f=0,q=0;f<d;f++)if(g[f].name==
a.name){if(g[f]==a){h=q;break}q++}if(0>h)return null;g=[];if(n(g,7))return null;r(g,e);r(g,b);r(g,c);p(g,a.name||"");r(g,h);return g}function G(a,e){var b=v.getFormNumber(e);if(0>b)return null;for(var c=e.elements,h=c.length,g=[],d=0;d<h;d++)if(!v.isEmptyField(c[d])){var f=c[d][Y];f&&0<f&&k.mergeArrays(g,[f])}c=[];if(n(c,11))return null;r(c,a);r(c,b);r(c,g.length);for(b=0;b<g.length;b++)r(c,g[b]);return c}function da(a,e,b){a=a.apply(m,e);R.append(a,b)}function w(a){if(a[Y])a=Ta(x.nowEventTime(),
a);else{var e=v.getElementParent(a);e&&w(e);a[Y]=na;Fa[na]={};na++;e=C(a);R.append(e,void 0);a=Ua(a)}R.append(a,void 0)}function z(a,e){var b=a&&v.classNameExists(a,"(ym-disable-keys|-metrika-nokeys)");e&&a&&(b=b||!!v.getElementsByClassName("(ym-disable-keys|-metrika-nokeys)",a).length);return b}function ta(a){return a&&v.classNameExists(a,"(ym-disable-submit|-metrika-noform)")}function D(a){var e=S.getTarget(a);if(e&&"SCROLLBAR"!=e.nodeName){if(/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e.tagName))if(e[Y])w(e);
else{var b=e.form;if(b){b=b.elements;for(var c=b.length,h=0;h<c;h++)/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[h].tagName)&&!b[h][Y]&&w(b[h])}else w(e)}else w(e);da(q,[x.nowEventTime(),a.type,e,S.getPos(a),a.which,a.button])}}function wa(a){D(a);ja()}function tb(a){return(a.shiftKey?2:0)|(a.ctrlKey?4:0)|(a.altKey?1:0)|(a.metaKey?8:0)|(a.ctrlKey||a.altKey?16:0)}function oa(a){if(!a)return{ignore:!0,forceRecord:!1,isPrivate:!1,privateFlag:!1,recordData:!0};var e="password"===a.type||la.test(a.name)||la.test(a.id),
b=k.reduce(function(e,b){return e||Z.generalRegex.test(a[b])},!1,["className","id","name"])||Z.placeholderRegex.test(a.placeholder),c=Z.forceRecordRegex.test(a.className);return{forceRecord:c,ignore:e,isPrivate:b,privateFlag:!c&&(b||e),recordData:c||!(b&&f.get("isEU")||e)}}function Ga(a){return"INPUT"==a.tagName?"password"==a.type||a.name&&la.test(a.name)||a.id&&la.test(a.id):!1}function E(a,e,b){a=S.getTarget(a);var c=oa(a);c.ignore||!c.forceRecord&&(c.isPrivate&&f.get("isEU")||z(a))||(w(a),da(h,
[x.nowEventTime(),e,b,a,c.privateFlag]))}function P(a){var e=a.keyCode,b=tb(a);if({3:1,8:1,9:1,13:1,16:1,17:1,18:1,19:1,20:1,27:1,33:1,34:1,35:1,36:1,37:1,38:1,39:1,40:1,45:1,46:1,91:1,92:1,93:1,106:1,110:1,111:1,144:1,145:1}[e]||112<=e&&123>=e||96<=e&&105>=e||b&16)19==e&&4==(b&-17)&&(e=144),E(a,e,b|16),ka=!1,k.setTimeout(function(){ka=!0},1,"fvl.keyDown"),!(67==e&&b&4)||b&1||b&2||V()}function ha(a){ka&&!gb&&0!==a.which&&(E(a,a.charCode||a.keyCode,tb(a)),gb=!0,k.setTimeout(function(){gb=!1},1,"fvl.keyPress"))}
function ja(){if(m.getSelection){try{var a=m.getSelection()}catch(Qb){return}var b=a.toString();var c=a.anchorNode}else t.selection&&t.selection.createRange&&(a=t.selection.createRange(),b=a.text,c=a.parentElement());if("string"==typeof b){try{for(;c&&1!=c.nodeType;)c=c.parentNode}catch(Qb){return}if(c){a=oa(c).privateFlag||z(c,!0);c=c.getElementsByTagName("*");for(var h=0;h<c.length&&!a;)a=oa(c[h]).privateFlag||z(c[h],!0),h++;b!=Oa&&(Oa=b,b=a?k.map(function(){return Z.obfuscatedSymbol},b.split("")).join(""):
b,da(e,[x.nowEventTime(),b]))}}}function V(){hb||(hb=!0,Oa&&da(B,[x.nowEventTime()]),k.setTimeout(function(){hb=!1},1,"fvl.copy"))}function O(){xa||(xa=!0,da(I,[x.nowEventTime()]))}function H(){xa&&(xa=!1,da(A,[x.nowEventTime()]))}function aa(a){(!xa||a&&!a.fromElement)&&O()}function Q(a){a&&!a.toElement&&H()}function F(a){if((a=S.getTarget(a))&&/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)){if(a[Y])w(a);else{var e=a.form;if(e){e=e.elements;for(var b=e.length,c=0;c<b;c++)/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e[c].tagName)&&
!e[c][Y]&&w(e[c])}else w(a)}da(ca,[x.nowEventTime(),a])}}function K(a){(a=S.getTarget(a))&&/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)&&(w(a),da(Sa,[x.nowEventTime(),a]))}function L(a){if((a=S.getTarget(a))&&!Ga(a)&&!z(a)&&/^INPUT|SELECT|TEXTAREA$/.test(a.tagName)){var e=oa(a),b=/^(checkbox|radio)$/.test(a.type)?a.checked:a.value;b=e.recordData?b:k.map(function(){return Z.obfuscatedSymbol},b.split("")).join("");w(a);da(Na,[x.nowEventTime(),a,b,e.privateFlag])}}function J(a){if((a=S.getTarget(a))&&
!ta(a)&&"FORM"==a.nodeName){for(var e=a.elements,b=0;b<e.length;b++)v.isEmptyField(e[b])||w(e[b]);da(G,[x.nowEventTime(),a],!0)}}function N(a){(a=S.getTarget(a))&&"BODY"==a.tagName&&R.append([],!0)}var R=new ub({protocol:a,counterId:b,globalConfig:f,counterType:c,meta:{url:M().href,hitId:d,timezone:ib,timestamp:jb}}),Ma={A:1,ABBR:2,ACRONYM:3,ADDRESS:4,APPLET:5,AREA:6,B:7,BASE:8,BASEFONT:9,BDO:10,BIG:11,BLOCKQUOTE:12,BODY:13,BR:14,BUTTON:15,CAPTION:16,CENTER:17,CITE:18,CODE:19,COL:20,COLGROUP:21,DD:22,
...
TITLE:86,TR:87,TT:88,U:89,UL:90,VAR:91,NOINDEX:100},fa=[17,18,38,32,39,15,11,7,1],Z=function(){var a="first(-|\\.|_|\\s){0,2}name last(-|\\.|_|\\s){0,2}name zip postal phone address passport (bank|credit)(-|\\.|_|\\s){0,2}card card(-|\\.|_|\\s){0,2}number card(-|\\.|_|\\s){0,2}holder cvv card(-|\\.|_|\\s){0,2}exp card(-|\\.|_|\\s){0,2}name card.*month card.*year card.*month card.*year password email birth(-|\\.|_|\\s){0,2}(day|date) second(-|\\.|_|\\s){0,2}name third(-|\\.|_|\\s){0,2}name patronymic middle(-|\\.|_|\\s){0,2}name birth(-|\\.|_|\\s){0,2}place house street city flat state".split(" ");
return{generalRegex:new RegExp("("+a.join("|")+")","i"),placeholderRegex:new RegExp("("+a.concat("\u0438\u043c\u044f;\u0444\u0430\u043c\u0438\u043b\u0438\u044f;\u043e\u0442\u0447\u0435\u0441\u0442\u0432\u043e;\u0438\u043d\u0434\u0435\u043a\u0441;\u0442\u0435\u043b\u0435\u0444\u043e\u043d;\u0430\u0434\u0440\u0435\u0441;\u043f\u0430\u0441\u043f\u043e\u0440\u0442;\u041d\u043e\u043c\u0435\u0440(-|\\.|_|\\s){0,2}\u043a\u0430\u0440\u0442\u044b;\u0434\u0430\u0442\u0430(-|\\.|_|\\s){0,2} \u0440\u043e\u0436\u0434\u0435\u043d\u0438\u044f;\u0434\u043e\u043c;\u0443\u043b\u0438\u0446\u0430;\u043a\u0432\u0430\u0440\u0442\u0438\u0440\u0430;\u0433\u043e\u0440\u043e\u0434;\u043e\u0431\u043b\u0430\u0441\u0442\u044c".split(";")).join("|")+
")","i"),forceRecordRegex:/ym-record-keys/i,obfuscatedSymbol:String.fromCharCode(8226),obfuscatedKeyCode:88}}(),na=1,la=/^(password|passwd|pswd)$/,ka=!0,gb=!1,Oa="",hb=!1,xa=!0;x.initCorrector();x.nowTime();var Y="metrikaId_"+Math.random(),Fa={},Ha=":submit"+Math.random();if(!k.isMetrikaPlayer()){y.on(t,"click,dblclick,mousedown",D);y.on(t,"mouseup",wa);y.on(t,"keydown",P);y.on(t,"keypress",ha);y.on(t,"copy",V);if(v.getBody())y.on(t,"mouseleave",N);t.attachEvent&&!m.opera?(y.on(t,"focusin",aa),y.on(t,
"focusout",Q)):(y.on(m,"focus",O),y.on(m,"blur",H),y.on(t,"blur",H));t.addEventListener?(y.on(t,"focus",F),y.on(t,"blur",K),y.on(t,"change",L),y.on(t,"submit",J)):t.attachEvent&&(y.on(t,"focusin",F),y.on(t,"focusout",K),function(){for(var a=t.getElementsByTagName("form"),e=0;e<a.length;e++){for(var b=a[e].getElementsByTagName("*"),c=0;c<b.length;c++)if(/^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName))y.on(b[c],"change",L);y.on(a[e],"submit",J)}}());(function(){var a=t.getElementsByTagName("form");if(a.length)for(var e=
0;e<a.length;e++){var b=a[e].submit;if("function"==typeof b||"object"==typeof b&&/^\s*function submit\(\)/.test(String(b)))a[e][Ha]=b,a[e].submit=function(){J({target:this});return this[Ha]()}}})()}return{start:function(){R.activate()},stop:function(){R.clear();y.un(t,"click",D);y.un(t,"dblclick",D);y.un(t,"mousedown",D);y.un(t,"mouseup",wa);y.un(t,"keydown",P);y.un(t,"keypress",ha);y.un(t,"copy",V);y.un(t,"focusin",aa);y.un(t,"focusout",Q);y.un(m,"focus",O);y.un(m,"blur",H);y.un(t,"blur",H);t.removeEventListener?
(y.un(t,"focus",F),y.un(t,"blur",K),y.un(t,"change",L),y.un(t,"submit",J)):t.detachEvent&&(y.un(t,"focusin",F),y.un(t,"focusout",K),function(){for(var a=t.getElementsByTagName("form"),e=0;e<a.length;e++){for(var b=a[e].getElementsByTagName("*"),c=0;c<b.length;c++)/^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName)&&y.un(b[c],"change",L);y.un(a[e],"submit",J)}}());(function(){for(var a=t.getElementsByTagName("form"),e=0;e<a.length;e++)a[e][Ha]&&(a[e].submit=a[e][Ha])})()}}}function M(){for(var a={},b="hash host hostname href pathname port protocol search".split(" "),
c=b.length,d=c,f,l;d--;)a[b[d]]="";try{for(f=m.location,d=c;d--;)l=b[d],a[l]=""+f[l]}catch(g){L&&(a=L)}return a}function pa(){return 0==M().hostname.search(/^(.*\.)?((yandex(-team)?)\.(com?\.)?[a-z]+|(auto|kinopoisk|beru|bringly)\.ru|ya\.(ru|cc)|yadi\.sk|yastatic\.net|.*\.yandex)$/)}function kb(a){return-1!==(""+m.navigator.userAgent).toLowerCase().search(a)}function vb(a){return(a=a&&a.innerHTML&&a.innerHTML.replace(/<\/?[^>]+>/gi,""))?(""+a).replace(/^\s+/,"").replace(/\s+$/,""):""}function wb(a,
b){var c;if(!a||!b)return!1;var d=[];for(c=0;c<b.length;c++)d.push(b[c].replace(/\^/g,"\\^").replace(/\$/g,"\\$").replace(/\./g,"\\.").replace(/\[/g,"\\[").replace(/\]/g,"\\]").replace(/\|/g,"\\|").replace(/\(/g,"\\(").replace(/\)/g,"\\)").replace(/\?/g,"\\?").replace(/\*/g,"\\*").replace(/\+/g,"\\+").replace(/\{/g,"\\{").replace(/\}/g,"\\}"));return(new RegExp("\\.("+d.join("|")+")$","i")).test(a)}function Tb(a,b){function c(a){a=a.split(":");a=a[1]||"";a=a.replace(/^\/*/,"").replace(/^www\./,"");
...
b.domContentLoadedEventEnd?b.domContentLoadedEventEnd-b.domContentLoadedEventStart:null),d.push(b.domComplete?b.domComplete-c:null),d.push(b.loadEventStart?b.loadEventStart-c:null),d.push(b.loadEventStart&&b.loadEventEnd?b.loadEventEnd-b.loadEventStart:null),d.push(b.domContentLoadedEventStart?b.domContentLoadedEventStart-c:null),a=0;a<d.length;a++)b=d[a],null!==b&&(0>b||36E5<b)&&(d[a]=null);return d}function Ub(a){var b=[],c=a._lastPerformanceTiming,d=xb(),f;if(c){var l=0;for(f=c.length;l<f;l++)null===
d[l]?b.push(d[l]):b.push(c[l]===d[l]?"":d[l])}else b=d;a._lastPerformanceTiming=d;return b.join(",")}function Vb(a){return"first-contentful-paint"===a.name}function Wb(){var a=m.performance&&m.performance.getEntriesByType,b=a?k.filter(Vb,m.performance.getEntriesByType("paint")):[];if(b.length)return b=b[0],Math.round(b.startTime);if(a)return 0;if("object"==typeof m.chrome&&m.chrome.loadTimes){if(b=m.chrome.loadTimes(),b.requestTime&&b.firstPaintTime&&m.performance&&m.performance.timing)return Math.round(1E3*
b.firstPaintTime-m.performance.timing.navigationStart)}else if(m.performance&&m.performance.timing&&(b=m.performance.timing,b.navigationStart&&b.msFirstPaint))return b.msFirstPaint-b.navigationStart;return null}var Pa=!1,yb="undefined"!==typeof Object&&"function"===typeof Object.defineProperty;try{if(yb)var Xb=function(a){function b(d){if(c[d])return c[d].exports;var f=c[d]={i:d,l:!1,exports:{}};a[d].call(f.exports,f,f.exports,b);f.l=!0;return f.exports}var c={};b.m=a;b.c=c;b.d=function(a,c,l){b.o(a,
...
b+"\\s*\\(\\)\\s*\\{\\s*\\[native[\\s-]code\\]\\s*\\}","i")).test(a.toString()):!1},isMonkeyPatchedOrUndefined:function(a,b){var c=f.a;if(c[a]===w||!this.isNative(c[a],a))return!0;if(b)for(var h=0;h<b.length;h++)if(!this.isNative(c[a].prototype[b[h]],b[h]))return!0;return!1},objectKeys:function(a){var b=[];Object(g.a)(a,function(a){return b.push(a)});return b},objectValues:function(a){var b=[];Object(g.a)(a,function(a,c){return b.push(c)});return b},safeAccess:function(a,b){if(null==a||"string"!==
typeof b)return w;for(var c=b.split("."),h=a,e=0,g=c.length;e<g;e++)if(h=h[c[e]],null==h)return w;return h},objectIsWindow:function(a){return"undefined"!==typeof Window&&a&&a.window&&a.window===a}}},function(a,b,c){b.a="undefined"!==typeof m?m:"undefined"!==typeof self?self:global},function(a,b,c){function d(a){var b={};"string"===typeof a&&0<a.length&&"?"!==a&&(a=a.replace(/^\?/,"").split("\x26"),Object(l.a)(a,function(a){var e=a.split("\x3d");a=e[0];e=e[1];try{b[a]=decodeURIComponent(e)}catch(I){b[a]=
...
if(g.nodeIsInTree(a))b(!0);else{var h=a.ownerDocument||t,e=new MutationObserver(function(){g.nodeIsInTree(a)&&(b(!0),e.disconnect())});e.observe(h.documentElement,{subtree:!0,childList:!0});var f=isFinite(c)?H(function(){g.nodeIsInTree(a)||(b(!1),e.disconnect())},c):w;d.disconnect=function(){f&&clearTimeout(f);e.disconnect()}}return d},createElement:function(a,b,c){c=c||t;var g=c.createElement(a);f.IterableUtils.forin(b,function(a){var c=b[a];"style"===a?l.ObjectUtils.assign(g[a],c):g[a]=c});return g},
...
c.SKIPPED_ATTRIBUTES,h=c.EXTRA_ATTRIBUTES,e=[],B={},I={INPUT:function(a,b){var e=f()({},b);"checkbox"===b.type||"radio"===b.type?a.checked?b.checked="checked":delete b.checked:e.value=a.value;return e},IMG:function(a,b){var e=f()({},b);a.currentSrc&&(e.src=a.currentSrc||b.src);return e}},A=function(a){if(null==a)return!1;a=a.nodeType;return a===n.DOMUtils.NodeTypes.TEXT_NODE||a===n.DOMUtils.NodeTypes.COMMENT_NODE},k=function oa(a,b){var e=[];if("function"===typeof b){var c=b(a);null!=c&&c!==NodeFilter.FILTER_ACCEPT||
e.push(a)}else e.push(a);if(a.childNodes&&0<a.childNodes.length){c=a.childNodes;for(var h=0,g=c.length;h<g;h++)e.push.apply(e,oa(c[h]))}return e},m=function(a,b,e){var c=function(a){return"function"===typeof e?e(a)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT};if("function"===typeof b&&c(a)===NodeFilter.FILTER_ACCEPT&&(b(a),!1===A(a)))for(a=t.createTreeWalker(a,-1,e?{acceptNode:c}:null,!1);a.nextNode()&&!1!==b(a.currentNode););},Na=function(a,b){var e=[];a&&(n.DOMUtils.nodeIsInTree(a)?
m(null==a?t.documentElement:a,function(a){e.push(a)},b):e.push.apply(e,k(a,b)));return e},Ta=function(a){var b=a["*"],e=d()(a,["*"]),c={},h=new RegExp(b.join("|"),"i");g.IterableUtils.forin(e,function(a){var h,g=(h=[]).concat.apply(h,e[a].concat(b));c[a]=new RegExp(g.join("|"),"i")});return function(a,b){if(a&&b){var e="string"===typeof a?a:a.nodeName;if(e)return(e=c[e.toLowerCase()])&&!!b.match(e)||!!b.match(h)}return!1}}(C),Ua=[function(a,b,e){return null==e||/^javascript/.test(e)},function(a,b){return"SCRIPT"===
a.nodeName&&"src"===b},function(a,b){return"A"===a.nodeName&&"href"===b}],G=function(a,b,e){for(var c=0,h=Ua.length;c<h;c++)if(!0===Ua[c](a,b,e))return!1;return!0},da=function(a,b,c){var h=c;if(G(a,b,c)){h=e.reduce(function(e,c){try{var h=c(a,b,e);return null!=h?h:e}catch(ja){return u["default"].warn("Filtering error",ja),e}},h);if("string"===typeof h)return(c=B[b])?c(a,b,h)||h:h;if(null!=h&&!1!==h)return h.baseVal}return null},v=function(a,b){a:{try{t.createAttribute(b)}catch(Ga){var e=!1;break a}e=
!0}return!e||Ta({nodeName:a},b)?!1:b},y=function(a,b,e){if(e&&e.name){if(!1!==v(b,e.name))try{var c,h=da(a,e.name,e.value);return c={},c[e.name]=h||"",c}catch(P){u["default"].warn("Error while reading attribute",e,a),u["default"].warn(P)}}else u["default"].warn("Error while reading attribute",e,a);return null};c=function(a){var b=new RegExp(a.join("|"),"gi");return function(a){return a&&!!a.nodeName.match(b)}}(p);var z=function(a){return a&&a.namespaceURI?/svg/.test(a.namespaceURI):!1};c={all:Na,
map:function(a,b,e){var c=[];a=Na(a,e);g.IterableUtils.fastIterate(a,function(a,e){c.push(b(e))});return c},walk:m,each:function(a,b,e){a&&(a=Na(a,e),g.IterableUtils.fastIterate(a,b))},getAttributes:function(a){var b={},e=a.nodeName,c=g.IterableUtils.toArray(a.attributes);c&&c.length&&(g.IterableUtils.fastIterate(c,function(c,h){var g=y(a,e,h);g&&l.ObjectUtils.assign(b,g)}),(c=h[e]||w)&&g.IterableUtils.fastIterate(c,function(c,h){y(b,e,{name:h,value:a[h]})}));return(c=I[e])?c(a,b):b},getContent:function(a){if(null!=
a&&A(a))return a.textContent},getNamespace:function(a){if(z(a))return a.namespaceURI},normalizeAttributeValue:da,cloneAttributes:function(a,b){var e=g.IterableUtils.toArray(a.attributes);g.IterableUtils.fastIterate(e,function(a,e){var c=!1===r.Tools.isNULL(e.namespaceURI),h=e.cloneNode();c?b.attributes.setNamedItemNS(h):b.attributes.setNamedItem(h)});return b},isSVG:z,isTextNode:A,isIgnoredNode:c,isIgnoredAttr:Ta,isAttributeNameValid:v,isSkippedAttribute:function(a){return g.IterableUtils.includes(q,
...
(a=(URL||webkitURL).createObjectURL(a),/blob:(?!http[s]?).*/.test(a)?a.replace("blob:","blob:"+(c.protocol+"//"+c.host)+"/"):a):w}(g);return g?{blob:g,url:f}:null},repeatString:function(a,b){void 0===b&&(b=1);return Array(b+1).join(a)},parseURLNative:function(a){var b=t.createElement("a");b.href=a;return{protocol:b.protocol,hostname:b.hostname,host:b.host,port:b.port,pathname:b.pathname,search:b.search,url:a}},parseURL:function(a){if(!a)return w;if("string"!==typeof a)return d.a.console.warn("URL was expected to be a string",
a),w;var b=a.match(/^(http[s]?|file):\/\/([^/\n]*)([^?\n]*)(\?[^\n]*)?/);if(b){var c=b.slice(1);b=c[0];var g=c[1],f=c[2];c=c[3];var l=g?(g.match(/([^:\s]+)(:[0-9]*)?/)||[]).slice(1):[],q=l[0];q=void 0===q?w:q;l=l[1];l=void 0===l?w:l;var h=q?(q.match(/\.([^.]+)$/)||[])[1]:w,e=f?function(){var a=f.match(/([^/]+)\.([^/]*)$/);return a?a[0]:w}():w,B=f&&e?f.replace("/"+e,""):f||"/";return{protocol:b?b+":":w,hostname:g,host:q,port:(l||"80").replace(/:/,""),path:f||"/",tld:h,file:e,pathname:B,search:c?c.replace(/^\?/,
""):w,url:a,assemble:function(a){var b=this;return a?a.replace(/(\{([^}]+)\})/g,function(){return b[2>=arguments.length?w:arguments[2]]}):this.url}}}return w}}},function(a,b,c){b.a=function(a,b,c){void 0===c&&(c=!1);var g=2===b.length;if(a&&b instanceof Function)for(var d in a)if(a.hasOwnProperty(d)||!0===c){var f=g?b(d,a[d]):b(d);if(!0!==f&&!1===f)break}}},function(a,b,c){(function(a,c){var d=new a;b.a={throttledFunctions:d,invokeAll:function(a){c.fastIterate(d,function(b,c){c.invoke.call(a)})},
create:function(a,b){var g=void 0===b?{}:b,f=g.timeout,l=void 0===f?0:f;f=g.immediateFirstRun;var n=void 0===f?!1:f;g=g.context;var q=!0,h=null,e=null,B=null,I=null,A=!1,k=null,m=null;g={invoke:function(){var b=this.context||this;B!==h&&(I=c.now(),B=h,a.call(b,{object:h,prevObject:null,timeDifff:0,args:m}))},run:function(b){var g=this.context||this;n&&(clearTimeout(k),k=H(function(){return q=!0},l));if(!A){h=b;for(var d=arguments.length,f=Array(1<d?d-1:0),r=1;r<d;r++)f[r-1]=arguments[r];m=f;q&&n?
(q=!1,B=b,a.call(g,{object:b,prevObject:null,timeDifff:0,args:m})):(I=c.now(),A=!0,H(function Sb(){var b=parseInt(c.now()-I,10);b>=l?(A=!1,I=c.now(),B!==h&&(e=B,B=h,a.call(g,{object:h,prevObject:e,timeDiff:b,args:m}))):H(Sb)}))}},context:void 0===g?null:g,call:function(){var a;(a=this.run).call.apply(a,arguments)}};d.set(a,g);return g},setContext:function(a,b){if(d.has(a)){var c=d.get(a);null==c.context&&(c.context=b)}}}}).call(this,c(12)["default"],c(7)["default"])},function(a,b,c){c.d(b,"a",function(){return p});
...
arguments);b=function(){return c};return c};return function(){return b.apply(void 0,arguments)}},noop:function(){return function(){}},toFunction:function(a){return"function"===typeof a?a:this.noop()},repeat:function(a,b){var c=void 0===b?{}:b,d=c.context,f=void 0===d?null:d;d=c.args;var l=void 0===d?[]:d;d=c.delay;var p=void 0===d?0:d;c=c.raf;c=void 0===c?!0:c;var C=Date.now(),q=!1,h=null,e=c?this.requestAnimationFrame.bind(this):H,B=c?this.cancelAnimationFrame.bind(this):clearTimeout;c=function A(){q?
...
d=b.clientWidth,f=b.clientHeight;return d>c||f>g?(c/=d,g/=f,Math.min(1,Math.max(c>g?.1:.35,Math.min(c,g)))):1},viewportGetter:function(a){a=a||m.document;var b=a.defaultView,c=function(c){/Trident|MSIE/.test(b.navigator.userAgent)?a.body.parentNode&&a.body.parentNode.appendChild(c):a.body.appendChild(c)},d=a.querySelector("ym-measure.ym-viewport"),g=a.querySelector("ym-measure.ym-zoom");null===d&&(d=f.DOMUtils.createElement("ym-measure",{className:"ym-viewport",style:{display:"block",top:0,right:0,
...
a)})(a)};return a}(),f=function(){function a(){this.m=[]}var b=a.prototype;b.use=function(a){this.m.push(a)};b.useRight=function(a){this.m.unshift(a)};b.run=function(a,b){return this._execute(a,b)};b._execute=function(a){for(var b=0,c=this.m.length;b<c;b++){var d=this.m[b](a);if(d===w)break;a=d}return a};return a}()},function(a,b,c){(function(b){function c(a,c,d,f,u,p,k){try{var g=a[p](k),h=g.value}catch(e){d(e);return}g.done?c(h):b.resolve(h).then(f,u)}a.exports=function(a){return function(){var d=
this,f=arguments;return new b(function(b,g){function l(a){c(q,b,g,l,n,"next",a)}function n(a){c(q,b,g,l,n,"throw",a)}var q=a.apply(d,f);l(w)})}}}).call(this,c(22).Promise)},function(a,b,c){var d=c(78)();a.exports=function(a){return a!==d&&null!==a}},function(a,b,c){c.r(b);c.d(b,"DocumentUtils",function(){return f});var d=function(a){return a?"IFRAME"===a.nodeName?a.contentDocument:a:null},f={open:function(a){(a=d(a))&&a.open()},write:function(a,b){var c=d(a);c&&c.write(b)},close:function(a){(a=d(a))&&
...
H)return H(a,0);if((k===c||!k)&&H)return k=H,H(a,0);try{return k(a,0)}catch(ca){try{return k.call(null,a,0)}catch(Sa){return k.call(this,a,0)}}}function l(a){if(q===clearTimeout)return clearTimeout(a);if((q===d||!q)&&clearTimeout)return q=clearTimeout,clearTimeout(a);try{return q(a)}catch(ca){try{return q.call(null,a)}catch(Sa){return q.call(this,a)}}}function g(){e&&B&&(e=!1,B.length?h=B.concat(h):I=-1,h.length&&n())}function n(){if(!e){var a=f(g);e=!0;for(var b=h.length;b;){B=h;for(h=[];++I<b;)B&&
B[I].run();I=-1;b=h.length}B=null;e=!1;l(a)}}function r(a,b){this.fun=a;this.array=b}function u(){}var p=a.exports={};try{var k="function"===typeof H?H:c}catch(A){k=c}try{var q="function"===typeof clearTimeout?clearTimeout:d}catch(A){q=d}var h=[],e=!1,B,I=-1;p.nextTick=function(a){var b=Array(arguments.length-1);if(1<arguments.length)for(var c=1;c<arguments.length;c++)b[c-1]=arguments[c];h.push(new r(a,b));1!==h.length||e||f(n)};r.prototype.run=function(){this.fun.apply(null,this.array)};p.title=
...
headers:{},method:"get",type:"json",data:null},b);if(b.headers===w||b.headers["Content-Type"]===w)c.headers=c.headers||{},c.headers["Content-Type"]=function(){switch(c.type){case "json":return"application/json";case "css":return"text/css";case "html":return"text/html";default:return"text/plain"}}();return(new a(function(a,b){var f=new XMLHttpRequest,l=new FileReader;"css"===c.type&&(f.responseType="blob");f.addEventListener("readystatechange",function(){var h=f.status;4===f.readyState&&(200<=h&&301>
...
b);f.open(c.method.toUpperCase(),c.url);Object(g.a)(c.headers,function(a,b){f.setRequestHeader(a,b)});f.send(c.data?JSON.stringify(c.data):w)}))["catch"](function(a){return{}})}}).call(this,c(22).Promise)},function(a,b,c){(function(a,c){var d=function(){if("undefined"!==typeof m)return m;if("undefined"!==typeof global)return global;if("undefined"!==typeof self)return self}(),g=function(){return Date.now()},f=function(b){return b?(b=this._getTime()-b,0>b&&a.warn("Invalid stamp: "+b),b):0},r=function(a,
...
c,b)});this.mocked=!1};c.setterInvoked=function(a,b,c){var e=this;this.mocked&&H(function(){e.send(a,"setter",{name:b,value:c})})};c.methodInvoked=function(a,b,c){var e=this;this.mocked&&H(function(){c=c.map(function(a){return a instanceof Image?Object(n.b)(a):a});e.send(a,"method",{name:b,args:c})})};c.send=function(a,b,c){this.events.emit(b,r.ObjectUtils.combine(c,{media:a}))};return b}();l()(h,"supported",d);b.a=h}).call(this,c(12)["default"])},function(a,b,c){(function(a){c.d(b,"a",function(){return d});
var d=function(b,c){void 0===c&&(c="body");return new a(function(a){null==b.querySelector(c)||t.hidden||t.msHidden||t.webkitHidden?function u(){null==b.querySelector(c)||t.hidden||t.msHidden||t.webkitHidden?H(u,100):a()}():a()})}}).call(this,c(22).Promise)},function(a,b,c){(function(a,f){var d=c(14),g=c.n(d);d=c(6);var n=c.n(d);d=c(17);var r=c.n(d);d=c(1);var u=c.n(d),p=c(11);d=c(15);var k=c(34),q=c(0),h=c(2),e=c(23),B=c(16),I=c(4),A="attributes namespace content parent next prev".split(" ");d=function(b){function c(c,
...
(k=!0,g(h,{origin:a.origin,location:c.targetWindow.location.href,identifier:c.identifier}),clearTimeout(C));else return!1},this.targetWindow));u&&m.push("response:"+u);(function wa(){c._sendMessage({data:d,type:a,target:c._getReceiver(l),flags:m});if(q&&p){var b=n;void 0===b&&(b=3E4);b=Date.now()-t>=b;!1===k&&(b?"function"===typeof f&&f():C=H(wa,100))}})()};c.subscribe=function(a,b){var c=this._createSubscriptionsGroup(a);if(!1===this._isSubscribed(c,b))c.push(b);else throw Error("This callback has already been subscribed to "+
...
c),c.className=a.className);c.className+=" ym-hidden-content";return{placeholder:c,bounds:d}};b.a=function(a){if(0<=g.indexOf(a.nodeName)){var b=f.DOMUtils.isHiddenContent(a);if(n.has(a))return n.get(a);if(b){var c=a.nodeName;b=a.textContent;if("#text"===c&&b&&""===b.trim())return a;b=function(a){switch(c){case "#text":var b=r(a,"span").placeholder;b.setAttribute("ym-text-content",l.randomizeString(a.textContent||""));return b;case "IMG":return b=r(a,"img"),a=b.placeholder,b=b.bounds,a.src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII\x3d",
a.width=b.width,a.height=b.height,a;case "TEXTAREA":case "INPUT":return b=r(a,"input"),a=b.placeholder,b=b.bounds,a.style.width=b.width+"px",a.style.height=b.height+"px",a;default:return b=r(a,"span"),a=b.placeholder,b=b.bounds,a.style.width=b.width+"px",a.style.height=b.height+"px",a}}(a);n.set(a,b);return b}}return a}},function(a,b,c){c.r(b);(function(a,f,l){c.d(b,"default",function(){return la});var d=c(40),n=c.n(d);d=c(24);var r=c.n(d);d=c(35);var k=c.n(d);d=c(5);var p=c.n(d);d=c(14);var C=c.n(d);
d=c(6);var q=c.n(d);d=c(17);var h=c.n(d);d=c(1);var e=c.n(d),B=c(16),I=c(23),A=c(0),ca=c(13),v=c(31),y=c(65),z=c(52),x=c(54),G=c(21);d=c(55);var D=c(56),E=c(57),F=c(58),K=c(59),J=c(15),M=c(27),N=c(60),oa=c(61),Ga=c(62),T=c(20),P=c(63),ha=c(11),ja=c(64),V=c(30),O=c(10),qa=c(38),aa=c(7),Q=c(2),X=c(4),U=c(28),ya=c(66),S=new d.a({checkOnLoad:!1,resetOnEnd:!0}),W={},R={counterId:null,maxSize:U.NumberUtils.size(50,"mb"),maxDuration:864E5,compression:!1,isEU:!1,recording:{keysMode:"explicit"}},Ma={disableIndex:!1},
fa=!0===Ga.a,Z=aa.IS_INCOGNITO||aa.DO_NOT_TRACK||"disable"===V.BrowserUtils.meta("webvisor"),na=m!==m.top;m.__YM_WV_RECORDABLE__===w&&Object.defineProperty(m,"__YM_WV_RECORDABLE__",{value:!0});var la=function(b){function c(c,d){void 0===c&&(c={});void 0===d&&(d={});var h=b.call(this)||this;e()(q()(h),"middlewares",[]);e()(q()(h),"options",Q.ObjectUtils.assign({},R));e()(q()(h),"initOptions",Q.ObjectUtils.assign({},Ma));e()(q()(h),"iframes",[]);e()(q()(h),"waitingBody",null);e()(q()(h),"ableToStart",
...
e){var d=c.offsets,g=c.counterId,f=e.origin;try{var l=p()({},h.options),B=f.split("//").pop(),n=g===l.counterId,q=B===m.location.host,r=-1!==(l.trustedDomains||[]).indexOf(B);q||r&&n?(h.offsets=d,h.sender.useRight(function(a){var b=a.data,c={};A.IterableUtils.fastIterate(["page","events","mutations"],function(a,e){b[e]&&(c[e]=b[e])});h.messenger.send("iframe_data",{data:c})})):X["default"].warn("Counter or domain mismatch, iframe will be recorded as master window");return a()}catch(Rb){b(Rb)}}});
e()(q()(h),"_sendEOF",I.FunctionUtils.once(function(){if(!h._EOF_SENT){var a=h._getEventObject("eof");h._saveChanges({events:[a]});h._EOF_SENT=!0}}));h._context=function(a){var b={};return a?(b.window=a.window||m,b.document=a.document||t,b):{window:m,document:t}}(d);h.sender=new x.a(h.middlewares.splice(0));h.captors=new a;h._timer=qa.TimeUtils.timer();h._tabId=Object(ja.a)();h._configOptions=p()({},c);Object.defineProperty(h.window,"__WV_ENABLED__",{value:!0});return!fa||Z?q()(h)||q()(h):h}h()(c,
b);var d=c.prototype;d.configure=function(){var a=Q.ObjectUtils.combine({},p()({},R,this._configOptions));this.frames=[];this.viewport=V.BrowserUtils.viewportGetter(this.document);this.zoomLevel=this.viewport.zoomLevel;this.prevMutationStamp=null;this.prevMutationOrderingID=0;this.ableToStart=this.inited=!1;this.startOptions=this.initException=null;this.precache=[];this.options=p()({},a);this.canvasProxy=v.a;this.MediaProxy=E.a;ha.c.addAttributesFilter(function(b,c,e){if(G.a.isValidNode(b)&&"value"===
c)return b=G.a.validate(b,a),c=b.forceRecord,b.isAllowed||c?e:G.a.encode(e)})};d.attachEvent=function(){for(var a,b=arguments.length,c=Array(b),e=0;e<b;e++)c[e]=arguments[e];M.a.on.apply(M.a,(a=[]).concat.apply(a,c));return c};d.removeEvent=function(){for(var a,b=arguments.length,c=Array(b),e=0;e<b;e++)c[e]=arguments[e];M.a.off.apply(M.a,(a=[]).concat.apply(a,c));return c};d["continue"]=function(){Z||(this.paused=!1)};d.findNode=function(a){return this.indexer.getNodeId(a)};d.pause=function(){Z||
(this.paused=!0)};d.middleware=function(a){this.sender?this.sender.use(a):this.middlewares.push(a);return this};d.init=function(a){var b=this;void 0===a&&(a={});this.initOptions=Q.ObjectUtils.assign({},this.initOptions,a||{});this.errorLogger(k()(r.a.mark(function Ha(){return r.a.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(fa&&!Z){a.next=2;break}return a.abrupt("return");case 2:return a.prev=2,a.next=5,Object(F.a)(b.document);case 5:b.waitingDocument=a.sent;a.next=11;break;case 8:a.prev=
8,a.t0=a["catch"](2),b.__handleDocumentLoadError(a.t0);case 11:return a.next=13,b.__handleDocumentLoad();case 13:case "end":return a.stop()}},Ha,null,[[2,8]])})),"init")["catch"](function(a){clearTimeout(b.cancelIfNotStarted);b.waitingDocument=!1;b.fatal("init-failed",a);b.sendErrors=H(function(){b.stop(!0,!1)},3E4)})};d.__handleDocumentLoadError=function(a){var b=a;"timeout"===a.message&&(b=Error("No \x3cbody\x3e found. Can't continue"));this.fatal("init-failed",b)};d.__handleDocumentLoad=function(){var a=
k()(r.a.mark(function Fa(){var a=this;return r.a.wrap(function(b){for(;;)switch(b.prev=b.next){case 0:return this.configure(),this.__initIndexer(),this.__initEventHandlers(),b.next=5,this._initMessenger();case 5:this.waitingDocument=!1,this.ableToStart=!0,this.cancelIfNotStarted=H(function(){a.stop(!0,!1)},3E4),this.emit("ready"),this.inited=!0,this.startOptions&&this.start(this.startOptions);case 11:case "end":return b.stop()}},Fa,this)}));return function(){return a.apply(this,arguments)}}();d.__initIndexer=
function(){var a=this;this.indexer=new K.a(this.document,{disabled:this.initOptions.disableIndex});if(p()({},this.options).childIframe)this.indexer.on("node",function(b){return a.connectSlaveRecorder(b)});this.indexer.use(ya.a);this.indexer.initialIndex()};d.__initEventHandlers=function(){this.summary=new z.a(this.document.documentElement,this.indexer,this);this.selection=new oa.a(m,this.document,this.indexer);this.keyCapture=new D.a("body",this);this.initOptions.disableMutations||this.summary.initObserver();
this._initCaptors();this._createSnapshot()};d.connectSlaveRecorder=function(a){var b=this;if("IFRAME"===a.nodeName&&a.name!==ca.a.NATIVE_IFRAME_NAME&&O.DOMUtils.isBlankOrSameOriginIframe(a,this.window)){try{var c=0<a.contentDocument.documentElement.childNodes.length&&"complete"===a.contentDocument.readyState}catch(tc){c=!0}var e=function fb(a){var c=a.contentWindow,e=a.contentDocument;X["default"].log("creating recorder");if(c&&e){if(!0===c.__YM_WV_RECORDABLE__)return X["default"].warn("Iframe has internal counter installed");
if(!0===c.__YM_RECORDING__)return X["default"].warn("We're already recording this iframe",a);a.contentWindow.__YM_RECORDING__=!0;c=b._createInstance(b._configOptions,{window:c,document:e});c.init(b.initOptions);c.start(b.startOptions);return X["default"].info("Recorder injected into the iframe",a)}H(function(){return fb(a)},10)},d=function(c){b.errorLogger(function(){if(c&&c.parentElement&&c.contentDocument&&O.DOMUtils.isBlankOrSameOriginIframe(a,b.window)&&!0!==c.contentWindow.__WV_ENABLED__)try{e(c)}catch(fb){X["default"].error(fb),
X["default"].warn("Probably this iframe is cross-origin")}},"ifLo")};this.attachEvent(a,"load",function(){d(a)},{capture:!0,passive:!0});c&&d(a)}};d.start=function(a){var b=this;void 0===a&&(a={});this.errorLogger(function(){if(b.ableToStart)if(!1===b.fatalError)if(!b.inited)b.savePageSnapshot(),b.fatal("init-failed",Error("Unknown error"));else{if(fa&&!Z){clearTimeout(b.cancelIfNotStarted);var c=(a||{}).forms;b.options.recording=Q.ObjectUtils.combine({},R.recording,{keysMode:void 0===c||c?"regular":
"explicit"});b.start=I.FunctionUtils.noop();b.started=!0;b.sendSnapshot().then(function(a){a&&(b._sendInitialEvents(),b._sendPreCachedData(),b._timer.start())})["catch"](function(a){b.fatal("recording-interrupted",a);b.start()});b["continue"]()}}else b.stop(!0,!0);else(function La(){b.ableToStart?b.start(a):H(La,50)})()},"start")};d.stop=function(a,b){var c=this;void 0===a&&(a=!1);void 0===b&&(b=!0);fa&&!Z&&(!1!==this.started&&this.inited||a)&&!0!==this.stopped&&(clearTimeout(this.cancelIfNotStarted),
...
this;this.keyCapture.addElementFilter(function(a){return"INPUT"===a.nodeName?"password"!==a.type&&!1===/ym-disable-keys/.test(a.className):!0});var b=Q.ObjectUtils.combine({},ca.a.captors,na?ca.a.iframeCaptors:null);A.IterableUtils.forin(b,function(c){if(!0===b[c]){var e=y.a[c]();a.errorLogger(function(){return e.create(a)},"init-captor-"+c);a.captors.set(c,e)}});M.a.on(this.window,"beforeunload",this.stop.bind(this))};d.throwError=function(a,b){void 0===b&&(b="recorder");this.emit("error",{error:a,
namespace:"recorder:"+b})};d.errorLogger=function(a,b){var c=this;void 0===b&&(b="recorder");try{var e=a();return e instanceof f?e["catch"](function(a){c.throwError(a,b+":async")}):e}catch(La){this.throwError(La,b)}};d._blockUpcomingCaptor=function(a,b){var c=this;void 0===b&&(b=Infinity);a&&(this._blockedCaptors=this._blockedCaptors||new l,this._blockedCaptors.add(a),Infinity>b&&H(function(){return c._releaseCaptor(a)},b))};d._releaseCaptor=function(a){a&&this._blockedCaptors.has(a)&&this._blockedCaptors["delete"](a)};
...
[]:e;return function(){for(var b=arguments.length,e=Array(b),h=0;h<b;h++)e[h]=arguments[h];c.errorLogger(function(){c.paused||a.apply(c,e.concat(d))},"universal-handler")}};d._createInstance=function(){for(var a=arguments.length,b=Array(a),c=0;c<a;c++)b[c]=arguments[c];return n()(this.constructor,b)};C()(c,[{key:"window",get:function(){return this._context.window}},{key:"document",get:function(){return this._context.document}},{key:"bodyNode",get:function(){return this.__bodyNode||(this.__bodyNode=
...
{key:"domain",get:function(){return L.protocol+"//"+(L.host||L.hostname)+(L.port?":"+L.port:"")}},{key:"tabId",get:function(){return this._tabId}}]);return c}(J.a),ka={IS_INCOGNITO:aa.IS_INCOGNITO,IS_MOBILE_DEVICE:aa.IS_MOBILE_DEVICE,DO_NOT_TRACK:aa.DO_NOT_TRACK};A.IterableUtils.forin(ka,function(a){var b={value:ka[a]};Object.defineProperty(la,a,b);Object.defineProperty(la.prototype,a,b)})}).call(this,c(12)["default"],c(22).Promise,c(8)["default"])},function(a,b,c){b=c(25)["default"];a.exports=c(69)()?
b:c(70)},function(a,b,c){(function(b){var c={object:!0,symbol:!0};a.exports=function(){if("function"!==typeof b)return!1;var a=b("test symbol");try{String(a)}catch(g){return!1}return c[typeof b.iterator]&&c[typeof b.toPrimitive]&&c[typeof b.toStringTag]?!0:!1}}).call(this,c(25)["default"])},function(a,b,c){(function(b){var d=c(71),l=c(85),g=Object.create,n=Object.defineProperties,r=Object.defineProperty,k=Object.prototype,p,m=g(null);if("function"===typeof b){var q=b;try{String(q());var h=!0}catch(I){}}var e=
function(){var a=g(null);return function(b){for(var c=0,e,h;a[b+(c||"")];)++c;b+=c||"";a[b]=!0;e="@@"+b;r(k,e,d.gs(null,function(a){h||(h=!0,r(this,e,d(a)),h=!1)}));return e}}();var B=function(a){if(this instanceof B)throw new TypeError("Symbol is not a constructor");return p(a)};a.exports=p=function ca(a){if(this instanceof ca)throw new TypeError("Symbol is not a constructor");if(h)return q(a);var b=g(B.prototype);a=a===w?"":String(a);return n(b,{__description__:d("",a),__name__:d("",e(a))})};n(p,
{"for":d(function(a){return m[a]?m[a]:m[a]=p(String(a))}),keyFor:d(function(a){var b;l(a);for(b in m)if(m[b]===a)return b}),hasInstance:d("",q&&q.hasInstance||p("hasInstance")),isConcatSpreadable:d("",q&&q.isConcatSpreadable||p("isConcatSpreadable")),iterator:d("",q&&q.iterator||p("iterator")),match:d("",q&&q.match||p("match")),replace:d("",q&&q.replace||p("replace")),search:d("",q&&q.search||p("search")),species:d("",q&&q.species||p("species")),split:d("",q&&q.split||p("split")),toPrimitive:d("",
q&&q.toPrimitive||p("toPrimitive")),toStringTag:d("",q&&q.toStringTag||p("toStringTag")),unscopables:d("",q&&q.unscopables||p("unscopables"))});n(B.prototype,{constructor:d(p),toString:d("",function(){return this.__name__})});n(p.prototype,{toString:d(function(){return"Symbol ("+l(this).__description__+")"}),valueOf:d(function(){return l(this)})});r(p.prototype,p.toPrimitive,d("",function(){var a=l(this);return"symbol"===typeof a?a:a.toString()}));r(p.prototype,p.toStringTag,d("c","Symbol"));r(B.prototype,
p.toStringTag,d("c",p.prototype[p.toStringTag]));r(B.prototype,p.toPrimitive,d("c",p.prototype[p.toPrimitive]))}).call(this,c(25)["default"])},function(a,b,c){var d=c(72),f=c(80),l=c(81),g=c(82);(a.exports=function(a,b){var c;if(2>arguments.length||"string"!==typeof a){var l=b;b=a;a=null}else l=arguments[2];if(null==a){var n=c=!0;var q=!1}else n=g.call(a,"c"),q=g.call(a,"e"),c=g.call(a,"w");n={value:b,configurable:n,enumerable:q,writable:c};return l?d(f(l),n):n}).gs=function(a,b,c,k){"string"!==typeof a&&
(k=c,c=b,b=a,a=null);null==b?b=w:l(b)?null==c?c=w:l(c)||(k=c,c=w):(k=b,b=c=w);if(null==a){var n=!0;a=!1}else n=g.call(a,"c"),a=g.call(a,"e");b={get:b,set:c,configurable:n,enumerable:a};return k?d(f(k),b):b}},function(a,b,c){a.exports=c(73)()?Object.assign:c(74)},function(a,b,c){a.exports=function(){var a=Object.assign;if("function"!==typeof a)return!1;var b={foo:"raz"};a(b,{bar:"dwa"},{trzy:"trzy"});return"razdwatrzy"===b.foo+b.bar+b.trzy}},function(a,b,c){var d=c(75),f=c(79),l=Math.max;a.exports=
function(a,b){var c,g,n=l(arguments.length,2);a=Object(f(a));var k=function(d){try{a[d]=b[d]}catch(h){c||(c=h)}};for(g=1;g<n;++g)b=arguments[g],d(b).forEach(k);if(c!==w)throw c;return a}},function(a,b,c){a.exports=c(76)()?Object.keys:c(77)},function(a,b,c){a.exports=function(){try{return Object.keys("primitive"),!0}catch(d){return!1}}},function(a,b,c){var d=c(36),f=Object.keys;a.exports=function(a){return f(d(a)?Object(a):a)}},function(a,b,c){a.exports=function(){}},function(a,b,c){var d=c(36);a.exports=
...
function(){function a(a){return"function"===typeof a}function c(){return function(){return b.nextTick(p)}}function d(){return"undefined"!==typeof T?function(){T(p)}:k()}function n(){var a=0,b=new ja(p),c=t.createTextNode("");b.observe(c,{characterData:!0});return function(){c.data=a=++a%2}}function r(){var a=new MessageChannel;a.port1.onmessage=p;return function(){return a.port2.postMessage(0)}}function k(){return function(){return H(p,1)}}function p(){for(var a=0;a<N;a+=2)(0,O[a])(O[a+1]),O[a]=w,
O[a+1]=w;N=0}function C(){try{var a=Function("return this")().require("vertx");T=a.runOnLoop||a.runOnContext;return d()}catch(fa){return k()}}function q(a,b){var c=this,d=new this.constructor(e);d[aa]===w&&M(d);var h=c._state;if(h){var g=arguments[h-1];P(function(){return F(h,d,g,c._result)})}else D(c,d,a,b);return d}function h(a){if(a&&"object"===typeof a&&a.constructor===this)return a;var b=new this(e);y(b,a);return b}function e(){}function B(a){try{return a.then}catch(fa){return S.error=fa,S}}
function I(a,b,c,e){try{a.call(b,c,e)}catch(la){return la}}function A(a,b,c){P(function(a){var e=!1,d=I(c,b,function(c){e||(e=!0,b!==c?y(a,c):x(a,c))},function(b){e||(e=!0,G(a,b))},"Settle: "+(a._label||" unknown promise"));!e&&d&&(e=!0,G(a,d))},a)}function ca(a,b){b._state===X?x(a,b._result):b._state===U?G(a,b._result):D(b,w,function(b){return y(a,b)},function(b){return G(a,b)})}function v(b,c,e){c.constructor===b.constructor&&e===q&&c.constructor.resolve===h?ca(b,c):e===S?(G(b,S.error),S.error=
null):e===w?x(b,c):a(e)?A(b,c,e):x(b,c)}function y(a,b){if(a===b)G(a,new TypeError("You cannot resolve a promise with itself"));else{var c=typeof b;null===b||"object"!==c&&"function"!==c?x(a,b):v(a,b,B(b))}}function z(a){a._onerror&&a._onerror(a._result);E(a)}function x(a,b){a._state===Q&&(a._result=b,a._state=X,0!==a._subscribers.length&&P(E,a))}function G(a,b){a._state===Q&&(a._state=U,a._result=b,P(z,a))}function D(a,b,c,e){var d=a._subscribers,h=d.length;a._onerror=null;d[h]=b;d[h+X]=c;d[h+U]=
e;0===h&&a._state&&P(E,a)}function E(a){var b=a._subscribers,c=a._state;if(0!==b.length){for(var e,d,h=a._result,g=0;g<b.length;g+=3)e=b[g],d=b[g+c],e?F(c,e,d,h):d(h);a._subscribers.length=0}}function F(b,c,e,d){var h=a(e),g=void 0,f=void 0,l=void 0,B=void 0;if(h){try{g=e(d)}catch(xa){S.error=xa,g=S}g===S?(B=!0,f=g.error,g.error=null):l=!0;if(c===g){G(c,new TypeError("A promises callback cannot return that same promise."));return}}else g=d,l=!0;c._state===Q&&(h&&l?y(c,g):B?G(c,f):b===X?x(c,g):b===
U&&G(c,g))}function K(a,b){try{b(function(b){y(a,b)},function(b){G(a,b)})}catch(Z){G(a,Z)}}function M(a){a[aa]=ba++;a._state=w;a._result=w;a._subscribers=[]}var L=void 0,J=L=Array.isArray?Array.isArray:function(a){return"[object Array]"===Object.prototype.toString.call(a)},N=0,T=void 0,W=void 0,P=function(a,b){O[N]=a;O[N+1]=b;N+=2;2===N&&(W?W(p):qa())},ha=(L="undefined"!==typeof m?m:w)||{},ja=ha.MutationObserver||ha.WebKitMutationObserver;ha="undefined"===typeof self&&"undefined"!==typeof b&&"[object process]"===
{}.toString.call(b);var V="undefined"!==typeof Uint8ClampedArray&&"undefined"!==typeof importScripts&&"undefined"!==typeof MessageChannel,O=Array(1E3),qa=void 0;qa=ha?c():ja?n():V?r():L===w?C():k();var aa=Math.random().toString(36).substring(2),Q=void 0,X=1,U=2,S={error:null},ba=0,ia=function(){function a(a,b){this._instanceConstructor=a;this.promise=new a(e);this.promise[aa]||M(this.promise);J(b)?(this._remaining=this.length=b.length,this._result=Array(this.length),0===this.length?x(this.promise,
this._result):(this.length=this.length||0,this._enumerate(b),0===this._remaining&&x(this.promise,this._result))):G(this.promise,Error("Array Methods must be provided an Array"))}a.prototype._enumerate=function(a){for(var b=0;this._state===Q&&b<a.length;b++)this._eachEntry(a[b],b)};a.prototype._eachEntry=function(a,b){var c=this._instanceConstructor,d=c.resolve;d===h?(d=B(a),d===q&&a._state!==Q?this._settledAt(a._state,b,a._result):"function"!==typeof d?(this._remaining--,this._result[b]=a):c===R?
(c=new c(e),v(c,a,d),this._willSettleAt(c,b)):this._willSettleAt(new c(function(b){return b(a)}),b)):this._willSettleAt(d(a),b)};a.prototype._settledAt=function(a,b,c){var e=this.promise;e._state===Q&&(this._remaining--,a===U?G(e,c):this._result[b]=c);0===this._remaining&&x(e,this._result)};a.prototype._willSettleAt=function(a,b){var c=this;D(a,w,function(a){return c._settledAt(X,b,a)},function(a){return c._settledAt(U,b,a)})};return a}(),R=function(){function b(a){this[aa]=ba++;this._result=this._state=
...
function(a,b){a.__proto__=b;return a};return c(b,f)}a.exports=c},function(a,b,c){b=function(){return this||"object"===typeof self&&self}()||Function("return this")();var d=b.regeneratorRuntime&&0<=Object.getOwnPropertyNames(b).indexOf("regeneratorRuntime"),f=d&&b.regeneratorRuntime;b.regeneratorRuntime=w;a.exports=c(90);if(d)b.regeneratorRuntime=f;else try{delete b.regeneratorRuntime}catch(l){b.regeneratorRuntime=w}},function(a,b,c){(function(b,c){!function(d){function g(a,b,c,e){b=Object.create((b&&
b.prototype instanceof l?b:l).prototype);e=new A(e||[]);b._invoke=h(a,c,e);return b}function f(a,b,c){try{return{type:"normal",arg:a.call(b,c)}}catch(V){return{type:"throw",arg:V}}}function l(){}function k(){}function p(){}function m(a){["next","throw","return"].forEach(function(b){a[b]=function(a){return this._invoke(b,a)}})}function q(a){function b(e,d,h,g){e=f(a[e],a,d);if("throw"===e.type)g(e.arg);else{var l=e.arg;return(e=l.value)&&"object"===typeof e&&v.call(e,"__await")?c.resolve(e.__await).then(function(a){b("next",
a,h,g)},function(a){b("throw",a,h,g)}):c.resolve(e).then(function(a){l.value=a;h(l)},function(a){return b("throw",a,h,g)})}}var e;this._invoke=function(a,d){function h(){return new c(function(c,e){b(a,d,c,e)})}return e=e?e.then(h,h):h()}}function h(a,b,c){var d=H;return function(h,g){if(d===M)throw Error("Generator is already running");if(d===L){if("throw"===h)throw g;return t()}c.method=h;for(c.arg=g;;){var l=c.delegate;if(l&&(l=e(l,c))){if(l===J)continue;return l}if("next"===c.method)c.sent=c._sent=
c.arg;else if("throw"===c.method){if(d===H)throw d=L,c.arg;c.dispatchException(c.arg)}else"return"===c.method&&c.abrupt("return",c.arg);d=M;l=f(a,b,c);if("normal"===l.type){d=c.done?L:K;if(l.arg===J)continue;return{value:l.arg,done:c.done}}"throw"===l.type&&(d=L,c.method="throw",c.arg=l.arg)}}}function e(a,b){var c=a.iterator[b.method];if(c===w){b.delegate=null;if("throw"===b.method){if(a.iterator["return"]&&(b.method="return",b.arg=w,e(a,b),"throw"===b.method))return J;b.method="throw";b.arg=new TypeError("The iterator does not provide a 'throw' method")}return J}c=
f(c,a.iterator,b.arg);if("throw"===c.type)return b.method="throw",b.arg=c.arg,b.delegate=null,J;c=c.arg;if(!c)return b.method="throw",b.arg=new TypeError("iterator result is not an object"),b.delegate=null,J;if(c.done)b[a.resultName]=c.value,b.next=a.nextLoc,"return"!==b.method&&(b.method="next",b.arg=w);else return c;b.delegate=null;return J}function B(a){var b={tryLoc:a[0]};1 in a&&(b.catchLoc=a[1]);2 in a&&(b.finallyLoc=a[2],b.afterLoc=a[3]);this.tryEntries.push(b)}function I(a){var b=a.completion||
{};b.type="normal";delete b.arg;a.completion=b}function A(a){this.tryEntries=[{tryLoc:"root"}];a.forEach(B,this);this.reset(!0)}function ca(a){if(a){var b=a[z];if(b)return b.call(a);if("function"===typeof a.next)return a;if(!isNaN(a.length)){var c=-1;b=function O(){for(;++c<a.length;)if(v.call(a,c))return O.value=a[c],O.done=!1,O;O.value=w;O.done=!0;return O};return b.next=b}}return{next:t}}function t(){return{value:w,done:!0}}var y=Object.prototype,v=y.hasOwnProperty,w,x="function"===typeof b?b:
{},z=x.iterator||"@@iterator",D=x.asyncIterator||"@@asyncIterator",E=x.toStringTag||"@@toStringTag";x="object"===typeof a;var F=d.regeneratorRuntime;if(F)x&&(a.exports=F);else{F=d.regeneratorRuntime=x?a.exports:{};F.wrap=g;var H="suspendedStart",K="suspendedYield",M="executing",L="completed",J={};d={};d[z]=function(){return this};(x=(x=Object.getPrototypeOf)&&x(x(ca([]))))&&x!==y&&v.call(x,z)&&(d=x);var N=p.prototype=l.prototype=Object.create(d);k.prototype=N.constructor=p;p.constructor=k;p[E]=k.displayName=
"GeneratorFunction";F.isGeneratorFunction=function(a){return(a="function"===typeof a&&a.constructor)?a===k||"GeneratorFunction"===(a.displayName||a.name):!1};F.mark=function(a){Object.setPrototypeOf?Object.setPrototypeOf(a,p):(a.__proto__=p,E in a||(a[E]="GeneratorFunction"));a.prototype=Object.create(N);return a};F.awrap=function(a){return{__await:a}};m(q.prototype);q.prototype[D]=function(){return this};F.AsyncIterator=q;F.async=function(a,b,c,e){var d=new q(g(a,b,c,e));return F.isGeneratorFunction(b)?
d:d.next().then(function(a){return a.done?a.value:d.next()})};m(N);N[E]="Generator";N[z]=function(){return this};N.toString=function(){return"[object Generator]"};F.keys=function(a){var b=[],c;for(c in a)b.push(c);b.reverse();return function O(){for(;b.length;){var c=b.pop();if(c in a)return O.value=c,O.done=!1,O}O.done=!0;return O}};F.values=ca;A.prototype={constructor:A,reset:function(a){this.next=this.prev=0;this.sent=this._sent=w;this.done=!1;this.delegate=null;this.method="next";this.arg=w;this.tryEntries.forEach(I);
if(!a)for(var b in this)"t"===b.charAt(0)&&v.call(this,b)&&!isNaN(+b.slice(1))&&(this[b]=w)},stop:function(){this.done=!0;var a=this.tryEntries[0].completion;if("throw"===a.type)throw a.arg;return this.rval},dispatchException:function(a){function b(b,e){h.type="throw";h.arg=a;c.next=b;e&&(c.method="next",c.arg=w);return!!e}if(this.done)throw a;for(var c=this,e=this.tryEntries.length-1;0<=e;--e){var d=this.tryEntries[e],h=d.completion;if("root"===d.tryLoc)return b("end");if(d.tryLoc<=this.prev){var g=
v.call(d,"catchLoc"),f=v.call(d,"finallyLoc");if(g&&f){if(this.prev<d.catchLoc)return b(d.catchLoc,!0);if(this.prev<d.finallyLoc)return b(d.finallyLoc)}else if(g){if(this.prev<d.catchLoc)return b(d.catchLoc,!0)}else if(f){if(this.prev<d.finallyLoc)return b(d.finallyLoc)}else throw Error("try statement without catch or finally");}}},abrupt:function(a,b){for(var c=this.tryEntries.length-1;0<=c;--c){var e=this.tryEntries[c];if(e.tryLoc<=this.prev&&v.call(e,"finallyLoc")&&this.prev<e.finallyLoc){var d=
...
2;for(b=a[a.length-1];0<=c;c--)b=b>a[c]?b:a[c]}return b},random:function(a,b){void 0===a&&(a=0);return Math.round(Math.random()*b+a)}}}])["default"]}catch(a){Pa={error:a,scope:"recoder"}}var k={mixin:function(a){var b,c;for(b=1;b<arguments.length;b++)if(arguments[b]){for(c in arguments[b])arguments[b].hasOwnProperty(c)&&(a[c]=arguments[b][c]);arguments[b].hasOwnProperty("toString")&&(a.toString=arguments[b].toString)}return a}},J=function(a){a=a||{};k.mixin(this,a);this._initComponent()};J.prototype._initComponent=
...
k.isEqual=function(a,b){var c=!0;k.forEachKey(a,function(a,f){b.hasOwnProperty(a)&&b[a]===f||(c=!1)});if(!c)return c;k.forEachKey(b,function(b,f){a.hasOwnProperty(b)&&a[b]===f||(c=!1)});return c};k.getNativeFunction=function(a,b){b=b||m;var c=b.constructor&&b.constructor.prototype&&b.constructor.prototype[a]||b[a];try{if(c&&c.apply)return function(){return c.apply(b,arguments)}}catch(d){return b[a]}return c};k.setTimeout=function(a,b,c){return k.getNativeFunction("setTimeout")(F(a,c||"setTimeout"),
b)};var y=J.inherit({_initComponent:function(){y.superclass._initComponent.apply(this,arguments);this._listeners=[]},on:function(a,b,c,d,f){f=y._getOpts(f);b=b.split(",");var l=b.length,g=this._listeners,n;for(n=0;n<l;n++){var r=b[n];var k=F(function(a){c.call(d||this,a||m.event)},"on"+(r||"")+(f.name||""));g[g.length]=[a,r,c,d,f,k];a.addEventListener?a.addEventListener(r,k,y._prepOpts(f)):a.attachEvent&&a.attachEvent("on"+r,k)}},un:function(a,b,c,d,f){f=y._getOpts(f);var l=this._listeners,g=l.length,
n;for(n=0;n<g;n++){var r=l[n];if(r[0]==a&&r[1]==b&&r[2]==c&&r[3]==d&&k.isEqual(r[4],f)){l.splice(n,1);this._removeListener(a,b,r[5],f);break}}},unAll:function(){var a=this._listeners,b=a.length,c;for(c=0;c<b;c++){var d=a[c];this._removeListener(d[0],d[1],d[5],d[4])}a.length=0},_removeListener:function(a,b,c,d){a.removeEventListener?a.removeEventListener(b,c,y._prepOpts(d)):a.detachEvent&&a.detachEvent("on"+b,c)}});y.supportsPassive=function(){if(y._supportsPassive!==w)return y._supportsPassive;y._supportsPassive=
!1;try{var a=Object.defineProperty({},"passive",{get:function(){return y._supportsPassive=!0}});m.addEventListener("test",null,a)}catch(b){}return y._supportsPassive};y._getOpts=function(a){return k.mixin({capture:!0,passive:!0},a||{})};y._prepOpts=function(a){return y.supportsPassive()?a:!!a.capture};y.on=function(){y._instance||(y._instance=new y);y._instance.on.apply(y._instance,arguments)};y.un=function(){y._instance&&y._instance.un.apply(y._instance,arguments)};var x={UNLOAD_MS:0,isPerfomance:m.performance&&
m.performance.timing&&m.performance.timing.navigationStart&&m.performance.now,getMs:function(){return 0<this.UNLOAD_MS?this.UNLOAD_MS:this.isPerfomance?Math.round(m.performance.timing.navigationStart+m.performance.now()):x.oldMs()},getFormStart:function(){return this.isPerfomance?Math.round(m.performance.now()):this.getMs()-this.initTime}};x.oldMs=Date.now?Date.now:function(){return(new Date).getTime()};x.initTime=x.getMs();y.on(m,"beforeunload,unload",function(){0===x.UNLOAD_MS&&(x.UNLOAD_MS=x.getMs())});
k.pad=function(a){return(10>a?"0":"")+a};x.getTimestamp=function(){var a=new Date;a=[a.getFullYear(),a.getMonth()+1,a.getDate(),a.getHours(),a.getMinutes(),a.getSeconds()];var b="",c;for(c=0;c<a.length;c++)b+=k.pad(a[c]);return b};x.getTimezone=function(){return-(new Date).getTimezoneOffset()};x.getMinutes=function(){return Math.floor(this.getMs()/1E3/60)};x.getSeconds=function(){return Math.round(this.getMs()/1E3)};x.isPerfomance||(x.deltaTime=0,x.lastNowTime=0,x.correctTime=0,x.timeCorrector=function(a){x.correctTime=
x.getMs();a&&x.correctTime<x.lastTime&&(x.deltaTime+=a-x.correctTime+20);k.setTimeout(function(){x.timeCorrector(x.correctTime)},20,"timeCorrector")});x.initCorrector=function(){x.isPerfomance||x.timeCorrector(0)};x.nowTime=function(){if(this.isPerfomance)return this.getMs();var a=this.getMs()+x.deltaTime;a<x.lastNowTime&&(a+=x.lastNowTime+10);return x.lastNowTime=a};x.nowEventTime=function(){return Math.round((x.nowTime()-x.initTime)/50)};k.toString=function(a){return Object.prototype.toString.call(a)};
k.isFunction=function(a){return"function"===typeof a};k.isArray=function(a){return k.isFunction(Array.isArray)?Array.isArray(a):"[object Array]"===k.toString(a)};k.mergeArrays=function(a){var b,c,d=arguments.length;for(b=1;b<d;b++){var f=arguments[b];if(k.isArray(f)||f&&"[object Arguments]"===f.toString())for(c=0;c<f.length;c++)a[a.length]=f[c]}return a};k.defer=function(a,b,c,d,f){return k.setTimeout(function(){a.apply(c,d||[])},b,f)};k.throttle=function(a,b,c,d){var f,l,g;return function(){l=arguments;
g=this;f||function(){f=null;l&&(a.apply(c||g,l),l=null,f=k.setTimeout(arguments.callee,b,d))}()}};var Aa=J.inherit({storage:null,storageKey:"dataBuffer",store:{_keys:[],_values:[],get:function(a){a=k.arrayIndexOf(this._keys,a);return-1==a?null:this._values[a]},set:function(a,b){this._keys.push(a);this._values.push(b)},pop:function(a){a=k.arrayIndexOf(this._keys,a);if(-1==a)return null;var b=this._values[a];this._keys.splice(a,1);this._values.splice(a,1);return b}},maxBufferSize:255,flushTimeout:1E4,
startBufferTime:0,active:!0,meta:null,onFlush:function(){},onFlushCtx:null,bufferExpireTime:864E5,_initComponent:function(){var a;Aa.superclass._initComponent.apply(this,arguments);this.wrappers=[];this._data=[];this._packetNumber=0;this._flushTID=null;this._saveToStorageThrottled=k.throttle(this._saveToStorage,300,this,"DataBuffer._saveToStorage");this.storage&&(a=this.storage.get(this.storageKey))&&a.data&&a.meta&&a.time&&a.time+this.bufferExpireTime>+x.getMs()&&this.onFlush.call(this.onFlushCtx||
this,this.dataFromStorage(a.data),a.meta,a.pnum);this.clear()},setWVType:function(a){this.wvType=a;this._sender.version=a},getFlushSize:function(){return this._data.length},mergeData:function(a,b){k.mergeArrays(a,b)},updateStamp:function(a,b){a.stamp!==w&&(b.stamp=a.stamp,"eof"!==a.type&&delete a.stamp)},append:function(a,b){this.mergeData(this._data,a);this._saveToStorageThrottled();this.active&&((b||this.getFlushSize()>=this.maxBufferSize||this.getFlushSize()===this.maxChunkSize)&&this._flush(b),
...
dataToStorage:function(a){return a},_saveToStorage:function(){this.storage&&this._data.length&&this.storage.set(this.storageKey,{data:this.dataToStorage(this._data),meta:this.meta,pnum:this._packetNumber,time:x.getMs()})}}),zb="ru ua by kz az kg lv md tj tm uz ee fr co.il com.ge com.am com.tr".split(" ");var ra=["mc.webvisor.org","mc.yandex.ru"];var D={storage:{},init:function(){var a=this;F(function(){m.Ya=m.Ya||{};m.Ya._metrika=m.Ya._metrika||{};a.storage=m.Ya._metrika},"",!0)();return this},setSafe:function(a,
b){var c=this;F(function(){c.storage[a]===w&&(c.storage[a]=b)},"",!0)();return this},set:function(a,b){F(function(){m.Ya._metrika[a]=b},"",!0)();return this},get:function(a,b){return F(function(){var c=m.Ya._metrika[a];return c===w?b:c},"",!0)()}};k.async=function(a,b,c){if(m.postMessage){var d="__ym__promise"+Math.random()+"_"+x.getMs();var f=function(c){try{var g=c.data}catch(n){return}g===d&&(c.stopPropagation&&c.stopPropagation(),a.call(b),y.un(m,"message",f,null,{passive:!1}))};y.on(m,"message",
f,null,{passive:!1,name:".async."+(c||"")});m.postMessage(d,"*")}else k.setTimeout(function(){a.call(b)},0)};var N=J.inherit({counterId:"",onlyCurrentDomain:!1,skipPrefix:!1,_initComponent:function(){var a;N.superclass._initComponent.apply(this,arguments);this._domain=null;if(!this.onlyCurrentDomain){var b=m.location.host.split(".");for(a=2;;)if(a<=b.length){if(this._domain="."+b.slice(-a).join("."),a++,this.isEnabled())break}else{this._domain=null;break}}},create:function(a,b,c){a=[this._prepareName(a)+
...
b=0;b<this.hostsInfo.length;b++)a=this.hostsInfo[b].split(this.COUNTERS_DELIMITER),1<parseInt(a[this.SUCCESS_COUNTER],10)&&(this.cookieIndex=parseInt(a[this.INDEX],10));this.cookieIndex===w&&(this.cookieIndex=1);this.selectedHost=ra[this.cookieIndex];return this},getUrls:function(a){var b=this,c=ra.slice();this.readCookie();var d=this.cookieIndex;c[0]=[c[d],c[d]=c[0]][0];this.hosts=c;return k.map(function(c){return[b.protocol,"//",c,"/",a].join("")},c)},onSuccess:function(a,b){var c=k.arrayIndexOf(ra,
this.hosts[a]),d=this;"beacon"!==b&&this.cookieIndex!==w&&c!==this.cookieIndex&&this.cookie.create(this.hostIndexCookieName,k.map(function(a){a=a.split(d.COUNTERS_DELIMITER);c==a[d.INDEX]&&(a[d.SUCCESS_COUNTER]=parseInt(a[d.SUCCESS_COUNTER],10)+1);return[a[d.INDEX],a[d.SUCCESS_COUNTER]].join(d.COUNTERS_DELIMITER)},this.hostsInfo).join(d.HOSTS_DELIMITER),1440)}});Va.isEnabled=function(){return 1!=(new Va).readCookie().cookieIndex};var Yb=J.inherit({transports:[],globalConfig:D,postParams:[],isDisabled:function(){return this.globalConfig.get("oo")},
send:function(a,b,c,d){var f=[a],l=this,g=c||function(){};if(l.isDisabled())g.call(d);else{var n=new Va({protocol:this.protocol});this.forceHost?f=[[this.protocol,"//",this.forceHost,"/",a].join("")]:ra&&(f=n.getUrls(a));(function p(a){if(a<this.transports.length)try{var c=new this.transports[a]({timeout:this.timeout,postParams:this.postParams,queryStringParams:this.queryStringParams});b["browser-info"]=c.logInfo(b["browser-info"]);(function e(h){h>=f.length?c.blockNext()||p.call(this,a+1):c.request(f[h],
b,function(a,b,f){a?(g.call(d,b,f),n.onSuccess(h,c.id)):k.async(function(){e.call(l,h+1)},this,"senderCall")},this)}).call(this,0)}catch(q){sa(q,"send by "+(c&&c.id)),p.call(this,a+1)}}).call(this,0)}}}),Ba={};k.keys=function(a){var b,c=[];for(b in a)a.hasOwnProperty(b)&&c.push(b);return c};Ba.stringify=function(a,b){var c=[],d=b||{},f={},l=k.keys(a).length,g,n;if(d.lastOrdering!==w)for(n=1;n<=b.lastOrdering.length;n++)f[b.lastOrdering[n-1]]=l+n;if(d.firstOrdering!==w)for(n=0;n<b.firstOrdering.length;n++)f[b.firstOrdering[n]]=
n;for(g in a)if(a.hasOwnProperty(g))if(d=a[g],k.isArray(d))for(n=0;n<d.length;n++)c.push({key:g,value:encodeURIComponent(g)+"\x3d"+encodeURIComponent(String(d[n]))});else c.push({key:g,value:encodeURIComponent(g)+"\x3d"+encodeURIComponent(String(d))});c.sort(function(a,b){var c=f[a.key],d=f[b.key];"undefined"===typeof c&&(c=l);"undefined"===typeof d&&(d=l);return c-d});return k.map(function(a){return a.value},c).join("\x26")};k.inArray=function(a,b){var c;for(c=0;c<a.length;c++)if(a[c]==b)return!0;
return!1};var Ca=J.inherit({postParams:[],timeout:1E4,index:0,blockNext:function(){return!1},logInfo:function(a){var b;if(a)return a=(b=a.match(/^ti:\d:/))?a.replace(b[0],""):a,"ti:"+this.index+":"+a},_buildUrl:function(a,b){var c=Ba.stringify(b,this.queryStringParams);return a+(-1<a.indexOf("?")?"\x26":c?"?":"")+c},_splitParams:function(a){var b={},c={};k.forEachKey(a,function(a,f){k.inArray(this.postParams,a)?c[a]=f:b[a]=f},this);return{get:b,post:c}},_parseResp:function(a){return a}}),Wa=Ca.inherit({id:"XHR",
index:7,method:"POST",withCredentials:!0,blockNext:function(){return!m.XMLHttpRequest||navigator.platform.match(/Win/)?!1:"withCredentials"in new m.XMLHttpRequest},request:function(a,b,c,d){var f=this,l;if(/[^a-z0-9.:-]/.test(L.host)&&m.opera&&"function"===typeof m.opera.version){var g=m.opera.version();if("string"===typeof g&&"12"===g.split(".")[0])return c.call(d,!1)}if(m.XMLHttpRequest){var n=new XMLHttpRequest;if("withCredentials"in n){b=this._splitParams(b);a=this._buildUrl(a,b.get);try{n.open(this.method,
...
a},_preparePostParams:function(a){return Ba.stringify(a.post)},_setHeaders:function(a){a.setRequestHeader("Content-Type","application/x-www-form-urlencoded")}}),z={};k.memorize=function(a,b){var c="memorize";return function(){"memorize"===c&&(c=a.apply(b||this,arguments));return c}};z.isAndroidWebView=F(function(){var a=navigator.userAgent||"";return a.match(/Android.*Version\/[0-9][0-9.]*\sChrome\/[0-9][0-9.]/)||a.match(/Android.*Version\/[0-9][0-9.]*\s(?:Mobile\s)?Safari\/[0-9][0-9.]*\sChrome\/[0-9][0-9.]*/)||
a.match(/; wv\).*Chrome\/[0-9][0-9.]*\sMobile/)},"isAndroidWebView");var Zb=Ca.inherit({id:"beacon",index:1,request:function(a,b,c,d){"function"===typeof navigator.sendBeacon&&!z.isAndroidWebView()&&navigator.onLine?(b=this._splitParams(b),b.get["force-urlencoded"]=1,c.call(d,navigator.sendBeacon(this._buildUrl(a,b.get),Ba.stringify(b.post)))):c.call(d,!1)}});k.random=function(a,b){2>arguments.length&&(b=a,a=0);1>arguments.length&&(b=1073741824);return Math.floor(Math.random()*(b-a))+a};var Xa=Ca.inherit({id:"form",
...
l,'"\x3e\x3c/iframe\x3e','\x3cform action\x3d"',this._buildUrl(a,b.get),'" method\x3d"post" target\x3d"',l,'" enctype\x3d"',this.enctype,'"\x3e'];k.forEachKey(b.post,function(a){k.mergeArrays(n,['\x3cinput type\x3d"hidden" autocomplete\x3d"off" autocorrect\x3d"off"',' autocapitalize\x3d"off" spellcheck\x3d"false" name\x3d"',a,'"/\x3e'])});k.mergeArrays(n,["\x3c/form\x3e"]);g.innerHTML=n.join("");f.body.appendChild(g);var r=g.getElementsByTagName("form")[0];k.forEachKey(b.post,function(a,b){r[a].value=
b});r.submit();k.setTimeout(function(){f.body.removeChild(g)},1E4,"TransportForm.request.2");return c.call(d,!0,"tf.request")},_createHtmlfile:function(){try{if(m.ActiveXObject){var a=new ActiveXObject("htmlfile");a.open();a.write("\x3chtml\x3e\x3cbody\x3e\x3c/body\x3e\x3c/html\x3e");a.close();return a}}catch(b){}return null}}),$b=Xa.inherit({id:"htmlfile",index:3,htmlfileOnly:!0}),Da=Ca.inherit({id:"img",index:4,request:function(a,b,c,d){a=this._buildUrl(a,b);var f=!1;b=t.createElement("img");c=
c||function(){};b.onload=F(function(){f||(c.call(d,!0),f=!0)},"TransportImage.request");b.onerror=F(function(){f||(c.call(d,!1),f=!0)},"TransportImage.request");b.src=a;this.timeout&&k.setTimeout(function(){f||(c.call(d,!1),f=!0)},this.timeout,"ti.request")}}),ba={stringify:function(a){try{var b=JSON.stringify(a)}catch(c){}return k.inArray(["{}",w],b)?"null":b}};k.toJSON=function(a){var b;if(a===w)return"";if(null===a)return"null";switch(a.constructor){case Boolean:return a.toString();case Number:return isFinite(a)?
a.toString():"null";case String:return'"'+a.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r")+'"';case Array:var c=[];var d=0;for(b=a.length;d<b;d++)c[c.length]=k.toJSON(a[d]);return"["+c.join(",")+"]";case Object:c=[];for(d in a)a.hasOwnProperty(d)&&a[d]!==w&&(c[c.length]=k.toJSON(d)+":"+k.toJSON(a[d]));return"{"+c.join(",")+"}";default:return ba.stringify(a)}};var ia=J.inherit({counterId:"",_initComponent:function(){ia.superclass._initComponent.apply(this,arguments);
this._ls=null;try{this._ls=m.localStorage}catch(a){}},set:function(a,b){if(this.isEnabled())try{!b||b&&k.isArray(b)&&!b.length?this.remove(a):this._ls.setItem(this._getLsKey(a),k.toJSON(b))}catch(c){}},get:function(a){if(this.isEnabled())try{return JSON.parse(this._ls.getItem(this._getLsKey(a)))}catch(b){}return null},remove:function(a){if(this.isEnabled())try{this._ls.removeItem(this._getLsKey(a))}catch(b){}},isEnabled:function(){return this._ls&&m.JSON&&"object"==typeof this._ls&&"object"==typeof m.JSON},
getStorageId:function(){var a=this.get("lsid");a||(a=Math.round(Math.random()*x.getMs()),this.set("lsid",a));return a},clearStorageId:function(){this.remove("lsid")},_getLsKey:function(a){return"_ym_alt"+this.counterId+"_"+a}});k.fnv32a=function(a){var b=2166136261,c;var d=0;for(c=a.length;d<c;++d)b^=a.charCodeAt(d),b+=(b<<1)+(b<<4)+(b<<7)+(b<<8)+(b<<24);return b>>>0};k.clearTimeout=function(a){return k.getNativeFunction("clearTimeout")(a)};k.getTld=function(){if(!this._tld){var a=L.hostname.split(".");
this._tld=a[a.length-1]}return this._tld};var W={abc:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",tail:"+/\x3d",tailSafe:"*-_",encode:function(a,b){var c=(W.abc+(b?W.tailSafe:W.tail)).split(""),d=a.length,f=[],l=d-d%3,g;for(g=0;g<l;g+=3){var n=(a[g]<<16)+(a[g+1]<<8)+a[g+2];k.mergeArrays(f,[c[n>>18&63],c[n>>12&63],c[n>>6&63],c[n&63]])}switch(d-l){case 1:n=a[l]<<4;k.mergeArrays(f,[c[n>>6&63],c[n&63],c[64],c[64]]);break;case 2:n=(a[l]<<10)+(a[l+1]<<2),k.mergeArrays(f,[c[n>>12&63],
c[n>>6&63],c[n&63],c[64]])}return f.join("")},decode:function(a,b){for(var c=W.abc+(b?W.tailSafe:W.tail),d=0,f="",l,g,n,k,u;a.length%4;)a+="\x3d";do{l=c.indexOf(a.charAt(d++));g=c.indexOf(a.charAt(d++));k=c.indexOf(a.charAt(d++));u=c.indexOf(a.charAt(d++));if(0>l||0>g||0>k||0>u)return null;n=l<<18|g<<12|k<<6|u;l=n>>16&255;g=n>>8&255;n&=255;f=64==k?f+String.fromCharCode(l):64==u?f+String.fromCharCode(l,g):f+String.fromCharCode(l,g,n)}while(d<a.length);return f}},Ia={encode:function(a){var b=[],c;var d=
0;for(c=a.length;d<c;d++){var f=a.charCodeAt(d);128>f?b.push(f):(127<f&&2048>f?b.push(f>>6|192):(b.push(f>>12|224),b.push(f>>6&63|128)),b.push(f&63|128))}return b}};k.isNativeFunction=function(a,b){return a&&"function"===typeof a?(new RegExp("function\\s*"+b+"\\s*\\(\\)\\s*\\{\\s*\\[native[\\s-]code\\]\\s*\\}","i")).test(a.toString()):!1};var v={removeNode:function(a){var b=a&&a.parentNode;b&&b.removeChild(a)}};z.isSafariWebView=F(function(){var a=navigator.userAgent||"";return navigator.vendor&&
-1<navigator.vendor.indexOf("Apple")&&(!a.match(/Safari/)&&a.match(/Mobile/)||a.match(/CFNetwork\/[0-9][0-9.]*.*Darwin\/[0-9][0-9.]*/)||-1!==a.indexOf("FB_IAB")||-1!==a.indexOf("FBAV")||-1!==a.indexOf("OKApp")||-1!==a.indexOf("GSA/"))},"isSafariWebView");z.isSafari=function(){try{return navigator.vendor&&-1<navigator.vendor.indexOf("Apple")&&navigator.userAgent&&!navigator.userAgent.match("CriOS")}catch(a){}return!1};z.getMacOSVersion=F(function(){var a=navigator.userAgent.match(/Mac OS X ([0-9]+)_([0-9]+)_([0-9]+)/);
return a?[+a[1],+a[2],+a[2]]:[0,0,0]},"",!0);z.getPlatform=F(function(){return""+navigator.platform},"",!0);z.isIOS=F(function(){var a=z.getPlatform()||"";return"iPhone"===a||"iPad"===a},"",!0);z.getITPYaBroVersion=function(){var a=/\sYptp\/\d\.(\d+)\s/,b=null;m.navigator&&navigator.userAgent&&(a=a.exec(navigator.userAgent))&&1<a.length&&(b=parseInt(a[1],10));return b};z.edgVersion=k.memorize(function(){var a=null;var b=/Edg\/(\d+)\./;m.navigator&&navigator.userAgent&&(b=navigator.userAgent.match(b))&&
1<b.length&&(a=parseInt(b[1],10));return a});z.isFF=F(function(a){var b=!1;m&&m.document&&m.document.documentElement&&m.document.documentElement.style&&(b="MozAppearance"in m.document.documentElement.style&&"undefined"!==typeof m.InstallTrigger);if(b&&a&&m.navigator&&m.navigator.userAgent&&m.navigator.userAgent.match){var c=m.navigator.userAgent.match(/Firefox\/([0-9]+)/);b=!1;c&&c.length&&(c=+c[1],b=c>=a)}return b},"isFF");var Ea={_storage:new ia,globalConfig:null,key:"zzlc",userInfo:"",updateInfo:function(a){k.forEachKey(this.getInfoFlags(),
function(b,c){var d=c.call(this);d&&(a[b]=d)},this);return a},getYm:function(){var a=this._storage.get(this.ymKey)||{};return a.resp?a.resp:this.genYm.call(this,a)},getYmD:function(){var a=this._storage.get(this.ymKey)||{};if(a.dmn)return a.dmn},getZZ:function(){return this._storage.get(this.key)?this._storage.get(this.key):this.zz},getPP:function(){return this.globalConfig&&this.globalConfig.get("pp")?this.globalConfig.get("pp"):this.pp},getPU:function(){return this.globalConfig&&this.globalConfig.get("pu")?
this.globalConfig.get("pu"):this.pu},getFip:function(){if(this._storage.get(this.fipKey))return this._storage.get(this.fipKey)},getInfoFlags:function(){return{pi:this.getYm,pid:this.getYmD,zz:this.getZZ,pp:this.getPP,pu:this.getPU,fip:this.getFip}},checkVersion:function(){var a=z.edgVersion();var b=z.getITPYaBroVersion();if(this.globalConfig.get("isEU"))return 1;if(50<=b&&99>=b||a&&79<=a)return 0;a=z.getMacOSVersion();return!((z.isIOS()||10<=a[0]&&13<=a[2])&&z.isSafari())||z.isSafariWebView()},noop:function(){},
genPu:function(a){var b=k.fnv32a(m.location.host)+this.userInfo;this.pu=b;a.set("pu",b);return b},ymKey:"pi",genYm:function(a){var b=this,c=M(),d=x.getMinutes();if(!this.checkVersion()&&m.fetch&&this._storage.get("retryReqs")&&"yandex.ru"==c.hostname&&"/"==c.pathname&&!(a.lt&&a.lt+1440>d)){a.lt=d;c=["auto.ru/daiku","thequestion.ru/daiku","www.kinopoisk.ru/daiku","www.maximonline.ru/_ym"];var f=c[k.random(0,c.length)];fetch("//"+f,{credentials:"include"}).then(function(a){return a.json()}).then(function(c){c&&
(a.resp=c._ym_uid,a.dmn=W.encode(Ia.encode(f)),b._storage.set(b.ymKey,a))})["catch"](function(){b._storage.set(b.ymKey,a)})}},initPU:function(a,b){var c=this;var d=z.isFF(68);this.globalConfig=b;b.get("pu")!==w||this.checkVersion()&&!d||(b.setSafe("pu",null),a.addHandler("gpu-get",function(){return{type:"gpu-get",pu:b.get("pu")}},this),m.opener?(d=k.setTimeout(function(){c.genPu(b)},200,"pu"),a.sendToIframe(m.opener,{type:"gpu-get"},this.handleGpu(d),this)):this.genPu(b))},handleGpu:function(a){return function(b){b=
b.pu;k.clearTimeout(a);b&&(this.pu=b,this.globalConfig.set("pu",b))}},onicecandidate:F(function(a){var b;try{var c=(b=a.localDescription.sdp)&&b.match(/c=IN\s[\w\d]+\s([\w\d:.]+)/)}catch(d){a.onicecandidate=this.noop;"closed"!==a.iceConnectionState&&a.close();return}c&&0<c.length&&(this.pp=k.fnv32a(c[1]),this.globalConfig.set("pp",this.pp));a.onicecandidate=this.noop;a.close()},"wrt"),onOffer:function(a,b){k.isFunction(a.setLocalDescription)&&a.setLocalDescription(b,this.noop,this.noop)},initPP:F(function(a){var b=
m.RTCPeerConnection||m.mozRTCPeerConnection||m.webkitRTCPeerConnection;this.globalConfig=a;if(m.navigator.onLine&&b&&a.get("pp")==w&&(this.globalConfig.setSafe("pp",null),b&&b.prototype&&b.prototype.constructor&&b.prototype.constructor.name)){try{var c=new b({iceServers:[]});c.createDataChannel("y.metrika")}catch(f){return}if(k.isFunction(c.createOffer)&&!c.createOffer.length){try{var d=c.createOffer()}catch(f){return}k.isFunction(d.then)&&d.then(k.bind(this.onOffer,this,c));c.onicecandidate=k.bind(this.onicecandidate,
this,c)}}},"rcinit"),initZZ:function(){var a="ru";var b=z.isFF(68);var c=this;this.getZZ()||this.checkVersion()&&!b||(b&&(a="md"),b=k.getNativeFunction("createElement",t)("iframe"),b.style.display="none",b.style.width="1px",b.style.height="1px",b.style.visibility="hidden",b.src="https://mc.yandex."+a+W.decode("L21ldHJpa2EvenpsYy5odG1s"),m.document.documentElement.appendChild(b),y.on(m,"message",this.onMessage,this,{passive:!1}),this.frame=b,this.timeout=k.setTimeout(function(){y.un(m,"message",c.onMessage,
c,{passive:!1});v.removeNode(c.frame);c.zz="na"},3E3,"cd.initZZ"))},onMessage:function(a){a.data&&a.data.substr&&"__ym__zz"===a.data.substr(0,8)&&(this.zz=a.data.substr(8),v.removeNode(this.frame),this._storage.set(this.key,this.zz),y.un(m,"message",this.onMessage,this,{passive:!1}),k.clearTimeout(this.timeout))},fipKey:"fip",fpFactors:["webGL","plugins","applePay","dnt"],initFip:function(){if(Object.keys&&!this.checkVersion()&&!this._storage.get(this.fipKey)){var a=new lb(k.reduce(function(a,c){a[c]=
1;return a},{},this.fpFactors));a=a.toString(!1).join("-");this._storage.set(this.fipKey,a)}}},T=Yb.inherit({protocol:"",timeout:4E3,queryStringParams:{firstOrdering:["wmode","callback","cnt-class"],lastOrdering:["browser-info"]},resource:"",counterId:"",counterType:0,retry:!1,transports:[Zb,Wa,Da,$b],_initComponent:function(){T.superclass._initComponent.apply(this,arguments);this.retry&&(this._storage=new ia)},send:function(a,b,c,d){var f=this.globalConfig.get(ua.globalKey),l=this;f&&3!==this.counterId?
f(function(){var g=l._registerRequest(a,b);l._sendSavedRequest(g,a,b,c,d)},a):(f=l._registerRequest(a,b),l._sendSavedRequest(f,a,b,c,d))},_sendSavedRequest:function(a,b,c,d,f){var l=this.globalConfig.get("firstReqStatus"),g=b.forceNoRedirect;if("process"==l)this.globalConfig.set("firstReqCallbacks",k.mergeArrays(this.globalConfig.get("firstReqCallbacks")||[],[[this,arguments]]));else{l||this.globalConfig.set("firstReqStatus","process");this.counterType&&(b["cnt-class"]=this.counterType);this.globalConfig.get("pri")&&
(c.pri=this.globalConfig.get("pri"));c.st=x.getSeconds();c.u=T._userID;this.globalConfig.get("isEU")||(c=Ea.updateInfo(c));c.hi=T._hostID;l=[this.resource,"/",this.counterId,g?"/1":""].join("");delete b.forceNoRedirect;var n=[];c&&(k.forEachKey(c,function(a,b){"t"!=a&&k.mergeArrays(n,[a,b])}),c.t&&k.mergeArrays(n,["t",c.t]));n.length&&(b["browser-info"]=n.join(":"));return T.superclass.send.call(this,l,b,function(){var b;this.globalConfig.set("firstReqStatus","complete");this._unregisterRequest(a);
var c=this.globalConfig.get("firstReqCallbacks");this.globalConfig.set("firstReqCallbacks",null);if(c)for(b=0;b<c.length;b++)c[b][0]._sendSavedRequest.apply(c[b][0],c[b][1]);d&&d.apply(f,arguments)},this)}},_isRetryEnabled:function(){return this.retry&&this._storage&&this._storage.isEnabled()},_registerRequest:function(a,b){var c;if(this._isRetryEnabled()){b.rqnl=b.rqnl||0;b.rqnl++;var d=this._storage.get("retryReqs")||{};for(c=1;d[c];)c++;d[c]={protocol:this.protocol,host:this.host,resource:this.resource,
counterId:this.counterId,counterType:this.counterType,postParams:this.postParams,params:a,browserInfo:b,ghid:this.globalConfig.get("_globalMetrikaHitId"),time:x.getMs()};this._storage.set("retryReqs",d);return c}},_unregisterRequest:function(a){if(a&&this._isRetryEnabled()){var b=this._storage.get("retryReqs")||{};b[a]&&(delete b[a],this._storage.set("retryReqs",b))}},_getVersion:F(function(){return va},"",!0)});T._storage=new ia;T.initCookie=function(a){var b=new N({onlyCurrentDomain:"uid"!==a}),
c=b.read(a),d=T._storage.get(a),f=!1,l=b.read("d"),g=x.getSeconds();d&&!c&&(c=d,f=!0,b.create(a,c,525600),b.create("d",g,525600));if(!c)c=g+""+k.random(),b.create(a,c,525600),b.create("d",g,525600);else if(!l||15768E3<g-parseInt(l))b.create(a,c,525600),b.create("d",g,525600);T._storage.set(a,c);T._hostID=b.read("hostIndex");T._userID=c;return f};T.retransmit=function(a){var b=T._storage,c=b.get("retryReqs")||{},d;b.remove("retryReqs");k.forEachKey(c,function(b,c){var g=x.getMs();a.get("firstReqStatus")||
a.set("firstReqStatus","complete");c.ghid&&c.ghid!=a.get("_globalMetrikaHitId")&&c.time&&c.time+1728E5>g&&500<g-c.time&&2>=c.browserInfo.rqnl&&(d=new T({protocol:c.protocol,host:c.host,resource:c.resource,counterId:c.counterId,counterType:c.counterType,postParams:c.postParams||[],retry:!0}),d.send(c.params,c.browserInfo))})};k.fletcher=function(a){for(var b=a.length,c=0,d=255,f=255,l,g,n;b;){l=21<b?21:b;b-=l;do g="string"==typeof a?a.charCodeAt(c):a[c],c++,255<g&&(n=g>>8,g&=255,g^=n),d+=g,f+=d;while(--l);
d=(d&255)+(d>>8);f=(f&255)+(f>>8)}a=(d&255)+(d>>8)<<8|(f&255)+(f>>8);return 65535==a?0:a};k.arrayEvery=function(a,b,c){var d;for(d=0;d<a.length;d++)if(!b.call(c,a[d],d,a))return!1;return!0};k.is4Bytes=function(a){return!k.arrayEvery((encodeURIComponent(a).match(/(%[A-F,\d]{2})+/g)||[]).join("").split("%"),function(a){return 240>parseInt(a,16)})};k.trim=function(a,b){a=String(a).replace(/^\s+|\s+$/g,"");b&&a.length>b&&(a=a.substr(0,b));return a};k.isNumber=function(a){return isFinite(a)&&!isNaN(a)&&
"[object Number]"===k.toString(a)};k.isString=function(a){return"[object String]"===k.toString(a)};k.warning=function(){m.console&&"function"===typeof m.console.warn&&console.warn.apply(console,arguments)};k.isObject=function(a){try{return a&&null!==a&&"[object Object]"===k.toString(a)}catch(b){return!1}};k._urlParser=null;k.parseUrl=function(a){if(!this._urlParser)try{this._urlParser=t.createElement("a")}catch(b){}return this._urlParser?(this._urlParser.href=a,{protocol:this._urlParser.protocol,
host:this._urlParser.host,port:this._urlParser.port,hostname:this._urlParser.hostname,hash:this._urlParser.hash,search:this._urlParser.search,query:this._urlParser.search.replace(/^\?/,""),pathname:this._urlParser.pathname||"/",path:(this._urlParser.pathname||"/")+this._urlParser.search,href:this._urlParser.href}):{}};k._playerRegexp=/^.+\.mtproxy\.yandex\.net$/;k.isMetrikaPlayer=function(){return"MetrikaPlayer"==m.name||this._playerRegexp.test(m.location.hostname)};v.getDocumentCharset=function(){return(""+
(t.characterSet||t.charset||"")).toLowerCase()};v.getBody=function(){for(var a=t.getElementsByTagName("body");0<a.length;)return a[0]};v.getRootElement=function(){var a=t.documentElement,b=v.getBody();return"CSS1Compat"==t.compatMode?a:b||a};v.getViewportSize=function(){var a=v.getRootElement();return[a.clientWidth||m.innerWidth,a.clientHeight||m.innerHeight]};v.getDocumentTitle=function(){var a=t.title;"string"!=typeof a&&(a=(a=t.getElementsByTagName("title"))&&a.length?a[0].innerHTML:"");return a};
z.getSilverlightVersion=k.memorize(function(){if(m.ActiveXObject)try{var a=new ActiveXObject("AgControl.AgControl");var b=function(a,b,d,f){for(;c(a,b);)b[d]+=f;b[d]-=f};var c=function(a,b){return a.isVersionSupported(b[0]+"."+b[1]+"."+b[2]+"."+b[3])};var d=[1,0,0,0];b(a,d,0,1);b(a,d,1,1);b(a,d,2,1E4);b(a,d,2,1E3);b(a,d,2,100);b(a,d,2,10);b(a,d,2,1);b(a,d,3,1);var f=d.join(".")}catch(l){}else if(b=m.navigator,b=b.plugins&&b.plugins["Silverlight Plug-In"])f=b.description;return f||""});z.getFlashVersion=
k.memorize(function(){var a=m.navigator;if("undefined"!=typeof a.plugins&&"object"==typeof a.plugins["Shockwave Flash"]){var b=a.plugins["Shockwave Flash"];var c=b.version;if((b=b.description)||c)if(a=a.mimeTypes,"undefined"==typeof a||!a["application/x-shockwave-flash"]||a["application/x-shockwave-flash"].enabledPlugin)c?z._flashVersion=c:b&&(z._flashVersion=b.replace(/([a-zA-Z]|\s)+/,"").replace(/(\s+r|\s+b[0-9]+)/,"."))}else if("undefined"!=typeof m.ActiveXObject)try{if(c=new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),
b=c.GetVariable("$version"))z._flashVersion=b.split(" ")[1].replace(/,/g,".").replace(/[^.\d]/g,"")}catch(d){}return z._flashVersion});z.getLanguage=k.memorize(function(){var a=(m.navigator?navigator.language||navigator.userLanguage||navigator.browserLanguage||navigator.systemLanguage:"").toLowerCase();return k.isString(a)?a:""});z.getJavaEnabled=k.memorize(function(){try{return navigator.javaEnabled()}catch(a){return!1}});z.getFingerPrint=k.memorize(function(){var a=[],b;if(navigator.plugins&&navigator.plugins.length)for(b=
0;b<navigator.plugins.length;b++){var c=navigator.plugins[b];k.mergeArrays(a,[c.name,c.version,c.description,c.filename])}if(navigator.mimeTypes&&navigator.mimeTypes.length)for(b=0;b<navigator.mimeTypes.length;b++)c=navigator.mimeTypes[b],k.mergeArrays(a,[c.type,c.description,c.suffixes]);return k.fnv32a(a.join(";"))+"01"});z.getNotificationPermission=function(){try{var a=Notification.permission}catch(b){}switch(a){case "denied":return 1;case "granted":return 2}};z.isIframe=k.memorize(function(){try{return m.top!=
m}catch(a){return!1}});z._nMap={other:"0",none:"1",unknown:"2",wifi:"3",ethernet:"4",bluetooth:"5",cellular:"6",wimax:"7",mixed:"8"};z.netType=function(){var a=(navigator.connection||{type:""}).type;return z._nMap[a]||a};z.isHeadLess=k.memorize(function(){var a,b=["_phantom","__nightmare","callPhantom"];for(a=0;a<b.length;a++)if(m[b[a]])return!0;return/PhantomJS/.test(m.navigator.userAgent)||m.navigator.webdriver||m.isChrome&&!m.chrome?!0:/HeadlessChrome/.test(m.navigator.userAgent)});z.getNavigationStart=
k.memorize(function(){var a=m.performance||m.webkitPerformance;return a&&a.timing&&a.timing.navigationStart});z.isSameOriginTopFrame=function(){try{return m.top.contentWindow||!0}catch(a){return!1}};z.isDesktop=function(a){var b=a.get("bt",{});a.get("bt")===w&&(b.p=navigator.getBattery?navigator.getBattery():null,a.set("bt",b),b.p&&b.p.then&&b.p.then(function(a){b.v=a.charging&&0===a.chargingTime}));return b.v};z.isSelenium=k.memorize(function(){var a=["_selenium","callSelenium","_Selenium_IDE_Recorder"],
...
v.getRootElement().appendChild(b))})},_saveReq:function(a){this._value=a=a?"1":"2";this._setReqStatus("complete");this._getLs().create("isad",a,1200)},_setReqStatus:function(a){try{this.globalConfig.set("adStatus",a)}catch(b){}},_getReqStatus:function(){try{return this.globalConfig.get("adStatus")}catch(a){return"complete"}},_getLs:function(){this._ls||(this._ls=new N);return this._ls}};Ia.decode=function(a){for(var b="",c=0,d,f,l;c<a.length;)d=a.charCodeAt(c),128>d?(b+=String.fromCharCode(d),c++):
191<d&&224>d?(f=a.charCodeAt(c+1),b+=String.fromCharCode((d&31)<<6|f&63),c+=2):(f=a.charCodeAt(c+1),l=a.charCodeAt(c+2),b+=String.fromCharCode((d&15)<<12|(f&63)<<6|l&63),c+=3);return b};k.reduce=function(a,b,c){var d=0;b==w&&(b=c[0],d++);for(;d<c.length;)b=a(b,c[d]),d++;return b};k.filter=function(a,b){var c,d=[];for(c=0;c<b.length;c++)a(b[c])&&d.push(b[c]);return d};ba.parse=function(a){try{return JSON.parse(a)}catch(b){return null}};var Ja=T.inherit({hitId:0,trackHash:!1,trimParams:!1,webvisor:!1,
...
{},this.paramsQueue),this.paramsQueue=k.filter(this._filter,this.paramsQueue));return k.mixin({},a,b)}},postParams:["site-info"],countersNoTitle:"22836271 9928105 26128362 29850769 22327510 40081755 16082914 279297 23323747 16082899".split(" "),fake:!1,sendTitle:!0,_initComponent:function(){Ja.superclass._initComponent.apply(this,arguments);this._trackHash=this.trackHash;"0"===""+this.counterType&&(this.sendTitle=-1===k.arrayIndexOf(this.countersNoTitle,""+this.counterId))},setTrackHash:function(a){this._trackHash=
a},sendHit:function(a){this._hitExt({url:a.url,title:a.title,referrer:a.referrer,vParams:a.vParams,modes:k.mixin(a.modes||{},{ar:!0,saveRef:!0,pv:!0}),callback:a.callback,hasPrerender:a.hasPrerender,ctx:a.ctx},"hit")},sendExperiments:function(a){this._hitExt({url:M().href,title:"",referrer:"",modes:{ex:!0,ar:!0},experiments:a.experiments,callback:a.callback,ctx:a.ctx},"exp")},sendPrerenderHit:function(a){this._hitExt({url:a.url,vParams:a.vParams,title:a.title,referrer:a.referrer,modes:{ar:!0,pq:!0}},
"hit")},sendAjaxHit:function(a){this._hitExt({url:a.url,title:a.title,referrer:a.referrer,modes:a.modes},"hit")},sendParams:function(a,b,c,d){this._hitExt({url:d||M().href,title:"",referrer:"",forceNoRedirect:!0,vParams:a,modes:{ar:!0,pa:!0,onlyData:!0},callback:b,ctx:c},"pa")},sendGoal:function(a,b){if(/[/&=?#]/.test(a))k.warning("Incorrect goal");else if(a){var c=b.url?k.parseUrl(b.url):M();this._hitExt({url:"goal://"+c.hostname+"/"+encodeURIComponent(a),title:v.getDocumentTitle(),referrer:c.href,
forceNoRedirect:!0,vParams:b.vParams,modes:{ar:!0},callback:b.callback,ctx:b.ctx},"go")}else k.warning("Empty goal")},sendClickLink:function(a,b){this._hitExt({url:a.url,title:a.title,referrer:b||M().href,modes:a.modes})},sendExtLink:function(a,b){this._hitExt({url:a.url,title:a.title||"",referrer:b||M().href,vParams:a.vParams,modes:{ar:!0,ln:!0,ut:mb},callback:a.callback,ctx:a.ctx},"cl")},sendFileUpload:function(a){this._hitExt({url:a.url,title:a.title||"",referrer:M().href,vParams:a.vParams,modes:{ar:!0,
ln:!0,dl:!0},callback:a.callback,ctx:a.ctx},"fu")},sendNotBounce:function(a,b){this._hitExt({url:b.url||M().href,title:"",referrer:"",modes:{cl:a,ar:!0,nb:!0,onlyData:!0},callback:b.callback,ctx:b.ctx},"nb")},sendDevice:function(a){this._hitExt({browserInfo:{di:a.data,dip:a.port},callback:a.callback,ctx:a.ctx},"de")},_hitExt:function(a,b){function c(a,b){b&&(m[a]=b)}var d,f,l,g={};if(!k.isMetrikaPlayer()){var n=a.modes||{};var r=a.browserInfo||{};var u="undefined"!==typeof a.referrer?a.referrer:Za.lastReferrer;
var p=a.url||"";var m={};a.nohit&&c("nohit",1);n.ar&&!n.onlyData&&(u=null===u||""===u?"":this._prepareHitUrl(u),p=this._prepareHitUrl(a.url));c("forceNoRedirect",a.forceNoRedirect);c("page-ref",k.trim(u,nb));c("page-url",k.trim(p,nb));k.is4Bytes(a.title)&&c("charset","utf-8");-1!=M().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/)?c("ut",mb):"undefined"!=typeof n.ut&&c("ut",k.trim(n.ut,ac));c("exp",a.experiments);(f=a.vParams)&&this.counter&&f.__ym&&(k.isNumber(f.__ym.turbo_page)&&(this.counter.tp=
f.__ym.turbo_page),k.isNumber(f.__ym.turbo_page_id)&&(this.counter.tpid=f.__ym.turbo_page_id));(!f||k.isObject(f)&&!f.__ym&&!f.__ymu)&&this.paramsQueue.length()&&k.inArray(["go","hit","pa"],b)&&(f=this.paramsQueue.mixin(f));f&&(p=k.toJSON(f),this.trimParams&&p.length>bc?l=!0:7E5<p?k.warning("Too big params"):c("site-info",p));n.saveRef&&(Za.lastReferrer=u);g=function(a,b){var c={};k.forEachKey(b,function(a,b){-1===k.arrayIndexOf(["",0,w,null],b)&&(c[a]=b)});return k.mixin({},a,c)}(g,{gdpr:ua.getState(this.globalConfig),
...
_prepareHitUrl:function(a){var b=M(),c=b.host;b=b.href;if(!k.isString(a))return b;if(-1!=a.search(/^[a-z][\w.+-]+:\/\//i))return a;var d=a.charAt(0);if("?"==d)return d=b.search(/\?/),-1==d?b+a:b.substr(0,d)+a;if("#"==d)return d=b.search(/#/),-1==d?b+a:b.substr(0,d)+a;if("/"==d){if(d=b.search(c),-1!=d)return b.substr(0,d+c.length)+a}else return c=b.split("/"),c[c.length-1]=a,c.join("/");return a},getFu:function(a,b){var c=a!==M().href,d=t.referrer.replace(/\/$/,""),f=(b||"").replace(/\/$/,"");d=d!==
f;f=0;d&&c?f=3:d?f=1:c&&(f=2);return f},_getTechInfo:function(a,b,c,d,f,l,g,n,r,u){function p(a,b,c){var e=""+b;a&&b&&(c||-1===e.indexOf(":"))&&(q[a]=e)}function C(a){b[a]&&p(a,"1")}var q={};b=b||{};d=d||x.getTimestamp();f=f||x.getTimezone();p("j",z.getJavaEnabled()?"1":"");var h=z.isDesktop(this.globalConfig);h!==w&&p("dp",h?"1":"0");p("nt",z.netType());p("ns",z.getNavigationStart());ea&&p("s",ea.width+"x"+ea.height+"x"+(ea.colorDepth||ea.pixelDepth));m.devicePixelRatio&&p("sk",m.devicePixelRatio);
z.isSelenium()&&p("iss","1");z.isHeadLess()&&p("hdl","1");z.isIframe()&&(p("ifr","1"),p("sti",z.isSameOriginTopFrame()?"1":"0"));m.ia_document&&m.ia_document.shareURL&&m.ia_document.referrer&&p("iia","1");p("adb",Ab.getVal());p("f",z.getFlashVersion());p("l",z.getSilverlightVersion());p("fpr",z.getFingerPrint());p("cn",this.counterNum);b.pa||(h=v.getViewportSize(),p("w",h[0]+"x"+h[1]));p("z",f);p("i",d);p("et",x.getSeconds());p("en",v.getDocumentCharset());p("c",navigator.cookieEnabled?"1":"");p("la",
z.getLanguage());p("ntf",z.getNotificationPermission());k.random(100)||p("np",W.encode(Ia.encode(k.trim(z.getPlatform(),100))));l&&p("wh","1");f="ar ln re dl cpf ad nb pa pq pv ex".split(" ");for(d=0;d<f.length;d++)C(f[d]);f="va vt sn sa he pai".split(" ");b.nb&&f.push("cl");for(d=0;d<f.length;d++)l=f[d],p(l,b[l]);f=new ia({counterId:c});f.isEnabled()&&(c=f.getStorageId(),d=f.get("reqNum"),u||(d?d++:d=1),f.set("reqNum",d),f.get("reqNum")==d?(p("ls",c),p("rqn",d)):(f.remove("reqNum"),f.clearStorageId(),
1<d&&(p("ls",c),p("rqn",0))));p("rn",k.random());p("hid",g);u||3==this.counterId||b.pq||p("ds",Ub(r));r._firstPaint||u||(r._firstPaint=Wb(),p("fp",r._firstPaint));if(n){g=D.get("winNameNum");if(!g){if(g=+m.name||Math.round(65535*Math.random()))0>g&&(g*=-1),g%=65535;g=g||k.fletcher(m.name);D.set("winNameNum",g)}p("wn",g);try{m.history&&p("hl",String(m.history.length))}catch(e){}}g="";this.sendTitle&&(g=this._getTitle(a));p("t",g,!0);return q},_getTitle:function(a){a="undefined"==typeof a?(a=v.getDocumentTitle())?
k.trim(a,Bb):"":k.trim(a,Bb);return a}});k.array2Props=function(a){var b=a.length,c={},d=c,f;for(f=0;f<b-1;f++){var l=a[f];d[l]={};f<b-2&&(d=d[l])}d[l]=a[b-1];return c};var Ra=J.inherit({sampling:1,counterId:26302566,_initComponent:function(){Ra.superclass._initComponent.apply(this,arguments);this._sender=new Ja({protocol:"https:",counterId:this.counterId,retry:!1,counter:{}})},log:function(){this.logParams(k.array2Props(arguments))},logParams:function(a){Math.random()<this.sampling&&this._sender.sendHit({url:L.href,
title:"",referrer:"",vParams:a})}}),cc=T.inherit({resource:"webvisor",retry:!0,postParams:["wv-data"],sendPacket:function(a,b,c,d,f,l,g,n){if(!a||!a.length)return!1;var r=W.encode(a,!0);if(0==r.indexOf("AAAAAAAAADw")&&m.Error){var u=Error();"string"==typeof u.stack&&(new Ra({sampling:.1})).log("bad visor packet 5",1)}a={rn:k.random(),"page-url":b,wmode:0,"wv-type":0,"wv-hit":c,"wv-part":d+1,"wv-check":k.fletcher(a),"wv-data":r};f={v:this._getVersion(),z:f,i:l};return this.send(a,f,g,n)}}),ub=Aa.inherit({protocol:"",
counterId:"",counterType:"",meta:null,maxBufferSize:7500,flushTimeout:3E4,storageKey:"visorbuff",active:!1,_initComponent:function(){this.storage=new ia({counterId:this.counterId});this._sender=new cc({globalConfig:this.globalConfig,protocol:this.protocol,counterId:this.counterId,counterType:this.counterType});ub.superclass._initComponent.apply(this,arguments)},onFlush:function(a,b,c){this._sender.sendPacket(a,b.url,b.hitId,c,b.timezone,b.timestamp)}});v.getDocumentHTML=function(){var a="";var b=
t.documentElement;var c=b.outerHTML,d,f;if(c)b=c;else{c=b.attributes;var l="";for(d=0;d<c.length;d++)(f=c[d])&&(l+=" "+f.name+'\x3d"'+(f.value||"")+'"');b="\x3chtml"+l+"\x3e"+b.innerHTML+"\x3c/html\x3e"}if(c=t.doctype)a=c.publicId?' PUBLIC "'+c.publicId+'"':"",l=c.systemId?' "'+c.systemId+'"':"",a="\x3c!DOCTYPE "+c.name+a+l+"\x3e\n";return a+b};v.getElementParent=function(a){if(!a||a==t.documentElement)return null;if(a==v.getBody())return t.documentElement;var b=null;try{b=a.parentNode}catch(c){}return b};
v.getElementChildren=function(a,b){var c=[],d,f,l;if(a&&(d=a.childNodes)){var g=0;for(l=d.length;g<l;g++){var n=d[g];(f="INPUT"==n.nodeName&&n.type&&"hidden"==n.type.toLocaleLowerCase())||b&&n.nodeName!=b||k.mergeArrays(c,[n])}}return c};v.getElementNeighborPosition=function(a){var b=v.getElementParent(a),c;if(b){var d=0;b=b.childNodes;var f=a&&a.nodeName;for(c=0;c<b.length;c++){var l=b[c]&&b[c].nodeName;if(f==l){if(a==b[c])return d;d++}}}return 0};v.getDocumentScroll=function(){var a=v.getBody();
return[m.pageXOffset||t.documentElement&&t.documentElement.scrollLeft||a&&a.scrollLeft||0,m.pageYOffset||t.documentElement&&t.documentElement.scrollTop||a&&a.scrollTop||0]};v.getElementXY=function(a){var b;if(!a||!a.ownerDocument||"PARAM"==a.tagName||a==v.getBody()||a==t.documentElement)return[0,0];if(a.getBoundingClientRect){a=a.getBoundingClientRect();var c=v.getDocumentScroll();return[Math.round(a.left+c[0]),Math.round(a.top+c[1])]}for(b=c=0;a;)c+=a.offsetLeft,b+=a.offsetTop,a=a.offsetParent;return[c,
b]};v.getDocumentSize=function(){var a=v.getRootElement(),b=v.getViewportSize();return[Math.max(a.scrollWidth,b[0]),Math.max(a.scrollHeight,b[1])]};v.getElementSize=function(a){var b;return a==v.getBody()||a==t.documentElement?v.getDocumentSize():(b=a.getBoundingClientRect&&a.getBoundingClientRect())?[b.width,b.height]:[a.offsetWidth,a.offsetHeight]};v.getElementRegion=function(a){var b=v.getElementXY(a);a=v.getElementSize(a);return[b[0],b[1],a[0],a[1]]};v.calcChildrenChecksum=function(a){var b=F(function(){return a.innerHTML},
"",!0)()||"";return k.fletcher(b.replace(/(<[^>]*>|[\u0000-\u0020])/g,""))};v.getFormNumber=function(a){var b=t.getElementsByTagName("form"),c;var d=0;for(c=b.length;d<c;d++)if(b[d]==a)return d;return-1};v.isEmptyField=function(a){return"INPUT"==a.nodeName&&"submit"!=a.type&&"image"!=a.type&&"hidden"!=a.type?"radio"==a.type||"checkbox"==a.type?!a.checked:!a.value:"TEXTAREA"==a.nodeName?!a.value:"SELECT"==a.nodeName?0>a.selectedIndex:!0};v.calcTextChecksum=function(a){var b="";a=a.childNodes;var c;
var d=0;for(c=a.length;d<c;d++)a[d]&&3==a[d].nodeType&&(b+=a[d].nodeValue);return k.fletcher(b.replace(/[\u0000-\u0020]+/g,""))};v.calcAttribChecksum=function(a){var b="",c="width height align title alt name".split(" "),d;"IMG"==a.tagName&&(b+=a.src.toLowerCase());"A"==a.tagName&&(b+=a.href.toLowerCase());b+=String(a.className||"").toLowerCase();for(d=0;d<c.length;d++)a.getAttribute&&(b+=String(a.getAttribute(c[d])||"").toLowerCase());return k.fletcher(b.replace(/[\u0000-\u0020]+/g,""))};v.classNameExists=
function(a,b){try{return(new RegExp("(?:^|\\s)"+b+"(?:\\s|$)")).test(a.className)}catch(c){return!1}};v.getElementsByClassName=function(a,b){var c;b=b||t;var d=b.getElementsByTagName("*");var f=[];for(c=0;c<d.length;c++)v.classNameExists(d[c],a)&&f.push(d[c]);return f};try{if(yb){var lb=function(a){function b(d){if(c[d])return c[d].f;var f=c[d]={Z:d,L:!1,f:{}};return a[d].call(f.f,f,f.f,b),f.L=!0,f.f}var c={};return b.aa=a,b.W=c,b.o=function(a,c,l){b.D(a,c)||Object.defineProperty(a,c,{enumerable:!0,
...
32-b])}function l(a,b){return 0===(b%=64)?a:32>b?[a[0]<<b|a[1]>>>32-b,a[1]<<b]:[a[1]<<b-32,0]}function g(a,b){return[a[0]^b[0],a[1]^b[1]]}function k(a){return a=g(a,[0,a[0]>>>1]),a=g(a=c(a,[4283543511,3981806797]),[0,a[0]>>>1]),g(a=c(a,[3301882366,444984403]),[0,a[0]>>>1])}b.a=!0;b.hash=function(a,b){b=b||0;var n=(a=a||"").length%16,r=a.length-n,q=[0,b];b=[0,b];for(var h,e,B=[2277735313,289559509],I=[1291169091,658871167],A=0;A<r;A+=16)h=[255&a.charCodeAt(A+4)|(255&a.charCodeAt(A+5))<<8|(255&a.charCodeAt(A+
...
944331445]);switch(h=[0,0],e=[0,0],n){case 15:e=g(e,l([0,a.charCodeAt(A+14)],48));case 14:e=g(e,l([0,a.charCodeAt(A+13)],40));case 13:e=g(e,l([0,a.charCodeAt(A+12)],32));case 12:e=g(e,l([0,a.charCodeAt(A+11)],24));case 11:e=g(e,l([0,a.charCodeAt(A+10)],16));case 10:e=g(e,l([0,a.charCodeAt(A+9)],8));case 9:e=c(e=g(e,[0,a.charCodeAt(A+8)]),I),b=g(b,c(f(e,33),B));case 8:h=g(h,l([0,a.charCodeAt(A+7)],56));case 7:h=g(h,l([0,a.charCodeAt(A+6)],48));case 6:h=g(h,l([0,a.charCodeAt(A+5)],40));case 5:h=g(h,
l([0,a.charCodeAt(A+4)],32));case 4:h=g(h,l([0,a.charCodeAt(A+3)],24));case 3:h=g(h,l([0,a.charCodeAt(A+2)],16));case 2:h=g(h,l([0,a.charCodeAt(A+1)],8));case 1:h=c(h=g(h,[0,a.charCodeAt(A)]),B),q=g(q,c(f(h,31),I))}return q=d(q=g(q,[0,a.length]),b=g(b,[0,a.length])),b=d(b,q),q=d(q=k(q),b=k(b)),b=d(b,q),("00000000"+(q[0]>>>0).toString(16)).slice(-8)+("00000000"+(q[1]>>>0).toString(16)).slice(-8)+("00000000"+(b[0]>>>0).toString(16)).slice(-8)+("00000000"+(b[1]>>>0).toString(16)).slice(-8)}}]);lb=lb["default"]}}catch(a){Pa=
...
[].slice.call(arguments,2);return function(){return a.apply(b||this,c.concat([].slice.call(arguments,0)))}};k.safeDecodeURIComponent=function(a){try{return decodeURIComponent(a)}catch(b){return""}};k.isDev=function(){return!1};k.noop=function(){};!kb(/webkit/)&&kb(/gecko/);var ob={asyncChunk:400,maxDuration:20,restTime:100,asyncBuffer:[],timeout:null,rest:0,addAsyncItem:function(a,b,c,d,f){var l=this;this.asyncBuffer.push({fn:a,ctx:b,args:d||[],loggerName:f||""});c?(clearTimeout(this.timeout),l.flushAsync(!0)):
x.getMs()-this.rest>=this.restTime&&!this.timeout?(this.rest=x.getMs(),l.flushAsync()):this.timeout||(this.timeout=k.setTimeout(function(){l.rest=x.getMs();l.flushAsync();l.timeout=!1},this.restTime))},chain:function(a,b,c,d){var f=this;a.push=function(a){throw'Try to push in Executor when it started "'+a+'"';};(function u(b,c,k){f.addAsyncItem(function(b,c,d){c=a[b++](c);b<=a.length-1&&u(b,c,d)},null,k,[b,c],d+"."+b)})(0,b,c)},callByTimeout:function(a,b){for(var c=x.getMs(),d=0,f,l=(b||0)+1,g=0,
n=this;this.asyncBuffer.length;)if(f=this.asyncBuffer.shift(),g+=1,!f.isExecuted&&(F(function(){f.fn.apply(f.ctx,f.args)},"AsyncExecutor."+f.loggerName)(),d=x.getMs()-c,f.isExecuted=!0,!a&&(g>=this.asyncChunk||d>=this.maxDuration))){k.setTimeout(function(){n.callByTimeout(a,l)},this.restTime);break}},flushAsync:function(a){this.asyncBuffer.length&&this.callByTimeout(a)}},dc=Wa.inherit({id:"XHRPlain",index:8,_splitParams:function(a){var b={},c={};k.forEachKey(a,function(a,f){k.inArray(this.postParams,
a)?this.postParams.isSingle?c=f:c[a]=f:b[a]=f},this);return{get:b,post:c}},_preparePostParams:function(a){return a.post},_setHeaders:function(a){a.setRequestHeader("Content-Type","text/plain")}}),pb=T.inherit({resource:"webvisor",version:2,retry:!1,postParams:["wv-data"],transports:[dc],_initComponent:function(){pb.superclass._initComponent.apply(this,arguments);this.postParams.isSingle=!0},sendPacket:function(a,b,c,d,f,l,g,n,r){var u=v.getViewportSize();if(!a||!a.length)return!1;a={rn:k.random(),
"page-url":b,wmode:0,"wv-type":this.version,"wv-hit":c,"wv-part":d+1,"wv-data":a};f={et:g,w:u[0]+"x"+u[1],v:this._getVersion(),z:f,i:l};this.browserInfoMix&&(f=k.mixin(f,this.browserInfoMix));return this.send(a,f,n,r)}}),$a=Aa.inherit({protocol:"",chunkSize:0,counterId:"",counterType:"",meta:null,maxBufferSize:7E5,flushTimeout:2E3,storageKey:"visorbuff2",active:!1,wvType:2,_v:"",_totalSendLimit:null,_totalSendedSize:0,_initComponent:function(){this._sender=new pb({version:this.wvType,protocol:this.protocol,
globalConfig:this.globalConfig,counterId:this.counterId,browserInfoMix:this.browserInfoMix,counterType:this.counterType});$a.superclass._initComponent.apply(this,arguments)},append:function(a){!this._data.length&&a&&a.length&&(this.startBufferTime=x.getSeconds());$a.superclass.append.apply(this,arguments)},_getSize:function(a){var b=this;this.chunkSize+=encodeURIComponent(a).length;this.wrappers.length&&k.reduce(function(a,d){var c=d.getBufferData();c&&(b.chunkSize+=k.toJSON(c).length)},0,this.wrappers);
return this.chunkSize},addData:function(a,b,c,d,f){var l=0,g=1,n={type:a},r=.9*this.maxBufferSize;if(!this.totalSendLimit||this._totalSendedSize<this.totalSendLimit)if(this._v=c,this.wrappers.length&&k.arrayEvery(this.wrappers,function(c){c.trigger&&c.trigger(a,b);return 1}),f)this._getSize("{}"),this.append([],d);else{this.updateStamp(b,n);c=ba.stringify(b);f=this._getSize(c);if(f>this.maxBufferSize)for(this._data.length&&this._flush(),d=Math.ceil(c.length/r);l<c.length;)n.partNum=g,n.end=g===d,
n.data=c.slice(l,l+=r),g++,this._getSize(n.data),this.append([n],!0);else n.data=c,this.append([n],d);this.store.set(n,{id:a,data:b})}},onFlush:function(a,b,c){this.chunkSize=0;k.arrayEvery(this.wrappers,function(b){if(!b.onFlush)return 1;k.arrayEvery(a,function(a){a=this.store.pop(a);if(!a)return 1;b.onFlush(a.id,a.data);return 1},this);return 1},this);k.arrayEvery(this.wrappers,function(b){b=b.getBufferData();if(!b)return 1;b.data=ba.stringify(b.data);a.push(b);return 1});if(a.length){var d=ba.stringify(a);
...
"decodeDelimited":"decode"](e)}catch(B){return g.emit("error",B,a),k(B)}g.emit("data",e,a);return k(null,e)}g.end(!0)})}catch(h){g.emit("error",h,a),H(function(){k(h)},0)}else H(function(){k(Error("already ended"))},0)};d.prototype.end=function(a){this.rpcImpl&&(a||this.rpcImpl(null,null,null),this.rpcImpl=null,this.emit("end").off());return this}},function(a,b,c){b.Service=c(4)},function(a,b,c){function d(a){f.call(this,a)}a.exports=d;var f=c(1);(d.prototype=Object.create(f.prototype)).constructor=
...
a(e>>>0,d,f+b),a((h<<31|e/4294967296)>>>0,d,f+c);else{var g=Math.floor(Math.log(e)/Math.LN2);1024===g&&(g=1023);e*=Math.pow(2,-g);a(4503599627370496*e>>>0,d,f+b);a((h<<31|g+1023<<20|1048576*e&1048575)>>>0,d,f+c)}}function c(a,b,c,e,d){b=a(e,d+b);e=a(e,d+c);a=2*(e>>31)+1;c=e>>>20&2047;b=4294967296*(1048575&e)+b;return 2047===c?b?NaN:1/0*a:0===c?5e-324*a*b:a*Math.pow(2,c-1075)*(b+4503599627370496)}a.writeDoubleLE=b.bind(null,f,0,4);a.writeDoubleBE=b.bind(null,l,4,0);a.readDoubleLE=c.bind(null,g,0,4);
a.readDoubleBE=c.bind(null,k,4,0)}();return a}function f(a,b,c){b[c]=255&a;b[c+1]=a>>>8&255;b[c+2]=a>>>16&255;b[c+3]=a>>>24}function l(a,b,c){b[c]=a>>>24;b[c+1]=a>>>16&255;b[c+2]=a>>>8&255;b[c+3]=255&a}function g(a,b){return(a[b]|a[b+1]<<8|a[b+2]<<16|a[b+3]<<24)>>>0}function k(a,b){return(a[b]<<24|a[b+1]<<16|a[b+2]<<8|a[b+3])>>>0}a.exports=d(d)},function(a,b,c){function d(){this._listeners={}}a.exports=d;d.prototype.on=function(a,b,c){(this._listeners[a]||(this._listeners[a]=[])).push({fn:b,ctx:c||
...
a.width&&Object.hasOwnProperty.call(a,"width")&&b.uint32(8).int32(a.width);null!=a.height&&Object.hasOwnProperty.call(a,"height")&&b.uint32(16).int32(a.height);null!=a.orientation&&Object.hasOwnProperty.call(a,"orientation")&&b.uint32(24).int32(a.orientation);return b};a.decode=function(a,b){a instanceof d||(a=d.create(a));for(var c=void 0===b?a.len:a.pos+b,e=new g.ru.yandex.metrika.wv2.proto.DeviceRotationEvent;a.pos<c;){var f=a.uint32();switch(f>>>3){case 1:e.width=a.int32();break;case 2:e.height=
...
function(a,b){a instanceof d||(a=d.create(a));for(var c=void 0===b?a.len:a.pos+b,e=new g.ru.yandex.metrika.wv2.proto.ArticleRubric;a.pos<c;){var f=a.uint32();switch(f>>>3){case 1:e.name=a.string();break;case 2:e.position=a.int32();break;default:a.skipType(7&f)}}return e};return a}();return a}();return a}();return a}();return a}();return a}();a.exports=g}]).ru.yandex.metrika.wv2.proto}catch(a){}try{var ab={ScrollEvent:{type:K.ScrollEvent,events:["scroll"]},SelectionEvent:{type:K.SelectionEvent,events:["selection"]},
ChangeEvent:{type:K.ChangeEvent,events:["change","input"]},MethodEvent:{type:K.MethodEvent,repeated:"args",events:["canvasMethod","mediaMethod"]},PropertyEvent:{type:K.PropertyEvent,events:["canvasProperty","mediaProperty"]},KeystrokesEvent:{type:K.KeystrokesEvent,repeated:"keystrokes",events:["keystroke"]},ZoomEvent:{type:K.ZoomEvent,events:["zoom"]},ResizeEvent:{type:K.ResizeEvent,events:["resize"]},WindowEvent:{type:K.WindowEvent,events:["windowfocus","windowblur","focus","blur","eof"]},MouseEvent:{type:K.MouseEvent,
events:["mousemove","mouseup","mousedown","click"]},DeviceRotationEvent:{type:K.DeviceRotationEvent,events:["deviceRotation"]},FatalErrorEvent:{type:K.FatalErrorEvent,events:["fatalError"]},TouchEvent:{type:K.TouchEvent,repeated:"touches",events:["touchmove","touchstart","touchend","touchcancel","touchforcechange"]}},ec=k.reduce(function(a,b){return a.concat(k.map(function(a){return{eventName:a,type:ab[b].type,repeated:ab[b].repeated,typeStr:b}},ab[b].events))},[],k.keys(ab)),fc={nullToStr:function(a){var b=
this;if(k.isArray(a))return k.map(function(a){return b.nullToStr(a)},a);if(k.isObject(a))k.forEachKey(a,function(c,d){a[c]=b.nullToStr(d);return!0});else if(null===a||a===w)a="";return a},uncapitalize:function(a,b){var c=a.slice(1);return a.charAt(0).toLowerCase()+(b?c.toLowerCase():c)},capitalize:function(a,b){var c=a.slice(1);return a.charAt(0).toUpperCase()+(b?c.toLowerCase():c)},notNaN:function(a){return isNaN(a)&&"number"==typeof a?0:a},eventSerialize:function(a){var b=k.filter(function(b){return b.eventName==
a.type},ec),c;for(c=0;c<b.length;c++)var d=b[c];if(d)return d.repeated?(c=new d.type,c[d.repeated]=a.meta[d.repeated]||a.meta):c=new d.type(this.nullToStr(a.meta)),b=new K.Event({type:K.EventType[d.eventName],target:a.target,frameId:a.frameId}),b[this.uncapitalize(d.typeStr)]=c,b},pageSerialize:function(a){return new K.Page(this.nullToStr(a))},articleInfoSerialize:function(a){return new K.ArticleInfo(this.nullToStr(a))},publishersHeaderSerialize:function(a){return new K.PublishersHeader(this.nullToStr(a))},
mutationSerialize:function(a){return new K.Mutation(this.nullToStr(a))},initBuffer:function(){return new K.BufferWrapper},appendBuffer:function(a,b){a.buffer.push(b)},serializeChunk:function(a){return this.serializeBuffer(null,a)},serializeBuffer:function(a,b,c){var d=new K.Buffer(b);a=a||new K.Wrapper;b||(d.data=a);c!==w&&(d.stamp=c);b&&b.stamp===w&&(d.stamp=x.getFormStart());return d},toTransport:function(a,b,c,d){var f=b||"BufferWrapper",k=this;if(c)ob.chain([function(){return k.nullToStr(a)},
function(a){return K[f].encode(a)},function(a){return a.finish()},function(a){return c.call(d,a)}],"",!1,"toTransportChain."+f);else return K[f].encode(this.nullToStr(a)).finish()},fromTrasport:function(a,b){if("number"==typeof a[0])return K[b||"BufferWrapper"].decode(a)},serialize:function(a,b,c){var d={},f={},k=this[a+"Serialize"];if(k)d[a]=k.call(this,b),f=new K.Wrapper(d);else if(c&&K.Wrapper.prototype[a]!==w)f[a]=b;else throw"Unrecoginze type of message";return c?K.Wrapper.encode(f).finish():
f}};Cb=!0}catch(a){sa(a,"pr.in")}var Db=Aa.inherit({protocol:"",chunkSize:0,counterId:"",counterType:"",meta:null,maxBufferSize:7E5,serializer:fc,_dataSize:0,flushTimeout:2E3,storageKey:"visorbuff3",active:!1,wvType:3,_totalSendedSize:0,_v:"",_initComponent:function(){this._sender=new pb({version:this.wvType,protocol:this.protocol,browserInfoMix:this.browserInfoMix,globalConfig:this.globalConfig,counterId:this.counterId,counterType:this.counterType});this.maxChunkSize=.9*this.maxBufferSize;$a.superclass._initComponent.apply(this,
...
this.serializer.initBuffer();this._dataSize=0;this._flushTID=null;this.storage&&this.storage.remove(this.storageKey)}}),U={};U._cookie=new N({onlyCurrentDomain:!0});U._check=F(function(){return-1<m.location.href.indexOf("_ym_debug\x3d1")||m._ym_debug||"1"===U._cookie.read("debug")});U.enabled=U._check();U.log=F(function(){(-1<L.href.indexOf("_ym_debug\x3d1")||m._ym_debug)&&this._cookie.create("debug","1");m.console&&console.log&&this._check()&&(U.enabled=!0,console.log.apply(console,arguments))},
"DebugConsole.log");var gc=J.inherit({eventMap:{mousemove:{val:0,multiply:1/.68},click:{val:0,multiply:1/.00975},input:{val:0,multiply:1/.0116},scroll:{val:0,multiply:1/.31},fatalError:{val:0,multiply:1}},getBufferData:function(){var a=this;return{type:"activity",data:k.reduce(function(b,c){var d=a.eventMap[c];return Math.round(b+d.val*d.multiply)},0,k.keys(this.eventMap))}},onFlush:function(a,b){var c;if(c=this.eventMap["event"!==a?a:b.type])c.val+=1}});v.closest=function(a,b){var c;if(!(m&&m.Element&&
...
--c&&d.item(c)!==a;)a;while(0>c&&(a=a.parentElement));return a}return null};var E={select:function(a,b){return a?a.querySelectorAll(b):null},looksLikeFullUrl:function(a){return"string"!==typeof a?!1:/^(https?:)\/\//.test(a)},selectOne:function(a,b){var c=this.select(a,b);return c&&c.length?c[0]:null},closest:function(a,b){return v.closest(a,b)},testAttr:function(a,b,c){return c.test(a.getAttribute(b))},selectPropOne:function(a,b){var c=this.selectProp(a,b);return c&&c.length?c[0]:null},selectProp:function(a,
b){var c=a.getAttribute("itemtype"),d=null,f=this.select(a,'[itemprop\x3d"'+b+'"]');c&&(d=k.filter(function(b){return b.parentNode&&v.closest(b.parentNode,"[itemtype]")===a},f));return d||f||[]},getVal:function(a){if(!a||0==a.length)return"";a.length===w&&(a=[a]);return a[0].getAttribute("content")||a[0].innerText||""},getDate:function(a){return a?a.attributes&&a.attributes.datetime?""+a.attributes.datetime.value:this.getVal(a):""}},bb={},cb=J.inherit({isAuthorsInTitle:!1,fields:{},schemaEntities:{"schema.org":"Article NewsArticle Movie BlogPosting Review Recipe Answer".split(" "),
...
E.looksLikeFullUrl(a.id)?a.id:this.getPageUrlCanonical());a.id||(a.id=a.pageTitle||a.pageUrlCanonical);return a},_getContentData:function(a){var b={},c=this;b.type=a.type;k.map(function(d){b[d]=c._getFieldData(a,d)},k.keys(this.fields));b.element=a.element;b.stamp=x.getFormStart();b=this._postprocessData(b,a);b.id=b.id?k.fnv32a(b.id):1;b.update=k.bind(this._getFieldData,this,a);return b},_getTitleFromContent:function(a){var b,c;for(b=1;5>=b;b++)if(c=E.getVal(E.selectOne(a,"h"+b)))return c;return null},
_getType:function(){return 1},getPageUrlCanonical:function(){var a=E.selectOne(this.root,'[rel\x3d"canonical"]');if(a)return a.href},findContent:function(){var a,b=[],c=[],d,f=this._findContentDescriptionNodes();for(a=0;a<f.length;a++)if(d=this._getContentData({element:f[a],type:this._getType(f[a])}))k.isArray(d)||(d=[d]),k.map(function(a){!a||a.chars<=bb[a.type]||(a=k.mixin({sended:!1,involvedTime:0},a))&&!k.inArray(c,a.id)&&(a.index=b.push(a),c.push(a.id))},d);return b}});bb[1]=500;bb[2]=500;bb[3]=
0;var qb=cb.inherit({id:"s",isAuthorsInTitle:!0,typesRegExp:new RegExp("schema.org\\/("+k.keys(cb.prototype.typesMap).join("|")+")$"),fields:{node:function(a){return this._getContentNode(a)},id:function(a){a=a.element;var b=E.selectPropOne(a,"identifier");return b?E.getVal(b):(b=E.selectPropOne(a,"mainEntityOfPage"))&&b.getAttribute("itemid")?b.getAttribute("itemid"):null},chars:function(a){var b=0;a=a.element;var c,d,f=["articleBody","reviewBody","recipeInstructions","description","text"];for(c=
...
"name"))&&(b.name=E.getVal(c));b.name||(b.name=a.getAttribute("content")||a.innerText||a.getAttribute("href"));return b},a)}},_getType:function(a){a=a.getAttribute("itemtype")||"";return(a=this.typesRegExp.exec(a))?this.typesMap[a[1]]:1},_getContentData:function(a){return a.element&&a.element.innerText&&a.element.innerText.length?qb.superclass._getContentData.call(this,a):null},_findContentDescriptionNodes:function(){var a=k.map(function(a){return'[itemtype$\x3d"schema.org/'+a+'"]'},this.schemaEntities["schema.org"]).join(",");
return E.select(t,a)}}),db=cb.inherit({id:"j",dataNodesSelector:'script[type\x3d"application/ld+json"],script[type\x3d"application/json+ld"],script[type\x3d"ld+json"],script[type\x3d"json+ld"]',isAuthorsInTitle:!0,fields:{node:function(a){return this._getContentNode(a)},id:function(a){var b=a.data["@id"];a=a.data.mainEntity||a.data.mainEntityOfPage;!b&&a&&(b=a["@id"]);return b},chars:function(a){return"string"===typeof a.data.text?a.data.text.length:this._getContentNode(a).innerText.length},authors:function(a){var b=
...
return d?d:E.closest(b,"head")||0===f.innerText.length?m.document.body:f},_extractElementByHashedUrl:function(a){var b,c;try{if(b=k.parseUrl(a).hash)if(c=E.selectOne(t.body,b))return c}catch(d){return null}},_parseType:function(a){return this.typesMap[a["@type"]]||1},_getContentData:function(a){var b=a.element,c=this,d=[],f;if(!a.data&&(a.data=ba.parse(b.innerText),!a.data||!/schema\.org/.test(a.data["@context"])))return null;if(k.isArray(a.data["@graph"]))return k.map(function(a){if(!k.inArray(c.schemaEntities["schema.org"],
a["@type"]))return null;a={element:b,data:a,type:c._parseType(a)};return db.superclass._getContentData.call(c,a)},a.data["@graph"]);"QAPage"===a.data["@type"]&&(f=a.data.mainEntity||a.data.mainEntityOfPage);"Question"===a.data["@type"]&&(f=a.data);if(f)return a=k.reduce(function(a,b){var c=f[b]||[];return a.concat(k.isArray(c)?c:[c])},[],["acceptedAnswer","suggestedAnswer"]),k.map(function(a){if(!k.inArray(c.schemaEntities["schema.org"],a["@type"]))return null;a={element:b,type:c._parseType(a),data:k.mixin({parentItem:f},
a)};return db.superclass._getContentData.call(c,a)},a);if(!k.inArray(this.schemaEntities["schema.org"],a.data["@type"]))return null;d=this._parseType(a.data);return d=db.superclass._getContentData.call(this,k.mixin(a,{type:d}))},_findContentDescriptionNodes:function(){return E.select(m.document,this.dataNodesSelector)}}),Eb=cb.inherit({id:"o",fields:{node:function(a){return this._getContentNode(a)},chars:function(a){a=this._getContentNode(a);return a.innerText?a.innerText.length:0},authors:function(a){return this._getArrayValue(a.data.author)},
...
l||a.parentNode===m.document.head)b=a.getAttribute("property").replace(n,""),c=a.getAttribute("content"),f[b]?k.isArray(f[b])?f[b].push(c):f[b]=[f[b],c]:f[b]=c}catch(u){}},d);else return null;return k.inArray(this.schemaEntities.opengraph,f.type)?k.mixin(a,{data:f}):null},_getContentNode:function(a){a=a.element;return a===t.head?t.body:a.parentElement},_getContentData:function(a){return(a=this._getEntityData(a))?Eb.superclass._getContentData.call(this,a):null}}),hc=J.inherit({buffer:null,meta:!1,
activeEvents:"page resize scroll mousemove mousedown click windowfocus keystroke deviceRotation input touchmove touchstart".split(" "),isStopped:!1,schemas:{json_ld:db,schema:qb,microdata:qb,opengraph:Eb},checkSize:function(){var a=this,b="pai"+this._schema.id,c=this.globalConfig.get(b,[]);c.push(function(b){!a.isStopped&&b.length&&(a.findContent(b),a.meta=a.getMeta(),a.send())});this.globalConfig.setSafe(b,c);if(1==c.length){var d=function(c){var f=a.globalConfig.get(b),g=a._schema.findContent();
...
function(b){b(a);return 1});this.events.push(a)},middleware:function(a){this.handlers.push(a);k.arrayEvery(this.events,function(b){a(b)})},lastStamp:0,involvedTime:0,MAX_INACTIVE:5E3,trigger:function(a,b){var c="event"!==a?a:b.type;if(k.inArray(this.activeEvents,c)){"scroll"==c&&b.meta&&b.meta.page&&(this.scroll=b.meta);"resize"==c&&0==b.target&&(this.viewbox=b.meta);var d=x.getMs()-this.lastStamp;d=Math.min(d,this.MAX_INACTIVE);this.involvedTime+=Math.round(d);this.lastStamp=x.getMs();this.meta&&
this.scroll&&this.viewbox&&k.arrayEvery(this.articles,function(a){if(this.isRemovedFromDoc(a.element))return 1;var b=k.filter(function(b){return b.id===a.id},this.meta).pop();if(!b)return sa(Error("Can't find meta"),"p.t"),1;var c=Math.max((Math.min(this.scroll.y+this.viewbox.height,b.y+b.height)-Math.max(this.scroll.y,b.y))/this.viewbox.height,0);var f=Math.max((this.scroll.y+this.viewbox.height-b.y)/b.height,0);a.involvedTime+=Math.round(c*d);a.maxScrolled=Math.round(1E4*f)/1E4;a.visibility=c;b.involvedTime=
a.involvedTime;return 1},this)}}}),Fb=J.inherit({hid:0,tz:0,ts:0,counterId:0,counterType:0,url:"",protocol:"",executor:ob,enabled:!1,_map:{page:{iterate:!1,name:"page"},events:{iterate:!0,name:"event"},mutations:{iterate:!0,name:"mutation"},articleInfo:{iterate:!0,name:"articleInfo"}},_getBufferType:function(){var a=$a,b=!1;if(!U.enabled&&Cb){try{b=(b=2===(new Blob(["\u00e4"])).size)&&2===(new Blob([new m.Uint8Array([1,2])])).size}catch(c){}b&&m.Uint8Array&&m.Uint8Array.prototype.slice&&(a=Db)}return a},
_initComponent:F(function(){var a=this._getBufferType();this._localStorage=new ia({counterId:this.counterId});var b=this._localStorage.get("pai");var c=this._getStorage();var d=c.read("visorc");"b"!==d&&"w"!==d&&(d="");if(!c.isEnabled()||kb("opera mini"))d="b";this._publisher=new hc({counterId:this.counterId,globalConfig:this.globalConfig});this._vc=d;c={protocol:this.protocol,counterId:this.counterId,counterType:this.counterType,globalConfig:this.globalConfig,meta:{url:this.url,hitId:this.hid,timezone:this.tz,
timestamp:this.ts}};this._recorder=new Xb({counterId:this.counterId,trustedDomains:this.trustedDomains,childIframe:this.childIframe});this._buffer=new a(k.mixin({},c,{totalSendLimit:31457280,browserInfoMix:{bt:1}}));this._eventsBuffer=new a(k.mixin(c,b&&{browserInfoMix:{pai:b}}));this._localStorage.remove("pai");this._buffer.activate();this._eventsBuffer.activate();"b"!==d&&(this._formRecorder=new Pb(this.protocol,this.counterId,this.counterType,this.hid,this.globalConfig),this._recorder.on("error",
function(a){sa(a.error,a.namespace)}),this._activity=new gc);Fb.superclass._initComponent.apply(this,arguments)},"wv2.init"),start:F(function(a,b){var c=this,d=this._vc;if(this._recorder){a=a||{};var f=+a.recp;if(!isFinite(f)||0>f||1<f)d="w";d||(d=this.hid%1E4/1E4<f?"w":"b");this._getStorage().create("visorc",d,30);this._publisher.start(b);"w"===d&&this.isEnabled()&&this.globalConfig.setSafe("wv2Counter",this.counterId);"w"===d&&this.isEnabled()&&this._isCorrectCounter()?(this._recorder.middleware(function(a){c.send(a.data)}),
...
this.globalConfig.get("wv2Counter")}}),Gb={FN:"ym",STACK:"a",counters:[],waitPool:{},handle:function(a){if(2>a.length)return 1;var b=""+a[0];k.inArray(b,":")||(b+=":0");var c=b.split(":")[0];var d=a[1];var f=this.globalConfig.get("counters",{})[b];"init"==d?(d="yaCounter"+c,m[d]||(a=k.mixin(a[2]||{},{id:+c}),m[d]=new m.Ya[this.constructorName](a))):k.inArray(this.counters,b)&&f&&f[d]?(a=[].slice.call(a,2),f[d].apply(f,a)):k.inArray(this.counters,b)||(this.waitPool[b]||(this.waitPool[b]=[]),this.waitPool[b].push(a));
return 1},subscribe:function(a){a&&(this.counters.push(a),this.waitPool[a]&&(k.arrayEvery(this.waitPool[a],this.handle,this),delete this.waitPool[a]))},init:function(a,b){var c=this,d=m[this.FN];if(d){var f=d[this.STACK];this.constructorName=a;this.globalConfig=b;f||(d[this.STACK]=f=[]);var l=f.push;f.push=function(){var a=l.apply(f,arguments);k.arrayEvery(arguments,c.handle,c);return a};d&&k.isArray(f)&&k.arrayEvery(f,this.handle,this)}}},ic=function(a,b){var c=["R0lGODlhAQABAO+/vQAAAAAAAAAAIe+/vQQBAAAAACwAAAAAAQABAAACAkQBADs\x3d",
"R0lGODlhAQABAO+/vQEAAAAA77+977+977+9Ie+/vQQBAAABACwAAAAAAQABAAACAkwBADs\x3d"],d={},f=!1,l=function(b){f||(a(b),f=!0)},g=b||"aHR0cHM6Ly95YW5kZXgucnUvcG9ydGFsL2dlbmVyYXRlXzIwNA\x3d\x3d aHR0cHM6Ly95YW5kZXgudWEvcG9ydGFsL2dlbmVyYXRlXzIwNA\x3d\x3d aHR0cHM6Ly95YW5kZXguZnIvcG9ydGFsL2dlbmVyYXRlXzIwNA\x3d\x3d aHR0cHM6Ly9wYXNzcG9ydC55YW5kZXguZnIvbWMvcGl4ZWw\x3d aHR0cHM6Ly9wYXNzcG9ydC55YW5kZXgudWEvbWMvcGl4ZWw\x3d aHR0cHM6Ly9wYXNzcG9ydC55YW5kZXgucnUvbWMvcGl4ZWw\x3d aHR0cHM6Ly9nZXRmYXN0YnJvd3Nlci5jb20vbWMvcGl4ZWw\x3d aHR0cHM6Ly9nZXR5YWJyb3dzZXIuY29tL21jL3BpeGVs aHR0cHM6Ly9nZXRicm93c2VyMjQuY29tL21jL3BpeGVs aHR0cHM6Ly9tYy53ZWJ2aXNvci5jb20vd2F0Y2gvNDQ4ODk0NjMvMQ\x3d\x3d aHR0cHM6Ly9tYy53ZWJ2aXNvci5vcmcvd2F0Y2gvNDQ4ODk0NjMvMQ\x3d\x3d aHR0cHM6Ly9tYy55YW5kZXgudWEvd2F0Y2gvNDQ4ODk0NjMvMQ\x3d\x3d aHR0cHM6Ly9tYy55YW5kZXgucnUvd2F0Y2gvNDQ4ODk0NjMvMQ\x3d\x3d aHR0cHM6Ly95bWV0cmljYS5jb20vd2F0Y2gvNDQ4ODk0NjMvMQ\x3d\x3d aHR0cHM6Ly95bWV0cmljYTEuY29tL3dhdGNoLzQ0ODg5NDYzLzE aHR0cHM6Ly95bWV0cmljYTIuY29tL3dhdGNoLzQ0ODg5NDYzLzE\x3d aHR0cHM6Ly9tYWlsLnlhbmRleC5mci9tYy9waXhlbA\x3d\x3d aHR0cHM6Ly9tYWlsLnlhbmRleC5jb20vbWMvcGl4ZWw\x3d aHR0cHM6Ly9tYWlsLnlhbmRleC51YS9tYy9waXhlbA\x3d\x3d aHR0cHM6Ly9tYWlsLnlhbmRleC5ydS9tYy9waXhlbA\x3d\x3d aHR0cHM6Ly9zdGFydHVwLm1vYmlsZS55YW5kZXgubmV0L21jL3BpeGVs aHR0cHM6Ly9zdGFydHVwLm1vYmlsZS53ZWJ2aXNvci5jb20vbWMvcGl4ZWw\x3d aHR0cHM6Ly9yZXBvcnQuYXBwbWV0cmljYS53ZWJ2aXNvci5jb20vbWMvcGl4ZWw\x3d aHR0cHM6Ly9yZWRpcmVjdC5hcHBtZXRyaWNhLndlYnZpc29yLmNvbS9tYy9waXhlbA\x3d\x3d aHR0cHM6Ly9yZXBvcnQtMS5hcHBtZXRyaWNhLndlYnZpc29yLmNvbS9tYy9waXhlbA\x3d\x3d aHR0cHM6Ly9yZXBvcnQtMi5hcHBtZXRyaWNhLndlYnZpc29yLmNvbS9tYy9waXhlbA\x3d\x3d".split(" "),
n=k.random(0,g.length);if(m.XMLHttpRequest){var r=W.decode(g[n]);var u=new XMLHttpRequest;u.timeout=1E4;u.open("GET",r,!0);u.ontimeout=function(){d[r]={status:"timeout"};l(d)};u.onreadystatechange=function(){4==u.readyState&&u.responseURL&&(u.responseURL!==r?d[r]={status:"redirect",body:u.responseURL}:2>=n?d[r]=204==u.status?{status:u.status}:{status:"onerror",code:u.status}:200!=u.status||k.inArray(c,W.encode(Ia.encode(u.response)))?d[r]={status:u.status}:d[r]={status:"content"},l(d))};u.onerror=
function(a){d[r]={status:"onerror",code:a.target.status};l(d)};u.send()}};v.loadScript=function(a,b){b=b||m;var c=k.mixin({type:"text/javascript",charset:"utf-8",async:!0},a),d=b.document,f=k.getNativeFunction("createElement",d),l=f("script");if(l){l.type=c.type;l.charset=c.charset;l.src=c.src;c.async&&(l.async=!0);try{var g=d.getElementsByTagName("head")[0];if(!g){var n=d.getElementsByTagName("html")[0];g=f("head");n&&n.appendChild(g)}g.insertBefore(l,g.firstChild);return l}catch(r){}}};var jc=Ca.inherit({id:"script",
index:6,request:function(a,b,c,d){var f=!1,l=k.getNativeFunction("createElement",t)("script");this.timeout&&k.setTimeout(function(){f||(f=!0,v.removeNode(l),c.call(d,!1))},this.timeout,"ts.request");if(!l)return f=!0,c.call(d,!1),!1;var g="_ymjsp"+k.random();m[g]=F(function(){if(!f){try{delete m[g]}catch(r){m[g]=w}c.apply(d,k.mergeArrays([!0],arguments));f=!0;v.removeNode(l)}},"transport.script");l.type="text/javascript";l.src=this._buildUrl(a,k.mixin({wmode:5,callback:g},b));l.async="async";var n=
t.getElementsByTagName("head")[0];n||(n=t.createElement("head"),t.documentElement.appendChild(n));k.async(function(){n.insertBefore(l,n.firstChild)});l.onerror=function(){f=!0;c.call(d,!1);m[g]=w};return!0}}),Hb=Wa.inherit({id:"XHRhit",index:10,_buildUrl:function(a,b){b.wmode=7;return Hb.superclass._buildUrl.apply(this,[a,b])},_parseResp:function(a){var b=ba.parse(a);if(!b)throw"";return k.map(function(a){return b[a]},k.keys(b))}}),rb=Ja.inherit({transports:[Hb,jc],trimParams:!0,_initComponent:function(){rb.superclass._initComponent.apply(this,
arguments);this._ilStorage=new ia({counterId:this.counterId})},postParams:[],checkYandexHost:function(a){if(a){a:{if(a=k.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/))if(a=a[0].split("yandex").reverse()[0].substring(1),-1!=k.arrayIndexOf(zb,a))break a;a=!1}a&&!Va.isEnabled()&&(this.forceHost="mc.yandex."+a)}},sendHit:function(a){var b={},c=this._ilStorage.get("il");a.visitColor&&(b.vc=a.visitColor);c&&(this._ilStorage.remove("il"),b.ilt=W.encode(Ia.encode(k.trim(c,Ib))));this.checkYandexHost(a.referrer);
this._hitExt({url:a.url,forceNoRedirect:a.forceNoRedirect,nohit:a.nohit,hasPrerender:a.hasPrerender,title:a.title,referrer:a.referrer,vParams:a.vParams,userParams:a.userParams,experiments:a.experiments,modes:a.modes,browserInfo:b,ts:a.ts,tz:a.tz,callback:a.callback,ctx:a.ctx},"hit")}}),Jb=J.inherit({cid:3,cnt:0,KEY_NAME:"wasSynced",_initComponent:function(){this._storage=new ia;this._cookie=new N},hit:function(a,b){var c=this,d=b===w?!0:!1,f=d?this._storage.get(this.KEY_NAME):!1,l=[],g=this.globalConfig.get("fakeHit");
if(g)return g(function(b){a(b)});!f&&d&&(f=this._cookie.read(this.KEY_NAME))&&(f=ba.parse(f));f&&f.params&&f.time+864E5>x.getMs()?(c.globalConfig.set("isEU",f.params.eu),a(f)):(this.globalConfig.set("fakeHit",function(a){l.push(a)}),this._getSender().sendHit({forceNoRedirect:this.forceNoRedirect,callback:function(b,d){var g=b||{};f={time:x.getMs(),params:g,bkParams:d};c.globalConfig.set("isEU",g.eu);c._storage.set(c.KEY_NAME,f);c._cookie.create(c.KEY_NAME,ba.stringify(f),1728);a(f);c.globalConfig.set("fakeHit",
function(a){a(f)});k.arrayEvery(l,function(a){a(f);return 1})}}))},_getSender:function(){this._sender||(this._sender=new rb({protocol:"https:",counterType:this.cnt,counterId:this.cid,sendTitle:!1,globalConfig:this.globalConfig,fake:!0}));return this._sender}}),Kb=J.inherit({baseUrl:"mc.yandex.",globalConfig:D,baseTld:"ru",partners:{"mc.yandexsport.ru":{regex:/^([^/]+\.)?yandexsport\.ru$/,tld:"ru"},"mc.beru.ru":{regex:/^([^/]+\.)?beru\.ru$/,tld:"ru"},"mc.kinopoisk.ru":{regex:/^([^/]+\.)?kinopoisk\.ru$/,
tld:"ru"}},_initComponent:function(){var a=this;Kb.superclass._initComponent.apply(this,arguments);this.syncTlds=k.reduce(function(a,c){return c(a)},zb,[k.bind(k.filter,null,function(b){return b!==a.baseTld}),k.bind(k.reduce,null,function(a,c){a[c]=[c];return a},{})]);k.forEachKey(this.partners,function(a,c){c.regex.test(m.location.hostname)&&(this.syncTlds[c.tld]||(this.syncTlds[c.tld]=[]),this.syncTlds[c.tld].push(a),this._replaceBase[a]=!0)},this);this.syncTlds=k.mixin(this.syncTlds,{ru:["mc.webvisor.org"]});
...
c=a.read("mda");"0"!==c&&"1"!==c&&a.create("mda","0",1036800);b.read("mda")&&b.erase("mda")},_is:function(){try{return!!this.globalConfig.get("startSync")}catch(a){return!1}},_setStatus:function(a){try{this.globalConfig.set("startSync",a)}catch(b){}},_need:function(){var a=this._getDomainByLang(),b=this._getTld(),c=[],d;(d=this.syncTlds[b])&&c.push.apply(c,d);d=this.syncTlds[a];a!==b&&d&&c.push.apply(c,d);var f=this._getLs().get("synced")||{};c=k.arrayFilter(c,function(a){return(f[a]||1)+1440<x.getMinutes()});
return c.length&&c||!1},_syncAdmetrica:function(){var a=new Da({timeout:1E3}),b=this._getLs();((b.get("synced")||{}).SYNCED_ADM||1)+1440<x.getMinutes()&&a.request("https://mc.admetrica.ru/sync_cookie_image_check",{},function(a){b.get("synced");var c=x.getMinutes();a=b.get("synced")||{};a.SYNCED_ADM=c;b.set("synced",a)})},_sync:function(a,b){var c,d=0,f=a.length,k=this;if(0<f){b=b||function(){};var g=function(){d++;f===d&&b()};var n=k._getLs();var m=new Da({timeout:1E3});for(c=0;c<f;c++)(function(a){m.request("https://"+
(k._replaceBase[a]?a:k.baseUrl+a)+"/sync_cookie_image_check",{},function(b){g();var c=x.getMinutes();b=n.get("synced")||{};b[a]=c;n.set("synced",b)})})(a[c])}else b()},_getCn:function(){this._cn||(this._cn=new Jb({fake:!0,globalConfig:this.globalConfig}));return this._cn},_getLs:function(){this._ls||(this._ls=new ia);return this._ls},_getTld:function(){var a=k.getTld();return{am:"com.am",tr:"com.tr",ge:"com.ge",il:"co.il","\u0440\u0444":"ru","xn--p1ai":"ru","\u0443\u043a\u0440":"ua","xn--j1amh":"ua",
"\u0431\u0435\u043b":"by","xn--90ais":"by"}[a]||a},_getDomainByLang:function(){if(!m.navigator)return"ru";try{var a=navigator.languages?navigator.languages[0]:z.getLanguage()}catch(b){}a&&a.toLowerCase&&(a=a.toLowerCase().split("-")[0]);return this.langToDomain[a]||"ru"}}),kc=Wa.inherit({id:"RawBodyXHR",index:9,postParams:["body"],_setHeaders:function(){},_preparePostParams:function(a){return a.post.body||""}});z.isAndroid=F(function(){var a=navigator.userAgent.toLowerCase(),b=z.getPlatform()||"";
return-1<a.indexOf("android")&&-1<a.indexOf("mobile")&&b.match(/^android|linux armv/i)},"",!0);var Qa={_url:"https://mc.webvisor.org/user_storage_set?",_params:{},init:function(a){this._params=a||{}},save:function(a,b){this._getReq().request(this._url+Ba.stringify({key:a,value:k.toJSON(b)}));this._getLs().set(a,b)},get:function(a){return{remote:this._params[a],local:this._getLs().get(a)}},getNum:function(a){a=this.get(a);return Math.max(+a.remote||0,+a.local||0)},_getLs:function(){this._ls||(this._ls=
new ia);return this._ls},_getReq:function(){this._req||(this._req=new Da);return this._req}},lc={sync:F(function(a,b,c,d){var f={t:'UV|L7,!"T[rwe\x26D_\x3eZIb\\aW#98Y.PC6k'};this.globalConfig=d||D;if(this._enabled(a,b,c)){this._setStatus(!0);var k=new kc({method:"GET",withCredentials:!1});var g=this._getHosts();var n=g.length;(function p(a){var b=g[a];a<n?k.request(b[0]+":"+b[1]+"/p",f,function(c,d){c?this._save(c,d,b[1]):p.call(this,a+1)},this):this._save(!1)}).call(this,0)}},"ds"),_getHosts:function(){var a=
[],b=L.protocol,c=z.isIOS();(z.isAndroid()||c&&"http:"===b)&&a.push(["http://127.0.0.1","30102"],["http://127.0.0.1","29009"]);c&&"https:"===b&&a.push(["https://yandexmetrica.com","30103"],["https://yandexmetrica.com","29010"]);return a},_save:function(a,b,c){var d=x.getMinutes();a?(new Ja({protocol:"https:",counterType:0,counterId:42822899,sendTitle:!1,fake:!0})).sendDevice({data:k.trim(b),port:c}):d-=45;Qa.save("ds",d)},_is:function(){try{return!!this.globalConfig.get("dSync")}catch(a){return!1}},
_enabled:function(a,b,c){if(!(60<x.getMinutes()-Qa.getNum("ds"))||this._is()||k.isDev(this.globalConfig))return!1;a=0===b&&0<=k.arrayIndexOf([39370095,1282253,29302335,43653484,41734944,31048081,16443139,27737346,41870499,33911514,30744873,5564395,2580487],a);a=pa()||!c&&.1>=Math.random()&&a;c=z.isIOS()&&a;return z.isAndroid()&&a||c},_setStatus:function(a){try{this.globalConfig.set("dSync",a)}catch(b){}}},S={getPos:function(a){var b=v.getRootElement(),c=v.getDocumentScroll();return[a.pageX||a.clientX+
c[0]-(b.clientLeft||0)||0,a.pageY||a.clientY+c[1]-(b.clientTop||0)||0]},getTarget:function(a){var b=null;try{if(b=a.target||a.srcElement)!b.ownerDocument&&b.documentElement?b=b.documentElement:b.ownerDocument!==t&&(b=null)}catch(c){}return b},getMouseButton:function(a){return a.which||a.button==w?a.which:a.button&1?1:a.button&2?3:a.button&4?2:0},prevent:function(a){a=a||m.event;a.preventDefault?a.preventDefault():a.returnValue=!1}};S.dispatchCustomEvent=F(function(a,b){var c;b=b||t;if(c=k.getNativeFunction("createEvent",
t)("Event"))c.initEvent(a,!1,!1),k.getNativeFunction("dispatchEvent",b)(c)},"evt.dispatch");var Za={lastReferrer:null},Ka=J.inherit({counter:null,prefsEcommerce:null,status:{NEW:w,PENDING:1,OK:2,FAIL:3},overrideTimeout:null,dataLayerName:"dataLayer",_initComponent:function(){Ka.superclass._initComponent.apply(this,arguments);this.frameConnector&&this.frameConnector.addHandler("params",function(a,b){if(this.counter&&this.counter.params)this.onCookies(function(a){this.counter.params(a.data)},this,b)},
...
a.sended.push(d))},this)},this,k.mixin({},g));g.status==this.status.NEW&&g.parent&&this.frameConnector&&this.frameConnector.checkFrame(m.parent)&&m.parent!==m&&(this.frameConnector.sendToParents({type:"params",data:g.data},function(){g.status=this.status.OK},this),g.status=this.status.PENDING)}}if(d&&d.ecommerce){var n={};var r=!1;k.forEachKey(d.ecommerce,function(a,b){0<=k.arrayIndexOf(c,a)&&(r=!0,n[a]=b)});r&&b.push(n)}b=b.concat(this._checkGtag(d))}if(b.length)this.onCookies(function(a){this.counter.params({__ym:{ecommerce:a}})},
this,b)}});Ka.handlers=[];var Lb="GDPR-ok GDPR-cross GDPR-cancel GDPR-skip GDPR-frame-skip GDPR-frame-ya GDPR-frame-noya GDPR-open-start GDPR-eu-skip GDPR-open-fail GDPR-open-success GDPR-cookie-success GDPR-cookie-fail GDPR-skip-login GDPR-skip-domain GDPR-skip-na GDPR-skip-eu-na GDPR-skip-wv".split(" "),mc=["https://brozen.yandex.ru","https://yabro1.zen-test.yandex.ru/yabro/index.html","https://yabro2.zen-test.yandex.ru/yabro/index.html"],ua=J.inherit({globalKey:"f1",MAX_SIZE:1E6,isYAN:!1,trigger:function(a){this.globalConfig.get("dataLayer").push({ymetrikaEvent:{type:a}})},
initCounter:function(){},enabled:pa()&&-1<m.location.href.indexOf("yagdprcheck\x3d1"),_initComponent:function(){this._cookie=ua.cookie;this._sender=new Jb({fake:!0,globalConfig:this.globalConfig,forceNoRedirect:!0})},realise:function(a,b){this.initCounter.apply(m,a);this.globalConfig.set(this.globalKey,function(a){a()});b.length&&ob.chain(b.concat([function(){b=[]}]),null,!1,"GDPR")},showPopup:function(a,b,c,d,f){var k=this;a=v.loadScript({src:"https://yastatic.net/q/global-notifications/cc/_lego-cc"+
a+"."+b+".js"});k.trigger("GDPR-open-start");a.onerror=function(a){F(function(){throw a;},"gdpr-popup")();k.trigger("GDPR-open-fail");k.realise(c,d);k.frameConnector.sendToChildren({type:"GDPR-ok"})};a.onload=function(){k.trigger("GDPR-open-success");Ka.handlers=Ka.handlers.concat([{type:"GDPR-ok, GDPR-cross",callback:function(a){a.once||(f.create("gdpr","0",525600),k.realise(c,d),k.frameConnector.sendToChildren({type:"GDPR-ok"}),a.once=!0)}},{type:"GDPR-cancel",callback:function(){f.create("gdpr",
"1");k.logCancel();k.frameConnector.sendToChildren({type:"GDPR-cancel"})}}])}},askGDPR:function(a,b,c,d,f,l){if(k.inArray([null,""],a))this.showPopup(b,c,d,f,l);else if("0"===a)this.trigger("GDPR-cookie-success"),this.realise(d,f);else if("1"===a)return this.trigger("GDPR-cookie-fail"),this.logCancel(),!1},logCancel:function(){this._sender.hit(function(){},!1)},handle:function(){var a=this._sender,b=[],c=(z.getLanguage()||"").toLowerCase().split("-")[0],d="ontouchstart"in m?"-touch":"",f=this._cookie,
l=f.read("gdpr"),g=f.read("yaGdprCheck"),n=this,r=this.globalConfig.get(this.globalKey),t=arguments;b.size=0;if(r)return r(function(){n.realise(t,b)});k.inArray("ru en kk be ky tr tt uk".split(" "),c)||(c="en");if(!this.enabled&&("0"===l||z.isSafariWebView()||z.isAndroidWebView()||k.inArray(mc,m.location.href.split("?")[0])||!pa()||f.read("yandex_login")||this.disable))return f.read("yandex_login")?(this.trigger("GDPR-skip-login"),f.create("gdpr","0",525600)):pa()?"0"===l?this.trigger("GDPR-skip"):
z.isSafariWebView()||z.isAndroidWebView()?this.trigger("GDPR-skip-wv"):this.trigger("GDPR-skip-na"):this.trigger("GDPR-skip-domain"),this.realise(t,b);this.globalConfig.set(this.globalKey,function(a,c){var d=0;try{d=JSON.stringify(c).length||0}catch(h){}b.size+d<n.MAX_SIZE?(b.push(a),b.size+=d):k.warning("GDPR buffer is exceeded")});a.hit(function(a){if(a.params.eu||g||n.enabled)if(n.frameConnector&&n.frameConnector.addHandler("isYandex",function(){return{type:"isYandex",isYandex:pa()}}),n.frameConnector.isIframe){n.frameConnector.sendToParents({type:"isYandex"},
function(a,c){var d=!1;clearTimeout(m);c[0].isYandex?(n.trigger("GDPR-frame-ya"),n.frameConnector.addHandler("GDPR-ok",function(){d||(f.create("gdpr","0",525600),n.realise(c,b),d=!0)}),n.frameConnector.addHandler("GDPR-cancel",function(){f.create("gdpr","1")})):(n.trigger("GDPR-frame-noya"),n.realise(c,b))});var m=k.setTimeout(function(){n.trigger("GDPR-frame-skip");n.realise(t,b)},2E3)}else n.askGDPR(l,d,c,t,b,f);else return a.params.eu?n.trigger("GDPR-skip-eu-na"):(f.create("gdpr","0"),n.trigger("GDPR-eu-skip")),
n.realise(t,b)})}});ua.globalKey="f1";ua.cookie=new N({skipPrefix:!0});ua.getState=function(a){var b=ua.cookie.read("gdpr");a=k.reduce(function(a,b){b.ymetrikaEvent&&k.inArray(Lb,b.ymetrikaEvent.type)&&a.push(k.arrayIndexOf(Lb,b.ymetrikaEvent.type));return a},[],a.get("dataLayer"));return a.length?(a=a.join(","),b&&(a+="-"+(k.inArray(["0","1"],b)?b:"2")),a):""};var nc={init:function(a,b,c){"22663942"==c&&(c=t.createElement("img"),a&&a.account&&a.tmsec&&b&&(c.src="https://www.tns-counter.ru/V13a****"+
a.account+"/ru/UTF-8/tmsec\x3d"+a.tmsec+"/"+b))}};z.isIE=k.memorize(function(){return t&&!t.addEventListener||!1});z.isChromePdf=k.memorize(function(){var a,b=navigator.plugins;if(b&&b.length)for(a=0;a<b.length;a++)if(/Chrome PDF Viewer/.test(b[a].name))return!0;return!1});z.isPrivate=F(function(a){var b=k.bind(a,null,0);a=k.bind(a,null,1);if(k.isFunction(m.webkitRequestFileSystem)&&!z.isAndroid())return m.webkitRequestFileSystem(0,0,b,a);if(z.isFF())return"undefined"==typeof navigator.serviceWorker?
a():b();if(z.isSafari()&&k.isFunction(m.openDatabase))try{m.openDatabase(null,null,null,null),b()}catch(c){a()}else{if(m.indexedDB||!m.PointerEvent&&!m.MSPointerEvent)return b();a()}},"isPrivate");z.findTarget=function(a){a=a.target||a.srcElement;var b;if(!a)return!1;3==a.nodeType&&(a=a.parentNode);for(b=a&&a.nodeName&&a.nodeName.toString().toLowerCase();a&&a.parentNode&&a.parentNode.nodeName&&("a"!==b&&"area"!==b||!a.href&&!a["xlink:href"]);)b=(a=a.parentNode)&&a.nodeName&&a.nodeName.toString().toLowerCase();
return a.href?a:!1};z.getHref=function(a){if(!a)return"";a=a.href;return k.isString(a)?""+a:"[object SVGAnimatedString]"===k.toString(a)?""+a.baseVal:""};z.getLinkComponents=function(a){return a&&"A"===a.nodeName?{href:a.href,hostname:a.hostname||k.parseUrl(a.href).hostname||"",host:a.host,protocol:a.protocol,pathname:a.pathname,hash:a.hash,port:a.port,search:a.search,query:a.search.slice(Math.min(1,a.search.length)),path:(a.pathname||"/")+a.search}:k.isString(a)?k.parseUrl(a):{href:"",hostname:"",
host:"",protocol:"",pathname:"",hash:"",port:"",search:"",query:"",path:""}};var oc=T.inherit({resource:"clmap",retry:!0,transports:[Da],sendClick:function(a,b,c,d){this.send({"page-url":a,"pointer-click":b},{},c,d)}}),pc=J.inherit({filter:null,ignoreTags:[],quota:0,isTrackHash:!1,protocol:"",counterId:0,counterType:0,startTime:0,MAX_LEN_PATH:128,TIMEOUT_CLICK:50,TIMEOUT_SAME_CLICKS:1E3,DELTA_SAME_CLICKS:2,tags:"A B BIG BODY BUTTON DD DIV DL DT EM FIELDSET FORM H1 H2 H3 H4 H5 H6 HR I IMG INPUT LI OL P PRE SELECT SMALL SPAN STRONG SUB SUP TABLE TBODY TD TEXTAREA TFOOT TH THEAD TR U UL ABBR AREA BLOCKQUOTE CAPTION CENTER CITE CODE CANVAS DFN EMBED FONT INS KBD LEGEND LABEL MAP OBJECT Q S SAMP STRIKE TT ARTICLE AUDIO ASIDE FOOTER HEADER MENU METER NAV PROGRESS SECTION TIME VIDEO NOINDEX NOBR MAIN svg circle clippath ellipse defs foreignobject g glyph glyphref image line lineargradient marker mask path pattern polygon polyline radialgradient rect set text textpath title".split(" "),
_initComponent:function(){var a,b;this._lastClick=null;this.hasQuota=!!this.quota;this._quota=this.quota;this._ignoreTags=[];if(this.ignoreTags)for(a=0;a<this.ignoreTags.length;a++)this.ignoreTags[a]&&k.mergeArrays(this._ignoreTags,[String(this.ignoreTags[a]).toUpperCase()]);this._cacheTags={};a=59;var c=String.fromCharCode;for(b=0;b<this.tags.length;b++)this._cacheTags[this.tags[b]]=c(a),c(a),a++;this._sender=new oc({globalConfig:this.globalConfig,protocol:this.protocol,counterId:this.counterId,
counterType:this.counterType});this._start=!1;this.start()},destroy:function(){this.stop()},start:function(){if(!this._start)y.on(t,"click",this._handler,this);this._start=!0},stop:function(){this._start&&y.un(t,"click",this._handler,this);this._start=!1},setTrackHash:function(a){this.isTrackHash=a},_isIgnore:function(a){return v.classNameExists(a,"(ym-disable-clickmap|ym-clickmap-ignore)")},_handler:function(a){a={el:S.getTarget(a),pos:S.getPos(a),button:S.getMouseButton(a),time:+new Date};if(this._isTrackingClick(a)){var b=
v.getElementSize(a.el);var c=v.getElementXY(a.el);b=["rn",k.random(),"x",Math.floor(65535*(a.pos[0]-c[0])/(b[0]||1)),"y",Math.floor(65535*(a.pos[1]-c[1])/(b[1]||1)),"t",Math.floor((a.time-this.startTime)/100),"p",this._getElPath(a.el),"X",a.pos[0],"Y",a.pos[1]];c=M().href;this.isTrackHash?k.mergeArrays(b,["wh","1"]):c=c.split("#")[0];this._sender.sendClick(k.trim(c,nb),b.join(":"));this._lastClick=a}},_isTrackingClick:function(a){var b;if(m.ymDisabledClickmap||k.isMetrikaPlayer()||!a.el)return!1;
...
ASSESSOR_COOKIE:"assessor",REMOTE_CONTROL:"i",getInjectHash:function(){var a={};k.forEachKey(this.injectHash,function(b){a[va+(""+k.fnv32a(b))]=this.injectHash[b]},this);return a},checkAssessor:function(){var a=[],b=this.getInjectHash();k.forEachKey(b,function(c){if((new RegExp(c)).test(m.location.hash)||N.get(this.ASSESSOR_COOKIE+c))N.set(this.ASSESSOR_COOKIE+c),a.push(b[c])},this);return a},_initComponent:function(){var a=this.checkAssessor();this.globalConfig.get(this.REMOTE_CONTROL)||(this.globalConfig.set(this.REMOTE_CONTROL,
!0),Mb.superclass._initComponent.apply(this,arguments),this._executedMsgs={},y.on(m,"message",this._onMessage,this),a.length&&(this.globalConfig.set("oo",!0),this.globalConfig.get("stopRecoder",function(){})(),k.arrayEvery(a,function(a){v.loadScript({src:a},m);return 1})))},_buildRemoteIframe:function(a){var b=k.getNativeFunction("createElement",t)("div"),c=v.getBody()||t.documentElement;if(c){b.innerHTML='\x3ciframe name\x3d"RemoteIframe" allowtransparency\x3d"true" style\x3d"position: absolute; left: -999px; top: -999px; width: 1px; height: 1px;"\x3e\x3c/iframe\x3e';
var d=b.firstChild;d.onload=function(){v.loadScript({src:a},d.contentWindow)};m._ym__remoteIframeEl=d;b.createShadowRoot||b.webkitCreateShadowRoot?(c.appendChild(b),b.removeChild(d),(c=b.createShadowRoot?b.createShadowRoot():b.webkitCreateShadowRoot())&&c.appendChild(d),m._ym__remoteIframeContainer=b):(c.appendChild(d),m._ym__remoteIframeContainer=d)}},_isAllowedLang:function(a){return-1!==k.arrayIndexOf("ru uk en tr es de".split(" "),a)},_isAllowedOrigin:function(a){return/^http:\/\/([\w\-.]+\.)?webvisor\.com\/?$/.test(a)},
...
"/cdn/inpage-remote/"+(b.newScriptAddr?"_inpage-remote_":"inpage-remote.")+b.lang+".js"))}}),qc={match:function(){this.enabled()&&y.ready(function(){var a=k.getNativeFunction("createElement",t)("iframe");a.onload=function(){Qa.save("cm",x.getMinutes());v.removeNode(a)};a.style.display="none";a.src="https://mc.webvisor.org/metrika/watch_match.html";t.documentElement.appendChild(a)})},enabled:function(){return 1440<x.getMinutes()-Qa.getNum("cm")&&"tr"===k.getTld()}};F(function(){(function(a){function b(d){if(c[d])return c[d].exports;
...
t.push("google");c("awaps",m.filter(function(a){return(a=a.src)&&-1<a.indexOf("awaps.yandex.net/")}));c("criteo",m.filter(function(a){var b=a.src;a=a.id;return b&&(-1<b.indexOf(".criteo.com/")||a&&-1<a.indexOf("cto_iframe_"))?!0:!1}));return{adElements:e,iframeProviders:t}}}})},"",!0)();var rc={init:function(a,b){if(Math.random()<(b||.005)&&!D.get("adDetect")){D.set("adDetect",!0);var c=function(b){var c=m.Ya.AdDetector.detectAd();var d=c.window;var f=c.page;a.sendParams({__ym:{ads:{w:{t:d.top,l:d.left,
w:d.width,h:d.height},p:{w:f.width,h:f.height},a:k.map(function(a){return{t:a.top,l:a.left,w:a.width,h:a.height,p:a.provider}},c.ads),full:b?1:0}}})};var d=F(function(){y.un(m,"load",d);c(!0)},"",!0);y.on(m,"load",d);k.setTimeout(c,1E4,"AdDetector",!0)}}},Nb=J.inherit({message:m.postMessage,spliter:":",nameSpace:"__yminfo",pending:{},childs:{},isIframe:!1,parents:{},dataToSend:{parents:[],childs:[]},checkFrame:function(a){try{var b=a&&a.postMessage}catch(c){return!1}return b},checkChildrenData:function(a,
...
"message",this.onMessage,this,{passive:!1,name:"FrameConnector"});this.sendToIframe=function(){};this.parents=[];this.pending={};this.childs={};this.dataToSend={parents:[],childs:[]}},_initComponent:function(){var a=m.document.getElementsByTagName("iframe"),b=0;Nb.superclass._initComponent.apply(this,arguments);this.handlers=k.mixin({},this.getHandlers());this.isIframe=z.isIframe();if(this.message){for(b=0;b<a.length;b++){var c=a[b];(function(a,b){a.sendToIframe(b.contentWindow,{type:"initToChild"},
...
d=ba.parse(a.data);var f=d[this.nameSpace]}catch(g){return}if(f&&f.substring&&f.substring(0,this.nameSpace.length)==this.nameSpace){for(b=0;3>=b;b++){var l=k.arrayIndexOf(f,this.spliter);-1!==l?c.push(f.substring(0,l)):c.push(f);f=f.substring(l+1)}b=c.splice(1,3);if((d=d.data)&&d.type&&this.handlers[d.type]&&"0"===b[this.DIR_INDEX]){if(!d.toCounter||d.toCounter==this.counterId){try{a.source}catch(g){return}d.counterId&&this.checkFrame(a.source)&&(l=this.trigger(d.type,a,d),a.source.postMessage(this.genMessage(l,
[b[0],b[1],d.counterId]).string,"*"))}}else b[this.DIR_INDEX]==this.counterId&&k.isArray(d)&&k.arrayEvery(d,function(a){return a.counterId&&a.hid})&&(a=this.pending[[b[0],b[1]].join(this.spliter)])&&a.apply(this,d)}}}),L=M(),ib=x.getTimezone(),jb=x.getTimestamp(),ea=m.screen,ac=64,nb=z.isIE()?512:2048,bc=z.isIE()?512:2048,Bb=z.isIE()?100:400,Ib=100,mb="noindex",Ob=/\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i,
sc=+new Date,ma="Metrika",sb,eb,va=function(){return"1857"}();D.init().setSafe("counters",{}).setSafe("hitParam",{}).setSafe("counterNum",0).setSafe("dataLayer",[]).setSafe("hitId",k.random(1,1073741824)).setSafe("_globalMetrikaHitId",k.random()).setSafe("v",va);Ea.globalConfig=D;ma="Metrika2";m.Ya[ma]=function(a,b,c,d){var f=this;return F(function(){function l(a,b,c){b=new N({counterId:b});b.erase("mp2_substs");if(a){a:{var d=a.conditions;var e;if(d&&d.length)for(e=0;e<d.length;e++){var f=d[e];if("ref"==
f.type)var h=g(f);else if("adv"==f.type){var l=m.Ya._metrika.counter._directCampaign;var p=f.ServiceNamePattern;var q=f.RefererPattern;h=l?f.direct_orders:f.direct_camp;var na=t.referrer,la=Ba.parse(L.search),w=u(L.search,L.hash),v;var x=la;var y={};var ka=["source","medium","campaign","term","content"];for(v=0;v<ka.length;v++)x["utm_"+ka[v]]&&(y[ka[v]]=x["utm_"+ka[v]]);x=y;ka=l?"direct.yandex.ru":w&&w.service||x.source;v=!1;if(!v&&p&&p.length)for(y=0;y<p.length;y++)if((new RegExp(p[y],"i")).test(ka)){v=
!0;break}if(!v&&!f.yandex_direct&&q&&q.length)for(p=0;p<q.length;p++)if((new RegExp(q[p],"i")).test(na)){v=!0;break}!v&&f.google_adwords&&la.gclid&&(v=!0);if(v&&h&&h.length&&(v=!1,l=l||w&&w.campaign||x&&x.campaign))for(f=0;f<h.length;f++)if(h[f]==l){v=!0;break}h=v}else h=!1;if(h){d[e].track_id&&b.create("mp2_track",d[e].track_id,43200);break a}}}d=b.read("mp2_track");a=a.substs&&a.substs[d];d&&a?(b.create("mp2_substs",k.toJSON(a)),a=n(a),c.params("__ym",a?"mp_trackid":"mp_trackid_bad",d)):r()}else r()}
...
e=e.slice(1);if("#"==g){if(g=t.getElementById(e))c=!0,b&&ja.unshift([g,g.innerHTML]),g.innerHTML=f}else if("."==g)for(g=v.getElementsByClassName(e),e=0;e<g.length;e++){c=!0;var h=g[e],k=f;b&&ja.unshift([h,h.innerHTML]);h.innerHTML=k}}return c}function r(){var a;for(a=0;a<ja.length;a++)ja[a][0].innerHTML=ja[a][1]}function u(a,b){var c,d="";a=a&&a.replace(/^\?/,"");b=b&&b.replace(/^#/,"")||"";if(a){var e=a.split("\x26");for(c=0;c<e.length;c++){var f=e[c].split("\x3d");"_openstat"===f[0]&&(d=f[1])}}var g=
b.split("?");for(c=0;c<g.length;c++){var h=g[c].split("\x26");for(e=0;e<h.length;e++)f=h[e].split("\x3d"),"_openstat"===f[0]&&(d=f[1])}d&&(d=-1<d.indexOf(";")?k.safeDecodeURIComponent(d):Ia.decode(W.decode(d.replace(/[-*_]/g,function(a){return{"*":"+","-":"/",_:"\x3d"}[a]||a}))));return d&&(c=d.split(";"),4==c.length)?{service:c[0],campaign:c[1],ad:c[2],source:c[3]}:null}function p(a,b){return F(function(){if(!f.isDestructing())return a.apply(this,arguments)},b||"")}function C(){var g=!1,n=!1;Da||
(n=T.initCookie(wa),Ea.userInfo=T._userID,Ab.init(D));Ea.initPU(qa,D);z.isAndroidWebView()||Ea.initPP(D);oa&&nc.init(oa,O,a);D.get("pri")!=w||z.isAndroidWebView()||(D.setSafe("pri",null),z.isPrivate(F(function(a){D.set("pri",a)},"privCb")));Gb.subscribe(V);if(D.get("hitParam")[V]){if(1!=c||D.get("counters")[V])return!1;g=!0}D.get("counters")[V]=f;D.get("hitParam")[V]=1;k.async(function(){Ea.initFip(D)},this,"initFip");f._webvisor=G.webvisor||!1;f._directCampaign=G.directCampaign;G.trackHash&&J(!0);
if(!g){pa=new Fb({protocol:"https:",globalConfig:D,counterId:a,counterType:c,hid:O,tz:ib,ts:jb,url:L.href,enabled:f._webvisor,trustedDomains:G.trustedDomains,childIframe:G.childIframe});f.replacePhones();g=new Kb({globalConfig:D});var p=function(e){var g=new rb({protocol:"https:",counterType:c,counterId:a,trackHash:za,hitId:O,webvisor:f._webvisor,counter:f,globalConfig:D,counterNum:aa}),h={ut:ma,re:n,he:~~G.httpError,ad:1==c&&m.Ya&&m.Ya.Direct,pv:!0,cpf:z.isChromePdf(),saveRef:!0};sb=+new Date;g.sendHit({url:P,
referrer:ha,title:v.getDocumentTitle(),vParams:b,userParams:Ca,nohit:d,experiments:Ga,modes:h,visitColor:pa.getVc(),hasPrerender:ta,ts:jb,tz:ib,callback:function(g,h){var k;eb||(eb=+new Date);d||(ta=!1);g=g||{};(k="0"!==g.pcs)||Ea.initZZ();g.eu!==w&&D.set("isEU",g.eu);T.retransmit(D);!k&&.01>Math.random()&&ic(function(a){(new Ja({forceHost:W.decode("bGFsYWJsYWguY29t"),noRedir:!0,protocol:"https:",counterType:c,globalConfig:D,counterId:44743195,hitId:O,counter:f,counterNum:aa})).sendParams({__ym:{monitor:a}})});
Qa.init(h);qc.match();lc.sync(a,c,k,D);d||U.log("PageView. Counter ",a,". URL: ",L.href,". Referrer: "+t.referrer,". Params: ",b);g.webvisor&&(g.webvisor.isEU=D.get("isEU"));f.isDestructing()||(pa.start(g.webvisor,g.publisher),l(g.mp2,a,f),y.on(m,"load",f.replacePhones,f));f._inited=!0;e&&e()}})};g.sync(p)}h(!1);y.on(t,"click",e,null,{name:"extLinkClick"});0!=k.keys(G).length&&(fa&&fa.initUserLayer(),G.enableAll?(h(!0),B(!0),A()):(G.clickmap&&B(G.clickmap),G.trackLinks&&h(G.trackLinks),G.accurateTrackBounce&&
A(G.accurateTrackBounce)),G.triggerEvent&&k.async(function(){S.dispatchCustomEvent("yacounter"+a+"inited")},this,"yacounterInit"))}function q(a){var b=new ua({frameConnector:qa,globalConfig:D,initCounter:C,disable:G.yaDisableGDPR});ta=a;b.handle.apply(b,arguments)}function h(a){var b={};switch(typeof a){case "string":b.on=!0;break;case "object":b.on=!0;break;case "boolean":b.on=a;break;default:return}f._trackLinks=b}function e(a){if(f._trackLinks&&f._trackLinks.on){a=z.findTarget(a);var b=z.getLinkComponents(a),
c=b.href,d=D.get("pai",k.noop)();if(c&&!v.classNameExists(a,"ym-disable-tracklink")){var e=b.protocol+"//"+b.hostname+b.pathname;d={pai:d&&d+"-"+O,ln:!0};var g=vb(a);g=c===g?"":g;if(v.classNameExists(a,"ym-external-link"))Q.sendClickLink({url:c,title:g,modes:d},P);else{var h=G.url?k.parseUrl(P).hostname:M().hostname;d.dl=Ob.test(e)||Ob.test(c)||wb(c,ya)||wb(e,ya);b=b.hostname;(h?h.replace(/^www\./,""):"").toLowerCase()==(b?b.replace(/^www\./,""):"").toLowerCase()?d.dl?(d.ln=!1,Q.sendClickLink({url:c,
title:g,modes:d},P)):(g=vb(a),va.set("pai",d.pai),g&&g!==c&&va.set("il",k.trim(g,Ib))):c&&-1!==c.search(/^ *(data|javascript):/i)||(d.ut=mb,Q.sendClickLink({url:c,title:g,modes:d},P))}}}}function B(b){"undefined"===typeof b&&(b=!0);!0===b&&(b={});f._clickmap&&f._clickmap.destroy();b&&(f._clickmap=new pc({globalConfig:D,filter:b.filter,ignoreTags:b.ignoreTags,quota:b.quota,isTrackHash:b.isTrackHash,protocol:"https:",counterId:a,counterType:c,startTime:sc}))}function E(a,b){function c(){if(!q){p&&k.clearTimeout(p);
var c=h?l:l+ +new Date-n;c=b-c;0>c&&(c=0);p=k.setTimeout(function(){q=!0;e(!1);a()},c,"trackUserTime")}}function d(){g||(f=!0,h=!1,g=!0,c())}function e(a){var b;for(b=0;b<r.length;b+=3)if(a)y.on(r[b],r[b+1],r[b+2],{name:"tabTrack"});else y.un(r[b],r[b+1],r[b+2])}var f=!1,g=!1,h=!0,l=0,n=+new Date,p=null,q=!1;if(z.isIE())k.setTimeout(a,b,"trackUserTime");else{var r=[m,"blur",function(){h=f=g=!0;l+=+new Date-n;n=+new Date;c()},m,"focus",function(){f||g||(l=0);n=+new Date;f=g=!0;h=!1;c()},t,"click",
d,t,"mousemove",d,t,"keydown",d,t,"scroll",d];e(!0);c()}}function A(b){var c=G.referrer?ha:t.referrer,d=G.url?P:M().href;"number"!==typeof b&&(b=15E3);if(!f._isAccurateTrackBounce){f._isAccurateTrackBounce=!0;var e=new ia({counterId:a});var g=e.get("lastHit");e.set("lastHit",x.getMs());((e=e.get("lastHit"))&&(!g||g<e-18E5)||!Tb(c,d)||.1>Math.random())&&E(function(){f.notBounce();X.init(.002,sa)},b)}}function H(a){var b=function(){var a=M().hash.split("#")[1];if("undefined"==typeof a)return!1;var b=
a.indexOf("?");0<b&&(a=a.substring(0,b));return a};var c=b();(function Oa(){var d=b();d!==c&&(a(),c=d);Aa=k.setTimeout(Oa,200,"trackHash")})()}function J(a){if(!1===a)za&&("onhashchange"in m?y.un(m,"hashchange",K):k.clearTimeout(Aa),za=!1);else if(a=K,!za){if("onhashchange"in m)y.on(m,"hashchange",a);else H(a);za=!0}Q.setTrackHash(za);f._trackHash=za}function K(){var a={ut:ma,ad:1==c&&m.Ya&&m.Ya.Direct,wh:!0,saveRef:!0,pv:!0};da=Za.lastReferrer=ra;Q.sendAjaxHit({url:G.url?P:M().href,title:v.getDocumentTitle(),
referrer:da,modes:a});ra=M().href}function ea(a,b,c){a=R.parseValidate(a,b);b=[];a&&(b.push(a),c=c||{},k.isFunction(c.callback)&&(b.push(c.callback),c.ctx&&b.push(c.ctx)));b.length&&f.params.apply(f,b)}var ma="",G={},da="",ra=Za.lastReferrer=L.href,sa=.002,ta=!1,pa;D.setSafe("counter",f);Pa&&F(function(){throw Pa.error;},"include."+Pa.scope)();if("object"===typeof a){G=a;d=a.defer;ma=a.ut;var wa=a.ldc||"uid";c=a.type;b=a.params;var Ca=a.userParams;var oa=a.tns;var Ga=G.experiments;var Da=G.nck;var P=
a.url;var ha=a.referrer;a=a.id}if(!m["disableYaCounter"+a]){Ba.parse=function(a,b){var c={},d;a=a&&a.replace(/^\?/,"")||"";if(a.length){var e=a.split("\x26");for(d=0;d<e.length;d++)if(e[d]){var f=e[d].split("\x3d");if(f[0]){var g=k.safeDecodeURIComponent(f[0]);f=k.safeDecodeURIComponent((f[1]||"").replace(/\+/g,"%20"));b&&g in c?k.isArray(c[g])?c[g].push(f):c[g]=[c[g],f]:c[g]=f}}}return c};var ja=[];P=P?P:M().href;ha=ha?ha:t.referrer;a=a||0;/^\d+$/.test(a)||(a=0);c=c||0;var V=a+":"+c;if(D.get("counters")[V])return U.log("Duplicate counter "+
V+" initialization"),D.get("counters")[V];var O=D.get("hitId");var qa=new Nb({counterId:a,hid:O});D.set("counterNum",D.get("counterNum")+1);var aa=D.get("counterNum");var Q=new Ja({protocol:"https:",counterType:c,counterId:a,hitId:O,counter:f,globalConfig:D,counterNum:aa});var X={init:function(a,b){if(m.performance&&"function"===typeof performance.getEntriesByType){a===w&&(a=1);b===w&&(b=1);var c=Math.random()>a,d=Math.random()>b;if(!c||!d){var e={1882689622:1,2318205080:1,3115871109:1,3604875100:1,
339366994:1,2890452365:1,849340123:1,173872646:1,2343947156:1,655012937:1,1996539654:1,2065498185:1,823651274:1,12282461:1,1555719328:1,1417229093:1,138396985:1},f=performance.getEntriesByType("resource"),g={},h={},l={counterId:51533966},n={},p;for(p=0;p<f.length;p++){var q=f[p];var r=q.name.replace(/^https?:\/\//,"").split("?")[0];var t=k.fnv32a(r);"script"!==q.initiatorType||c||(h[r]={dns:Math.round(q.domainLookupEnd-q.domainLookupStart),tcp:Math.round(q.connectEnd-q.connectStart),duration:Math.round(q.duration),
response:Math.round(q.responseEnd-q.requestStart),name:q.name,decodedBodySize:q.decodedBodySize});!e[t]||g[r]||d||(g[r]={dns:Math.round(q.domainLookupEnd-q.domainLookupStart),tcp:Math.round(q.connectEnd-q.connectStart),duration:Math.round(q.duration),response:Math.round(q.responseEnd-q.requestStart),pages:L.href})}k.keys(g).length&&(n.timings8=g);k.keys(h).length&&(n.scripts=h);k.keys(n).length&&(new Ra(l)).logParams(n)}}}};24226447==a&&(sa=1);f.replacePhones=p(function(){var b,c;try{(b=(new N({counterId:a})).read("mp2_substs"))&&
(c=ba.parse(b))&&n(c,!0)}catch(ka){}return f},"counter.replacePhones");f.reachGoal=p(function(b,c,d,e){2<=arguments.length&&"function"===typeof c&&(e=d,d=c,c=w);U.log("Reach goal. Counter: "+a+". Goal id: "+b+". Params: ",c);Q.sendGoal(b,{url:G.url?P:M().href,vParams:c,callback:d,ctx:e});return f},"counter.reachGoal");f.trackLinks=p(function(a){h(a);return f},"counter.trackLinks");var va=new ia({counterId:a});f.hit=p(function(b,c,d,e,g,h){(b=b&&k.isFunction(b.toString)?b.toString():!1)?(k.isObject(c)&&
(d=c.referer,e=c.params,g=c.callback,h=c.ctx,c=c.title),P=b,U.log("PageView. Counter "+a,". URL: "+b,". Referrer: "+d,". Params: ",e),Q.sendHit({url:b,title:c,hasPrerender:ta,referrer:d,vParams:e,callback:g,ctx:h}),ta=!1):k.warning("Empty hit url");return f},"counter.hit");f.params=p(function(b){var c=arguments.length,d=c,e=[].slice.call(arguments,0);if(b){if(1<arguments.length){if(k.isFunction(arguments[c-1])){var g=arguments[c-1];d=c-1}else if(k.isFunction(arguments[c-2])){g=arguments[c-2];var h=
arguments[c-1];d=c-2}e=[].slice.call(e,0,d);1<e.length&&(e=[k.array2Props(e)])}c=-1!==k.arrayIndexOf(k.keys(e[0]),"__ymu");(d=-1!==k.arrayIndexOf(k.keys(e[0]),"__ym")&&e[0].__ym.user_id)?U.log('Set user id "'+e[0].__ym.user_id+'"'):U.log((c?"User p":"P")+"arams. Counter "+a+". Params: ",e[0]);Q.sendParams(e[0],g,h,G.url?P:M().href)}else k.warning("Wrong params");return f},"counter.params");qa.addHandler("pluginInfo",function(){return G},this);qa.addHandler("parentConnect",function(a,b){Q.paramsQueue.push({__ym:{parentIframe:{counterId:b.counterId,
hid:b.hid}}})},this);f.file=p(function(a,b){a?(b=b||{},Q.sendFileUpload({url:a,title:b.title,vParams:b.params,callback:b.callback,ctx:b.ctx,referrer:G.url?P:M().href})):k.warning("Empty file url");return f},"counter.file");f.extLink=p(function(a,b){a?(b=b||{},Q.sendExtLink({url:a,title:b.title,vParams:b.params,callback:b.callback,ctx:b.ctx,referrer:G.url?P:M().href},P)):k.warning("Empty link");return f},"counter.extLink");f.notBounce=p(function(a){var b=0;a=a||{};sb&&eb&&(b=eb-sb);Q.sendNotBounce(b,
{url:G.url?P:M().href,callback:a.callback,ctx:a.ctx});return f},"counter.notBounce");var ya=[];f.addFileExtension=p(function(a){if(!a)return k.warning("Empty extension"),f;"string"===typeof a?ya.push(a):ya=ya.concat(a);return f});f.clickmap=function(a){B(a);return f};f.accurateTrackBounce=p(function(a){A(a);return f});var Aa=null;var za=!1;f.trackHash=p(function(a){J(a);return f});var R={requiredEcommerceFields:["currency","goods"],parseValidate:function(a,b){var c=this.validate(a,b),d;if(!c.isValid)return console&&
...
f.params({__ym:{user_id:a}},b||function(){},c):k.warning("Incorrect user ID");return f},"id");var Ma=new N;f.getClientID=p(function(a){var b=Ma.read(wa);a&&k.isFunction(a)&&a(b);return b},"guid");f.enableAll=function(){h(!0);B(!0);A();return f};f.uploadPage=function(){};f.destruct=p(function(){f._isDestructing=!0;y.un(t,"click",e,null,{name:"extLinkClick"});y.un(m,"load",f.replacePhones,f);J(!1);pa&&pa.stop();D.set("stopRecoder",w);D.set("counter",w);fa&&fa.destruct&&fa.destruct();B(!1);try{delete m["yaCounter"+
a],delete D.get("counters")[V],delete D.get("hitParam")[V]}catch(na){}});f.isDestructing=function(){return!!f._isDestructing};rc.init(Q);f._performanceTiming=xb;if(a){var fa=new Ka({counter:f,counterId:a,globalConfig:D,frameConnector:qa,prefsEcommerce:G.ecommerce,prefsUseDataLayer:G.useDataLayer});if("prerender"===t.webkitVisibilityState||"prerender"===t.visibilityState){Q.sendPrerenderHit({url:P,vParams:b,title:v.getDocumentTitle(),referrer:t.referrer});var Z=function(){"prerender"!==t.webkitVisibilityState&&
"prerender"!==t.visibilityState&&(y.un(t,"webkitvisibilitychange,visibilitychange",Z),q(!0))};y.on(t,"webkitvisibilitychange,visibilitychange",Z)}else q(!1)}}},"init")()};Gb.init(ma,D);new Mb({globalConfig:D});m.Ya[ma].counters=function(){var a=[];k.forEachKey(D.get("counters"),function(b,c){var d=b.split(":");a.push({id:+d[0],type:+d[1],accurateTrackBounce:c._isAccurateTrackBounce,clickmap:c._clickmap&&c._clickmap._start,oldCode:!!m.ya_cid,trackHash:!!c._trackHash,trackLinks:c._trackLinks&&c._trackLinks.on,
...
m.Ya._metrika.counter.reachGoal(a,b)});(function(){function a(a){try{delete m[a]}catch(r){m[a]=w}}var b="yandex_metrika_callback",c="yandex_metrika_callbacks";b="yandex_metrika_callback2";c="yandex_metrika_callbacks2";var d=m[b],f=m[c],k;"function"==typeof d&&d();if("object"==typeof f){var g=f.length;for(d=0;d<g;d++)if(k=f[d])f[d]=null,k()}a(b);a(c)})();m.Ya[ma].informer=function(a){var b=!!m.Ya[ma]._informer;Ya[ma]._informer=a;Ya[ma]._informer.domain="metrika-informer.com";b||v.loadScript({src:"https://metrika-informer.com/metrika/informer.js"})};
y.on(t,"click",F(function(a){var b=S.getTarget(a);if(b&&("ym-advanced-informer"===b.className||b.classList&&b.classList.contains("ym-advanced-informer"))){var c=b.getAttribute("data-lang");var d=b.getAttribute("data-cid");m.Ya[ma].informer({i:b,id:+d,lang:c});S.prevent(a)}},"adv-inf"),null,{passive:!1})})(this,this.document);
